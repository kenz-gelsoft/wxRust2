...
// NODEF: wxIMPLEMENT_APP_CONSOLE
// NODEF: wxIMPLEMENT_WXWIN_MAIN
// NODEF: wxIMPLEMENT_WXWIN_MAIN_CONSOLE
...
pub const GRID_DRAW_DEFAULT: c_int =
    GRID_DRAW_ROWS_HEADER | GRID_DRAW_COLS_HEADER | GRID_DRAW_CELL_LINES | GRID_DRAW_BOX_RECT;
...
pub const LIST_HITTEST_ONITEM: c_int =
    (LIST_HITTEST_ONITEMICON | LIST_HITTEST_ONITEMLABEL | LIST_HITTEST_ONITEMSTATEICON);
...
pub const PG_WINDOW_STYLE_MASK: c_int = PG_AUTO_SORT
    | PG_HIDE_CATEGORIES
    | PG_BOLD_MODIFIED
...
pub const PG_EX_WINDOW_PG_STYLE_MASK: c_int = PG_EX_INIT_NOCAT
...
pub const PG_EX_WINDOW_PGMAN_STYLE_MASK: c_int = PG_EX_NO_FLAT_TOOLBAR
    | PG_EX_MODE_BUTTONS
    | PG_EX_HIDE_PAGE_BUTTONS
    | PG_EX_NO_TOOLBAR_DIVIDER
    | PG_EX_TOOLBAR_SEPARATOR;
pub const PG_EX_WINDOW_STYLE_MASK: c_int =
    PG_EX_WINDOW_PG_STYLE_MASK | PG_EX_WINDOW_PGMAN_STYLE_MASK;
...
pub const PG_VFB_DEFAULT: c_int = PG_VFB_MARK_CELL | PG_VFB_SHOW_MESSAGEBOX;
...
pub const WINDOW_STYLE_MASK: c_long = (VSCROLL
    | HSCROLL
    | BORDER_MASK
    | ALWAYS_SHOW_SB
    | CLIP_CHILDREN
...
pub const WXK_LAUNCH_0: c_int = 501 + 17;
pub const WXK_LAUNCH_1: c_int = 501 + 18;
pub const WXK_LAUNCH_2: c_int = 501 + 19;
pub const WXK_LAUNCH_3: c_int = 501 + 20;
pub const WXK_LAUNCH_4: c_int = 501 + 21;
pub const WXK_LAUNCH_5: c_int = 501 + 22;
pub const WXK_LAUNCH_6: c_int = 501 + 23;
pub const WXK_LAUNCH_7: c_int = 501 + 24;
pub const WXK_LAUNCH_8: c_int = 501 + 25;
pub const WXK_LAUNCH_9: c_int = 501 + 26;
pub const WXK_LAUNCH_A: c_int = 501 + 27;
pub const WXK_LAUNCH_B: c_int = 501 + 28;
pub const WXK_LAUNCH_C: c_int = 501 + 29;
pub const WXK_LAUNCH_D: c_int = 501 + 30;
pub const WXK_LAUNCH_E: c_int = 501 + 31;
pub const WXK_LAUNCH_F: c_int = 501 + 32;
//  ENUM: wxKeyModifier
...
pub const EVT_CATEGORY_ALL: c_int = EVT_CATEGORY_UI
...
pub const S_DEFAULT: c_int = (POSIX_USER_READ
    | POSIX_USER_WRITE
    | POSIX_GROUP_READ
    | POSIX_GROUP_WRITE
    | POSIX_OTHERS_READ
    | POSIX_OTHERS_WRITE);
pub const S_DIR_DEFAULT: c_int = (POSIX_USER_READ
    | POSIX_USER_WRITE
    | POSIX_USER_EXECUTE
    | POSIX_GROUP_READ
    | POSIX_GROUP_WRITE
...
pub const FSW_EVENT_ALL: c_int = FSW_EVENT_CREATE
    | FSW_EVENT_DELETE
    | FSW_EVENT_RENAME
    | FSW_EVENT_MODIFY
    | FSW_EVENT_ACCESS
...
pub const ELLIPSIZE_FLAGS_DEFAULT: c_int =
    ELLIPSIZE_FLAGS_PROCESS_MNEMONICS | ELLIPSIZE_FLAGS_EXPAND_TABS;
...
pub const COMPOSITION_DIFF: c_int = -1 + 14;
//  ENUM: wxGradientType
...
pub const HF_DEFAULT_STYLE: c_int =
...
pub const LOCALE_TAGTYPE_DEFAULT: c_int = 0;
pub const LOCALE_TAGTYPE_SYSTEM: c_int = 0 + 1;
pub const LOCALE_TAGTYPE_BCP47: c_int = 0 + 2;
pub const LOCALE_TAGTYPE_MACOS: c_int = 0 + 3;
pub const LOCALE_TAGTYPE_POSIX: c_int = 0 + 4;
pub const LOCALE_TAGTYPE_WINDOWS: c_int = 0 + 5;
...
//  ENUM: wxLocaleName
pub const LOCALE_NAME_LOCALE: c_int = 0;
pub const LOCALE_NAME_LANGUAGE: c_int = 0 + 1;
pub const LOCALE_NAME_COUNTRY: c_int = 0 + 2;
//  ENUM: wxLocaleForm
pub const LOCALE_FORM_NATIVE: c_int = 0;
pub const LOCALE_FORM_ENGLISH: c_int = 0 + 1;
...
pub const LANGUAGE_AFAR_DJIBOUTI: c_int = 0 + 4;
pub const LANGUAGE_AFAR_ERITREA: c_int = 0 + 5;
pub const LANGUAGE_AFAR_ETHIOPIA: c_int = 0 + 6;
pub const LANGUAGE_AFRIKAANS: c_int = 0 + 7;
pub const LANGUAGE_AFRIKAANS_NAMIBIA: c_int = 0 + 8;
pub const LANGUAGE_AFRIKAANS_SOUTH_AFRICA: c_int = 0 + 9;
pub const LANGUAGE_AGHEM: c_int = 0 + 10;
pub const LANGUAGE_AGHEM_CAMEROON: c_int = 0 + 11;
pub const LANGUAGE_AKAN: c_int = 0 + 12;
pub const LANGUAGE_AKAN_GHANA: c_int = 0 + 13;
pub const LANGUAGE_ALBANIAN: c_int = 0 + 14;
pub const LANGUAGE_ALBANIAN_ALBANIA: c_int = 0 + 15;
pub const LANGUAGE_ALBANIAN_KOSOVO: c_int = 0 + 16;
pub const LANGUAGE_ALBANIAN_NORTH_MACEDONIA: c_int = 0 + 17;
pub const LANGUAGE_ALSATIAN_FRANCE: c_int = 0 + 18;
pub const LANGUAGE_AMHARIC: c_int = 0 + 19;
pub const LANGUAGE_AMHARIC_ETHIOPIA: c_int = 0 + 20;
pub const LANGUAGE_ARABIC: c_int = 0 + 21;
pub const LANGUAGE_ARABIC_ALGERIA: c_int = 0 + 22;
pub const LANGUAGE_ARABIC_BAHRAIN: c_int = 0 + 23;
pub const LANGUAGE_ARABIC_CHAD: c_int = 0 + 24;
pub const LANGUAGE_ARABIC_COMOROS: c_int = 0 + 25;
pub const LANGUAGE_ARABIC_DJIBOUTI: c_int = 0 + 26;
pub const LANGUAGE_ARABIC_EGYPT: c_int = 0 + 27;
pub const LANGUAGE_ARABIC_ERITREA: c_int = 0 + 28;
pub const LANGUAGE_ARABIC_IRAQ: c_int = 0 + 29;
pub const LANGUAGE_ARABIC_ISRAEL: c_int = 0 + 30;
pub const LANGUAGE_ARABIC_JORDAN: c_int = 0 + 31;
pub const LANGUAGE_ARABIC_KUWAIT: c_int = 0 + 32;
pub const LANGUAGE_ARABIC_LEBANON: c_int = 0 + 33;
pub const LANGUAGE_ARABIC_LIBYA: c_int = 0 + 34;
pub const LANGUAGE_ARABIC_MAURITANIA: c_int = 0 + 35;
pub const LANGUAGE_ARABIC_MOROCCO: c_int = 0 + 36;
pub const LANGUAGE_ARABIC_OMAN: c_int = 0 + 37;
pub const LANGUAGE_ARABIC_PALESTINIAN_AUTHORITY: c_int = 0 + 38;
pub const LANGUAGE_ARABIC_QATAR: c_int = 0 + 39;
pub const LANGUAGE_ARABIC_SAUDI_ARABIA: c_int = 0 + 40;
pub const LANGUAGE_ARABIC_SOMALIA: c_int = 0 + 41;
pub const LANGUAGE_ARABIC_SOUTH_SUDAN: c_int = 0 + 42;
pub const LANGUAGE_ARABIC_SUDAN: c_int = 0 + 43;
pub const LANGUAGE_ARABIC_SYRIA: c_int = 0 + 44;
pub const LANGUAGE_ARABIC_TUNISIA: c_int = 0 + 45;
pub const LANGUAGE_ARABIC_UAE: c_int = 0 + 46;
pub const LANGUAGE_ARABIC_WORLD: c_int = 0 + 47;
pub const LANGUAGE_ARABIC_YEMEN: c_int = 0 + 48;
pub const LANGUAGE_ARMENIAN: c_int = 0 + 49;
pub const LANGUAGE_ARMENIAN_ARMENIA: c_int = 0 + 50;
pub const LANGUAGE_ASSAMESE: c_int = 0 + 51;
pub const LANGUAGE_ASSAMESE_INDIA: c_int = 0 + 52;
pub const LANGUAGE_ASTURIAN: c_int = 0 + 53;
pub const LANGUAGE_ASTURIAN_SPAIN: c_int = 0 + 54;
pub const LANGUAGE_ASU: c_int = 0 + 55;
pub const LANGUAGE_ASU_TANZANIA: c_int = 0 + 56;
pub const LANGUAGE_AYMARA: c_int = 0 + 57;
pub const LANGUAGE_AZERBAIJANI: c_int = 0 + 58;
pub const LANGUAGE_AZERBAIJANI_CYRILLIC: c_int = 0 + 59;
pub const LANGUAGE_AZERBAIJANI_CYRILLIC_AZERBAIJAN: c_int = 0 + 60;
pub const LANGUAGE_AZERBAIJANI_LATIN: c_int = 0 + 61;
pub const LANGUAGE_AZERBAIJANI_LATIN_AZERBAIJAN: c_int = 0 + 62;
pub const LANGUAGE_BAFIA: c_int = 0 + 63;
pub const LANGUAGE_BAFIA_CAMEROON: c_int = 0 + 64;
pub const LANGUAGE_BAMANANKAN: c_int = 0 + 65;
pub const LANGUAGE_BAMANANKAN_LATIN: c_int = 0 + 66;
pub const LANGUAGE_BAMANANKAN_LATIN_MALI: c_int = 0 + 67;
pub const LANGUAGE_BANGLA: c_int = 0 + 68;
pub const LANGUAGE_BANGLA_BANGLADESH: c_int = 0 + 69;
pub const LANGUAGE_BANGLA_INDIA: c_int = 0 + 70;
pub const LANGUAGE_BASAA: c_int = 0 + 71;
pub const LANGUAGE_BASAA_CAMEROON: c_int = 0 + 72;
pub const LANGUAGE_BASHKIR: c_int = 0 + 73;
pub const LANGUAGE_BASHKIR_RUSSIA: c_int = 0 + 74;
pub const LANGUAGE_BASQUE: c_int = 0 + 75;
pub const LANGUAGE_BASQUE_SPAIN: c_int = 0 + 76;
pub const LANGUAGE_BELARUSIAN: c_int = 0 + 77;
pub const LANGUAGE_BELARUSIAN_BELARUS: c_int = 0 + 78;
pub const LANGUAGE_BEMBA: c_int = 0 + 79;
pub const LANGUAGE_BEMBA_ZAMBIA: c_int = 0 + 80;
pub const LANGUAGE_BENA: c_int = 0 + 81;
pub const LANGUAGE_BENA_TANZANIA: c_int = 0 + 82;
pub const LANGUAGE_BIHARI: c_int = 0 + 83;
pub const LANGUAGE_BISLAMA: c_int = 0 + 84;
pub const LANGUAGE_BLIN: c_int = 0 + 85;
pub const LANGUAGE_BLIN_ERITREA: c_int = 0 + 86;
pub const LANGUAGE_BODO: c_int = 0 + 87;
pub const LANGUAGE_BODO_INDIA: c_int = 0 + 88;
pub const LANGUAGE_BOSNIAN: c_int = 0 + 89;
pub const LANGUAGE_BOSNIAN_CYRILLIC: c_int = 0 + 90;
pub const LANGUAGE_BOSNIAN_CYRILLIC_BOSNIA_AND_HERZEGOVINA: c_int = 0 + 91;
pub const LANGUAGE_BOSNIAN_LATIN: c_int = 0 + 92;
pub const LANGUAGE_BOSNIAN_LATIN_BOSNIA_AND_HERZEGOVINA: c_int = 0 + 93;
pub const LANGUAGE_BRETON: c_int = 0 + 94;
pub const LANGUAGE_BRETON_FRANCE: c_int = 0 + 95;
pub const LANGUAGE_BULGARIAN: c_int = 0 + 96;
pub const LANGUAGE_BULGARIAN_BULGARIA: c_int = 0 + 97;
pub const LANGUAGE_BURMESE: c_int = 0 + 98;
pub const LANGUAGE_BURMESE_MYANMAR: c_int = 0 + 99;
pub const LANGUAGE_CATALAN: c_int = 0 + 100;
pub const LANGUAGE_CATALAN_ANDORRA: c_int = 0 + 101;
pub const LANGUAGE_CATALAN_FRANCE: c_int = 0 + 102;
pub const LANGUAGE_CATALAN_ITALY: c_int = 0 + 103;
pub const LANGUAGE_CATALAN_SPAIN: c_int = 0 + 104;
pub const LANGUAGE_CEBUANO: c_int = 0 + 105;
pub const LANGUAGE_CEBUANO_LATIN: c_int = 0 + 106;
pub const LANGUAGE_CEBUANO_LATIN_PHILIPPINES: c_int = 0 + 107;
pub const LANGUAGE_CENTRAL_ATLAS_TAMAZIGHT: c_int = 0 + 108;
pub const LANGUAGE_CENTRAL_ATLAS_TAMAZIGHT_ARABIC: c_int = 0 + 109;
pub const LANGUAGE_CENTRAL_ATLAS_TAMAZIGHT_ARABIC_MOROCCO: c_int = 0 + 110;
pub const LANGUAGE_CENTRAL_ATLAS_TAMAZIGHT_LATIN: c_int = 0 + 111;
pub const LANGUAGE_CENTRAL_ATLAS_TAMAZIGHT_LATIN_ALGERIA: c_int = 0 + 112;
pub const LANGUAGE_CENTRAL_ATLAS_TAMAZIGHT_LATIN_MOROCCO: c_int = 0 + 113;
pub const LANGUAGE_CENTRAL_ATLAS_TAMAZIGHT_TIFINAGH: c_int = 0 + 114;
pub const LANGUAGE_CENTRAL_ATLAS_TAMAZIGHT_TIFINAGH_MOROCCO: c_int = 0 + 115;
pub const LANGUAGE_CENTRAL_KURDISH: c_int = 0 + 116;
pub const LANGUAGE_CENTRAL_KURDISH_IRAQ: c_int = 0 + 117;
pub const LANGUAGE_CHAKMA: c_int = 0 + 118;
pub const LANGUAGE_CHAKMA_CHAKMA: c_int = 0 + 119;
pub const LANGUAGE_CHAKMA_CHAKMA_BANGLADESH: c_int = 0 + 120;
pub const LANGUAGE_CHAKMA_CHAKMA_INDIA: c_int = 0 + 121;
pub const LANGUAGE_CHECHEN: c_int = 0 + 122;
pub const LANGUAGE_CHECHEN_RUSSIA: c_int = 0 + 123;
pub const LANGUAGE_CHEROKEE: c_int = 0 + 124;
pub const LANGUAGE_CHEROKEE_CHEROKEE: c_int = 0 + 125;
pub const LANGUAGE_CHEROKEE_US: c_int = 0 + 126;
pub const LANGUAGE_CHIGA: c_int = 0 + 127;
pub const LANGUAGE_CHIGA_UGANDA: c_int = 0 + 128;
pub const LANGUAGE_CHINESE: c_int = 0 + 129;
pub const LANGUAGE_CHINESE_CHINA: c_int = 0 + 130;
pub const LANGUAGE_CHINESE_HONGKONG: c_int = 0 + 131;
pub const LANGUAGE_CHINESE_MACAO: c_int = 0 + 132;
pub const LANGUAGE_CHINESE_SIMPLIFIED_EXPLICIT: c_int = 0 + 133;
pub const LANGUAGE_CHINESE_SIMPLIFIED_HONGKONG: c_int = 0 + 134;
pub const LANGUAGE_CHINESE_SIMPLIFIED_MACAO: c_int = 0 + 135;
pub const LANGUAGE_CHINESE_SINGAPORE: c_int = 0 + 136;
pub const LANGUAGE_CHINESE_TAIWAN: c_int = 0 + 137;
pub const LANGUAGE_CHINESE_TRADITIONAL_EXPLICIT: c_int = 0 + 138;
pub const LANGUAGE_CHURCH_SLAVIC: c_int = 0 + 139;
pub const LANGUAGE_CHURCH_SLAVIC_RUSSIA: c_int = 0 + 140;
pub const LANGUAGE_COLOGNIAN: c_int = 0 + 141;
pub const LANGUAGE_COLOGNIAN_GERMANY: c_int = 0 + 142;
pub const LANGUAGE_CORNISH: c_int = 0 + 143;
pub const LANGUAGE_CORNISH_UK: c_int = 0 + 144;
pub const LANGUAGE_CORSICAN: c_int = 0 + 145;
pub const LANGUAGE_CORSICAN_FRANCE: c_int = 0 + 146;
pub const LANGUAGE_CROATIAN: c_int = 0 + 147;
pub const LANGUAGE_CROATIAN_BOSNIA_AND_HERZEGOVINA: c_int = 0 + 148;
pub const LANGUAGE_CROATIAN_CROATIA: c_int = 0 + 149;
pub const LANGUAGE_CZECH: c_int = 0 + 150;
pub const LANGUAGE_CZECH_CZECHIA: c_int = 0 + 151;
pub const LANGUAGE_DANISH: c_int = 0 + 152;
pub const LANGUAGE_DANISH_DENMARK: c_int = 0 + 153;
pub const LANGUAGE_DANISH_GREENLAND: c_int = 0 + 154;
pub const LANGUAGE_DARI: c_int = 0 + 155;
pub const LANGUAGE_DARI_AFGHANISTAN: c_int = 0 + 156;
pub const LANGUAGE_DIVEHI: c_int = 0 + 157;
pub const LANGUAGE_DIVEHI_MALDIVES: c_int = 0 + 158;
pub const LANGUAGE_DUALA: c_int = 0 + 159;
pub const LANGUAGE_DUALA_CAMEROON: c_int = 0 + 160;
pub const LANGUAGE_DUTCH: c_int = 0 + 161;
pub const LANGUAGE_DUTCH_ARUBA: c_int = 0 + 162;
pub const LANGUAGE_DUTCH_BELGIAN: c_int = 0 + 163;
pub const LANGUAGE_DUTCH_BONAIRE_SINT_EUSTATIUS_AND_SABA: c_int = 0 + 164;
pub const LANGUAGE_DUTCH_CURACAO: c_int = 0 + 165;
pub const LANGUAGE_DUTCH_NETHERLANDS: c_int = 0 + 166;
pub const LANGUAGE_DUTCH_SINT_MAARTEN: c_int = 0 + 167;
pub const LANGUAGE_DUTCH_SURINAME: c_int = 0 + 168;
pub const LANGUAGE_DZONGKHA: c_int = 0 + 169;
pub const LANGUAGE_DZONGKHA_BHUTAN: c_int = 0 + 170;
pub const LANGUAGE_EDO: c_int = 0 + 171;
pub const LANGUAGE_EDO_NIGERIA: c_int = 0 + 172;
pub const LANGUAGE_EMBU: c_int = 0 + 173;
pub const LANGUAGE_EMBU_KENYA: c_int = 0 + 174;
pub const LANGUAGE_ENGLISH: c_int = 0 + 175;
pub const LANGUAGE_ENGLISH_AMERICAN_SAMOA: c_int = 0 + 176;
pub const LANGUAGE_ENGLISH_ANGUILLA: c_int = 0 + 177;
pub const LANGUAGE_ENGLISH_ANTIGUA_AND_BARBUDA: c_int = 0 + 178;
pub const LANGUAGE_ENGLISH_AUSTRALIA: c_int = 0 + 179;
pub const LANGUAGE_ENGLISH_AUSTRIA: c_int = 0 + 180;
pub const LANGUAGE_ENGLISH_BAHAMAS: c_int = 0 + 181;
pub const LANGUAGE_ENGLISH_BARBADOS: c_int = 0 + 182;
pub const LANGUAGE_ENGLISH_BELGIUM: c_int = 0 + 183;
pub const LANGUAGE_ENGLISH_BELIZE: c_int = 0 + 184;
pub const LANGUAGE_ENGLISH_BERMUDA: c_int = 0 + 185;
pub const LANGUAGE_ENGLISH_BOTSWANA: c_int = 0 + 186;
pub const LANGUAGE_ENGLISH_BRITISH_INDIAN_OCEAN_TERRITORY: c_int = 0 + 187;
pub const LANGUAGE_ENGLISH_BRITISH_VIRGIN_ISLANDS: c_int = 0 + 188;
pub const LANGUAGE_ENGLISH_BURUNDI: c_int = 0 + 189;
pub const LANGUAGE_ENGLISH_CAMEROON: c_int = 0 + 190;
pub const LANGUAGE_ENGLISH_CANADA: c_int = 0 + 191;
pub const LANGUAGE_ENGLISH_CARIBBEAN: c_int = 0 + 192;
pub const LANGUAGE_ENGLISH_CARIBBEAN_CB: c_int = 0 + 193;
pub const LANGUAGE_ENGLISH_CAYMAN_ISLANDS: c_int = 0 + 194;
pub const LANGUAGE_ENGLISH_CHRISTMAS_ISLAND: c_int = 0 + 195;
pub const LANGUAGE_ENGLISH_COCOS_KEELING_ISLANDS: c_int = 0 + 196;
pub const LANGUAGE_ENGLISH_COOK_ISLANDS: c_int = 0 + 197;
pub const LANGUAGE_ENGLISH_CYPRUS: c_int = 0 + 198;
pub const LANGUAGE_ENGLISH_DENMARK: c_int = 0 + 199;
pub const LANGUAGE_ENGLISH_DOMINICA: c_int = 0 + 200;
pub const LANGUAGE_ENGLISH_EIRE: c_int = 0 + 201;
pub const LANGUAGE_ENGLISH_ERITREA: c_int = 0 + 202;
pub const LANGUAGE_ENGLISH_ESWATINI: c_int = 0 + 203;
pub const LANGUAGE_ENGLISH_EUROPE: c_int = 0 + 204;
pub const LANGUAGE_ENGLISH_FALKLAND_ISLANDS: c_int = 0 + 205;
pub const LANGUAGE_ENGLISH_FIJI: c_int = 0 + 206;
pub const LANGUAGE_ENGLISH_FINLAND: c_int = 0 + 207;
pub const LANGUAGE_ENGLISH_GAMBIA: c_int = 0 + 208;
pub const LANGUAGE_ENGLISH_GERMANY: c_int = 0 + 209;
pub const LANGUAGE_ENGLISH_GHANA: c_int = 0 + 210;
pub const LANGUAGE_ENGLISH_GIBRALTAR: c_int = 0 + 211;
pub const LANGUAGE_ENGLISH_GRENADA: c_int = 0 + 212;
pub const LANGUAGE_ENGLISH_GUAM: c_int = 0 + 213;
pub const LANGUAGE_ENGLISH_GUERNSEY: c_int = 0 + 214;
pub const LANGUAGE_ENGLISH_GUYANA: c_int = 0 + 215;
pub const LANGUAGE_ENGLISH_HONG_KONG_SAR: c_int = 0 + 216;
pub const LANGUAGE_ENGLISH_INDIA: c_int = 0 + 217;
pub const LANGUAGE_ENGLISH_INDONESIA: c_int = 0 + 218;
pub const LANGUAGE_ENGLISH_ISLE_OF_MAN: c_int = 0 + 219;
pub const LANGUAGE_ENGLISH_ISRAEL: c_int = 0 + 220;
pub const LANGUAGE_ENGLISH_JAMAICA: c_int = 0 + 221;
pub const LANGUAGE_ENGLISH_JERSEY: c_int = 0 + 222;
pub const LANGUAGE_ENGLISH_KENYA: c_int = 0 + 223;
pub const LANGUAGE_ENGLISH_KIRIBATI: c_int = 0 + 224;
pub const LANGUAGE_ENGLISH_LESOTHO: c_int = 0 + 225;
pub const LANGUAGE_ENGLISH_LIBERIA: c_int = 0 + 226;
pub const LANGUAGE_ENGLISH_MACAO_SAR: c_int = 0 + 227;
pub const LANGUAGE_ENGLISH_MADAGASCAR: c_int = 0 + 228;
pub const LANGUAGE_ENGLISH_MALAWI: c_int = 0 + 229;
pub const LANGUAGE_ENGLISH_MALAYSIA: c_int = 0 + 230;
pub const LANGUAGE_ENGLISH_MALTA: c_int = 0 + 231;
pub const LANGUAGE_ENGLISH_MARSHALL_ISLANDS: c_int = 0 + 232;
pub const LANGUAGE_ENGLISH_MAURITIUS: c_int = 0 + 233;
pub const LANGUAGE_ENGLISH_MICRONESIA: c_int = 0 + 234;
pub const LANGUAGE_ENGLISH_MONTSERRAT: c_int = 0 + 235;
pub const LANGUAGE_ENGLISH_NAMIBIA: c_int = 0 + 236;
pub const LANGUAGE_ENGLISH_NAURU: c_int = 0 + 237;
pub const LANGUAGE_ENGLISH_NETHERLANDS: c_int = 0 + 238;
pub const LANGUAGE_ENGLISH_NEW_ZEALAND: c_int = 0 + 239;
pub const LANGUAGE_ENGLISH_NIGERIA: c_int = 0 + 240;
pub const LANGUAGE_ENGLISH_NIUE: c_int = 0 + 241;
pub const LANGUAGE_ENGLISH_NORFOLK_ISLAND: c_int = 0 + 242;
pub const LANGUAGE_ENGLISH_NORTHERN_MARIANA_ISLANDS: c_int = 0 + 243;
pub const LANGUAGE_ENGLISH_PAKISTAN: c_int = 0 + 244;
pub const LANGUAGE_ENGLISH_PALAU: c_int = 0 + 245;
pub const LANGUAGE_ENGLISH_PAPUA_NEW_GUINEA: c_int = 0 + 246;
pub const LANGUAGE_ENGLISH_PHILIPPINES: c_int = 0 + 247;
pub const LANGUAGE_ENGLISH_PITCAIRN_ISLANDS: c_int = 0 + 248;
pub const LANGUAGE_ENGLISH_PUERTO_RICO: c_int = 0 + 249;
pub const LANGUAGE_ENGLISH_RWANDA: c_int = 0 + 250;
pub const LANGUAGE_ENGLISH_SAMOA: c_int = 0 + 251;
pub const LANGUAGE_ENGLISH_SEYCHELLES: c_int = 0 + 252;
pub const LANGUAGE_ENGLISH_SIERRA_LEONE: c_int = 0 + 253;
pub const LANGUAGE_ENGLISH_SINGAPORE: c_int = 0 + 254;
pub const LANGUAGE_ENGLISH_SINT_MAARTEN: c_int = 0 + 255;
pub const LANGUAGE_ENGLISH_SLOVENIA: c_int = 0 + 256;
pub const LANGUAGE_ENGLISH_SOLOMON_ISLANDS: c_int = 0 + 257;
pub const LANGUAGE_ENGLISH_SOUTH_AFRICA: c_int = 0 + 258;
pub const LANGUAGE_ENGLISH_SOUTH_SUDAN: c_int = 0 + 259;
pub const LANGUAGE_ENGLISH_ST_HELENA_ASCENSION_TRISTAN_DA_CUNHA: c_int = 0 + 260;
pub const LANGUAGE_ENGLISH_ST_KITTS_AND_NEVIS: c_int = 0 + 261;
pub const LANGUAGE_ENGLISH_ST_LUCIA: c_int = 0 + 262;
pub const LANGUAGE_ENGLISH_ST_VINCENT_AND_GRENADINES: c_int = 0 + 263;
pub const LANGUAGE_ENGLISH_SUDAN: c_int = 0 + 264;
pub const LANGUAGE_ENGLISH_SWEDEN: c_int = 0 + 265;
pub const LANGUAGE_ENGLISH_SWITZERLAND: c_int = 0 + 266;
pub const LANGUAGE_ENGLISH_TANZANIA: c_int = 0 + 267;
pub const LANGUAGE_ENGLISH_TOKELAU: c_int = 0 + 268;
pub const LANGUAGE_ENGLISH_TONGA: c_int = 0 + 269;
pub const LANGUAGE_ENGLISH_TRINIDAD: c_int = 0 + 270;
pub const LANGUAGE_ENGLISH_TURKS_AND_CAICOS_ISLANDS: c_int = 0 + 271;
pub const LANGUAGE_ENGLISH_TUVALU: c_int = 0 + 272;
pub const LANGUAGE_ENGLISH_UGANDA: c_int = 0 + 273;
pub const LANGUAGE_ENGLISH_UK: c_int = 0 + 274;
pub const LANGUAGE_ENGLISH_UNITED_ARAB_EMIRATES: c_int = 0 + 275;
pub const LANGUAGE_ENGLISH_US: c_int = 0 + 276;
pub const LANGUAGE_ENGLISH_US_OUTLYING_ISLANDS: c_int = 0 + 277;
pub const LANGUAGE_ENGLISH_US_VIRGIN_ISLANDS: c_int = 0 + 278;
pub const LANGUAGE_ENGLISH_VANUATU: c_int = 0 + 279;
pub const LANGUAGE_ENGLISH_WORLD: c_int = 0 + 280;
pub const LANGUAGE_ENGLISH_ZAMBIA: c_int = 0 + 281;
pub const LANGUAGE_ENGLISH_ZIMBABWE: c_int = 0 + 282;
pub const LANGUAGE_ESPERANTO: c_int = 0 + 283;
pub const LANGUAGE_ESPERANTO_WORLD: c_int = 0 + 284;
pub const LANGUAGE_ESTONIAN: c_int = 0 + 285;
pub const LANGUAGE_ESTONIAN_ESTONIA: c_int = 0 + 286;
pub const LANGUAGE_EWE: c_int = 0 + 287;
pub const LANGUAGE_EWE_GHANA: c_int = 0 + 288;
pub const LANGUAGE_EWE_TOGO: c_int = 0 + 289;
pub const LANGUAGE_EWONDO: c_int = 0 + 290;
pub const LANGUAGE_EWONDO_CAMEROON: c_int = 0 + 291;
pub const LANGUAGE_FAEROESE: c_int = 0 + 292;
pub const LANGUAGE_FAEROESE_DENMARK: c_int = 0 + 293;
pub const LANGUAGE_FAEROESE_FAROE_ISLANDS: c_int = 0 + 294;
pub const LANGUAGE_FARSI: c_int = 0 + 295;
pub const LANGUAGE_FIJI: c_int = 0 + 296;
pub const LANGUAGE_FILIPINO: c_int = 0 + 297;
pub const LANGUAGE_FILIPINO_PHILIPPINES: c_int = 0 + 298;
pub const LANGUAGE_FINNISH: c_int = 0 + 299;
pub const LANGUAGE_FINNISH_FINLAND: c_int = 0 + 300;
pub const LANGUAGE_FRENCH: c_int = 0 + 301;
pub const LANGUAGE_FRENCH_ALGERIA: c_int = 0 + 302;
pub const LANGUAGE_FRENCH_BELGIAN: c_int = 0 + 303;
pub const LANGUAGE_FRENCH_BENIN: c_int = 0 + 304;
pub const LANGUAGE_FRENCH_BURKINA_FASO: c_int = 0 + 305;
pub const LANGUAGE_FRENCH_BURUNDI: c_int = 0 + 306;
pub const LANGUAGE_FRENCH_CAMEROON: c_int = 0 + 307;
pub const LANGUAGE_FRENCH_CANADIAN: c_int = 0 + 308;
pub const LANGUAGE_FRENCH_CARIBBEAN: c_int = 0 + 309;
pub const LANGUAGE_FRENCH_CENTRAL_AFRICAN_REPUBLIC: c_int = 0 + 310;
pub const LANGUAGE_FRENCH_CHAD: c_int = 0 + 311;
pub const LANGUAGE_FRENCH_COMOROS: c_int = 0 + 312;
pub const LANGUAGE_FRENCH_CONGO: c_int = 0 + 313;
pub const LANGUAGE_FRENCH_CONGO_DRC: c_int = 0 + 314;
pub const LANGUAGE_FRENCH_COTE_DIVOIRE: c_int = 0 + 315;
pub const LANGUAGE_FRENCH_DJIBOUTI: c_int = 0 + 316;
pub const LANGUAGE_FRENCH_EQUATORIAL_GUINEA: c_int = 0 + 317;
pub const LANGUAGE_FRENCH_FRANCE: c_int = 0 + 318;
pub const LANGUAGE_FRENCH_FRENCH_GUIANA: c_int = 0 + 319;
pub const LANGUAGE_FRENCH_FRENCH_POLYNESIA: c_int = 0 + 320;
pub const LANGUAGE_FRENCH_GABON: c_int = 0 + 321;
pub const LANGUAGE_FRENCH_GUADELOUPE: c_int = 0 + 322;
pub const LANGUAGE_FRENCH_GUINEA: c_int = 0 + 323;
pub const LANGUAGE_FRENCH_HAITI: c_int = 0 + 324;
pub const LANGUAGE_FRENCH_LUXEMBOURG: c_int = 0 + 325;
pub const LANGUAGE_FRENCH_MADAGASCAR: c_int = 0 + 326;
pub const LANGUAGE_FRENCH_MALI: c_int = 0 + 327;
pub const LANGUAGE_FRENCH_MARTINIQUE: c_int = 0 + 328;
pub const LANGUAGE_FRENCH_MAURITANIA: c_int = 0 + 329;
pub const LANGUAGE_FRENCH_MAURITIUS: c_int = 0 + 330;
pub const LANGUAGE_FRENCH_MAYOTTE: c_int = 0 + 331;
pub const LANGUAGE_FRENCH_MONACO: c_int = 0 + 332;
pub const LANGUAGE_FRENCH_MOROCCO: c_int = 0 + 333;
pub const LANGUAGE_FRENCH_NEW_CALEDONIA: c_int = 0 + 334;
pub const LANGUAGE_FRENCH_NIGER: c_int = 0 + 335;
pub const LANGUAGE_FRENCH_REUNION: c_int = 0 + 336;
pub const LANGUAGE_FRENCH_RWANDA: c_int = 0 + 337;
pub const LANGUAGE_FRENCH_SENEGAL: c_int = 0 + 338;
pub const LANGUAGE_FRENCH_SEYCHELLES: c_int = 0 + 339;
pub const LANGUAGE_FRENCH_ST_BARTHELEMY: c_int = 0 + 340;
pub const LANGUAGE_FRENCH_ST_MARTIN: c_int = 0 + 341;
pub const LANGUAGE_FRENCH_ST_PIERRE_AND_MIQUELON: c_int = 0 + 342;
pub const LANGUAGE_FRENCH_SWISS: c_int = 0 + 343;
pub const LANGUAGE_FRENCH_SYRIA: c_int = 0 + 344;
pub const LANGUAGE_FRENCH_TOGO: c_int = 0 + 345;
pub const LANGUAGE_FRENCH_TUNISIA: c_int = 0 + 346;
pub const LANGUAGE_FRENCH_VANUATU: c_int = 0 + 347;
pub const LANGUAGE_FRENCH_WALLIS_AND_FUTUNA: c_int = 0 + 348;
pub const LANGUAGE_FRISIAN: c_int = 0 + 349;
pub const LANGUAGE_FRISIAN_NETHERLANDS: c_int = 0 + 350;
pub const LANGUAGE_FRIULIAN: c_int = 0 + 351;
pub const LANGUAGE_FRIULIAN_ITALY: c_int = 0 + 352;
pub const LANGUAGE_FULAH: c_int = 0 + 353;
pub const LANGUAGE_FULAH_LATIN: c_int = 0 + 354;
pub const LANGUAGE_FULAH_LATIN_BURKINA_FASO: c_int = 0 + 355;
pub const LANGUAGE_FULAH_LATIN_CAMEROON: c_int = 0 + 356;
pub const LANGUAGE_FULAH_LATIN_GAMBIA: c_int = 0 + 357;
pub const LANGUAGE_FULAH_LATIN_GHANA: c_int = 0 + 358;
pub const LANGUAGE_FULAH_LATIN_GUINEA: c_int = 0 + 359;
pub const LANGUAGE_FULAH_LATIN_GUINEA_BISSAU: c_int = 0 + 360;
pub const LANGUAGE_FULAH_LATIN_LIBERIA: c_int = 0 + 361;
pub const LANGUAGE_FULAH_LATIN_MAURITANIA: c_int = 0 + 362;
pub const LANGUAGE_FULAH_LATIN_NIGER: c_int = 0 + 363;
pub const LANGUAGE_FULAH_LATIN_NIGERIA: c_int = 0 + 364;
pub const LANGUAGE_FULAH_LATIN_SENEGAL: c_int = 0 + 365;
pub const LANGUAGE_FULAH_LATIN_SIERRA_LEONE: c_int = 0 + 366;
pub const LANGUAGE_GALICIAN: c_int = 0 + 367;
pub const LANGUAGE_GALICIAN_SPAIN: c_int = 0 + 368;
pub const LANGUAGE_GANDA: c_int = 0 + 369;
pub const LANGUAGE_GANDA_UGANDA: c_int = 0 + 370;
pub const LANGUAGE_GEORGIAN: c_int = 0 + 371;
pub const LANGUAGE_GEORGIAN_GEORGIA: c_int = 0 + 372;
pub const LANGUAGE_GERMAN: c_int = 0 + 373;
pub const LANGUAGE_GERMAN_AUSTRIAN: c_int = 0 + 374;
pub const LANGUAGE_GERMAN_BELGIUM: c_int = 0 + 375;
pub const LANGUAGE_GERMAN_GERMANY: c_int = 0 + 376;
pub const LANGUAGE_GERMAN_ITALY: c_int = 0 + 377;
pub const LANGUAGE_GERMAN_LIECHTENSTEIN: c_int = 0 + 378;
pub const LANGUAGE_GERMAN_LUXEMBOURG: c_int = 0 + 379;
pub const LANGUAGE_GERMAN_SWISS: c_int = 0 + 380;
pub const LANGUAGE_GREEK: c_int = 0 + 381;
pub const LANGUAGE_GREEK_CYPRUS: c_int = 0 + 382;
pub const LANGUAGE_GREEK_GREECE: c_int = 0 + 383;
pub const LANGUAGE_GREENLANDIC: c_int = 0 + 384;
pub const LANGUAGE_GUARANI: c_int = 0 + 385;
pub const LANGUAGE_GUARANI_PARAGUAY: c_int = 0 + 386;
pub const LANGUAGE_GUJARATI: c_int = 0 + 387;
pub const LANGUAGE_GUJARATI_INDIA: c_int = 0 + 388;
pub const LANGUAGE_GUSII: c_int = 0 + 389;
pub const LANGUAGE_GUSII_KENYA: c_int = 0 + 390;
pub const LANGUAGE_HAUSA: c_int = 0 + 391;
pub const LANGUAGE_HAUSA_LATIN: c_int = 0 + 392;
pub const LANGUAGE_HAUSA_LATIN_GHANA: c_int = 0 + 393;
pub const LANGUAGE_HAUSA_LATIN_NIGER: c_int = 0 + 394;
pub const LANGUAGE_HAUSA_LATIN_NIGERIA: c_int = 0 + 395;
pub const LANGUAGE_HAWAIIAN: c_int = 0 + 396;
pub const LANGUAGE_HAWAIIAN_US: c_int = 0 + 397;
pub const LANGUAGE_HEBREW: c_int = 0 + 398;
pub const LANGUAGE_HEBREW_ISRAEL: c_int = 0 + 399;
pub const LANGUAGE_HINDI: c_int = 0 + 400;
pub const LANGUAGE_HINDI_INDIA: c_int = 0 + 401;
pub const LANGUAGE_HUNGARIAN: c_int = 0 + 402;
pub const LANGUAGE_HUNGARIAN_HUNGARY: c_int = 0 + 403;
pub const LANGUAGE_IBIBIO: c_int = 0 + 404;
pub const LANGUAGE_IBIBIO_NIGERIA: c_int = 0 + 405;
pub const LANGUAGE_ICELANDIC: c_int = 0 + 406;
pub const LANGUAGE_ICELANDIC_ICELAND: c_int = 0 + 407;
pub const LANGUAGE_IGBO: c_int = 0 + 408;
pub const LANGUAGE_IGBO_NIGERIA: c_int = 0 + 409;
pub const LANGUAGE_INDONESIAN: c_int = 0 + 410;
pub const LANGUAGE_INDONESIAN_INDONESIA: c_int = 0 + 411;
pub const LANGUAGE_INTERLINGUA: c_int = 0 + 412;
pub const LANGUAGE_INTERLINGUA_WORLD: c_int = 0 + 413;
pub const LANGUAGE_INTERLINGUE: c_int = 0 + 414;
pub const LANGUAGE_INUKTITUT: c_int = 0 + 415;
pub const LANGUAGE_INUKTITUT_LATIN: c_int = 0 + 416;
pub const LANGUAGE_INUKTITUT_LATIN_CANADA: c_int = 0 + 417;
pub const LANGUAGE_INUKTITUT_SYLLABICS: c_int = 0 + 418;
pub const LANGUAGE_INUKTITUT_SYLLABICS_CANADA: c_int = 0 + 419;
pub const LANGUAGE_INUPIAK: c_int = 0 + 420;
pub const LANGUAGE_IRISH: c_int = 0 + 421;
pub const LANGUAGE_IRISH_IRELAND: c_int = 0 + 422;
pub const LANGUAGE_ITALIAN: c_int = 0 + 423;
pub const LANGUAGE_ITALIAN_ITALY: c_int = 0 + 424;
pub const LANGUAGE_ITALIAN_SAN_MARINO: c_int = 0 + 425;
pub const LANGUAGE_ITALIAN_SWISS: c_int = 0 + 426;
pub const LANGUAGE_ITALIAN_VATICAN_CITY: c_int = 0 + 427;
pub const LANGUAGE_JAPANESE: c_int = 0 + 428;
pub const LANGUAGE_JAPANESE_JAPAN: c_int = 0 + 429;
pub const LANGUAGE_JAVANESE: c_int = 0 + 430;
pub const LANGUAGE_JAVANESE_INDONESIA: c_int = 0 + 431;
pub const LANGUAGE_JAVANESE_JAVANESE: c_int = 0 + 432;
pub const LANGUAGE_JAVANESE_JAVANESE_INDONESIA: c_int = 0 + 433;
pub const LANGUAGE_JOLA_FONYI: c_int = 0 + 434;
pub const LANGUAGE_JOLA_FONYI_SENEGAL: c_int = 0 + 435;
pub const LANGUAGE_KABUVERDIANU: c_int = 0 + 436;
pub const LANGUAGE_KABUVERDIANU_CABO_VERDE: c_int = 0 + 437;
pub const LANGUAGE_KABYLE: c_int = 0 + 438;
pub const LANGUAGE_KABYLE_ALGERIA: c_int = 0 + 439;
pub const LANGUAGE_KAKO: c_int = 0 + 440;
pub const LANGUAGE_KAKO_CAMEROON: c_int = 0 + 441;
pub const LANGUAGE_KALAALLISUT: c_int = 0 + 442;
pub const LANGUAGE_KALENJIN: c_int = 0 + 443;
pub const LANGUAGE_KALENJIN_KENYA: c_int = 0 + 444;
pub const LANGUAGE_KAMBA: c_int = 0 + 445;
pub const LANGUAGE_KAMBA_KENYA: c_int = 0 + 446;
pub const LANGUAGE_KANNADA: c_int = 0 + 447;
pub const LANGUAGE_KANNADA_INDIA: c_int = 0 + 448;
pub const LANGUAGE_KANURI: c_int = 0 + 449;
pub const LANGUAGE_KANURI_LATIN: c_int = 0 + 450;
pub const LANGUAGE_KANURI_NIGERIA: c_int = 0 + 451;
pub const LANGUAGE_KASHMIRI: c_int = 0 + 452;
pub const LANGUAGE_KASHMIRI_DEVANAGARI: c_int = 0 + 453;
pub const LANGUAGE_KASHMIRI_DEVANAGARI_INDIA: c_int = 0 + 454;
pub const LANGUAGE_KASHMIRI_INDIA: c_int = 0 + 455;
pub const LANGUAGE_KASHMIRI_PERSO_ARABIC: c_int = 0 + 456;
pub const LANGUAGE_KASHMIRI_PERSO_ARABIC_INDIA: c_int = 0 + 457;
pub const LANGUAGE_KAZAKH: c_int = 0 + 458;
pub const LANGUAGE_KAZAKH_KAZAKHSTAN: c_int = 0 + 459;
pub const LANGUAGE_KHMER: c_int = 0 + 460;
pub const LANGUAGE_KHMER_CAMBODIA: c_int = 0 + 461;
pub const LANGUAGE_KICHE: c_int = 0 + 462;
pub const LANGUAGE_KICHE_GUATEMALA: c_int = 0 + 463;
pub const LANGUAGE_KICHE_LATIN: c_int = 0 + 464;
pub const LANGUAGE_KIKUYU: c_int = 0 + 465;
pub const LANGUAGE_KIKUYU_KENYA: c_int = 0 + 466;
pub const LANGUAGE_KINYARWANDA: c_int = 0 + 467;
pub const LANGUAGE_KINYARWANDA_RWANDA: c_int = 0 + 468;
pub const LANGUAGE_KIRGHIZ: c_int = 0 + 469;
pub const LANGUAGE_KIRGHIZ_KYRGYZSTAN: c_int = 0 + 470;
pub const LANGUAGE_KIRUNDI: c_int = 0 + 471;
pub const LANGUAGE_KIRUNDI_BURUNDI: c_int = 0 + 472;
pub const LANGUAGE_KONKANI: c_int = 0 + 473;
pub const LANGUAGE_KONKANI_INDIA: c_int = 0 + 474;
pub const LANGUAGE_KOREAN: c_int = 0 + 475;
pub const LANGUAGE_KOREAN_KOREA: c_int = 0 + 476;
pub const LANGUAGE_KOREAN_NORTH_KOREA: c_int = 0 + 477;
pub const LANGUAGE_KOYRABORO_SENNI: c_int = 0 + 478;
pub const LANGUAGE_KOYRABORO_SENNI_MALI: c_int = 0 + 479;
pub const LANGUAGE_KOYRA_CHIINI: c_int = 0 + 480;
pub const LANGUAGE_KOYRA_CHIINI_MALI: c_int = 0 + 481;
pub const LANGUAGE_KURDISH: c_int = 0 + 482;
pub const LANGUAGE_KURDISH_PERSO_ARABIC_IRAN: c_int = 0 + 483;
pub const LANGUAGE_KWASIO: c_int = 0 + 484;
pub const LANGUAGE_KWASIO_CAMEROON: c_int = 0 + 485;
pub const LANGUAGE_LAKOTA: c_int = 0 + 486;
pub const LANGUAGE_LAKOTA_US: c_int = 0 + 487;
pub const LANGUAGE_LANGI: c_int = 0 + 488;
pub const LANGUAGE_LANGI_TANZANIA: c_int = 0 + 489;
pub const LANGUAGE_LAOTHIAN: c_int = 0 + 490;
pub const LANGUAGE_LAOTHIAN_LAOS: c_int = 0 + 491;
pub const LANGUAGE_LATIN: c_int = 0 + 492;
pub const LANGUAGE_LATIN_WORLD: c_int = 0 + 493;
pub const LANGUAGE_LATVIAN: c_int = 0 + 494;
pub const LANGUAGE_LATVIAN_LATVIA: c_int = 0 + 495;
pub const LANGUAGE_LINGALA: c_int = 0 + 496;
pub const LANGUAGE_LINGALA_ANGOLA: c_int = 0 + 497;
pub const LANGUAGE_LINGALA_CENTRAL_AFRICAN_REPUBLIC: c_int = 0 + 498;
pub const LANGUAGE_LINGALA_CONGO: c_int = 0 + 499;
pub const LANGUAGE_LINGALA_CONGO_DRC: c_int = 0 + 500;
pub const LANGUAGE_LITHUANIAN: c_int = 0 + 501;
pub const LANGUAGE_LITHUANIAN_LITHUANIA: c_int = 0 + 502;
pub const LANGUAGE_LOWER_SORBIAN: c_int = 0 + 503;
pub const LANGUAGE_LOWER_SORBIAN_GERMANY: c_int = 0 + 504;
pub const LANGUAGE_LOW_GERMAN: c_int = 0 + 505;
pub const LANGUAGE_LOW_GERMAN_GERMANY: c_int = 0 + 506;
pub const LANGUAGE_LOW_GERMAN_NETHERLANDS: c_int = 0 + 507;
pub const LANGUAGE_LUBA_KATANGA: c_int = 0 + 508;
pub const LANGUAGE_LUBA_KATANGA_CONGO_DRC: c_int = 0 + 509;
pub const LANGUAGE_LUO: c_int = 0 + 510;
pub const LANGUAGE_LUO_KENYA: c_int = 0 + 511;
pub const LANGUAGE_LUXEMBOURGISH: c_int = 0 + 512;
pub const LANGUAGE_LUXEMBOURGISH_LUXEMBOURG: c_int = 0 + 513;
pub const LANGUAGE_LUYIA: c_int = 0 + 514;
pub const LANGUAGE_LUYIA_KENYA: c_int = 0 + 515;
pub const LANGUAGE_MACEDONIAN: c_int = 0 + 516;
pub const LANGUAGE_MACEDONIAN_NORTH_MACEDONIA: c_int = 0 + 517;
pub const LANGUAGE_MACHAME: c_int = 0 + 518;
pub const LANGUAGE_MACHAME_TANZANIA: c_int = 0 + 519;
pub const LANGUAGE_MAKHUWA_MEETTO: c_int = 0 + 520;
pub const LANGUAGE_MAKHUWA_MEETTO_MOZAMBIQUE: c_int = 0 + 521;
pub const LANGUAGE_MAKONDE: c_int = 0 + 522;
pub const LANGUAGE_MAKONDE_TANZANIA: c_int = 0 + 523;
pub const LANGUAGE_MALAGASY: c_int = 0 + 524;
pub const LANGUAGE_MALAGASY_MADAGASCAR: c_int = 0 + 525;
pub const LANGUAGE_MALAY: c_int = 0 + 526;
pub const LANGUAGE_MALAYALAM: c_int = 0 + 527;
pub const LANGUAGE_MALAYALAM_INDIA: c_int = 0 + 528;
pub const LANGUAGE_MALAY_BRUNEI: c_int = 0 + 529;
pub const LANGUAGE_MALAY_MALAYSIA: c_int = 0 + 530;
pub const LANGUAGE_MALAY_SINGAPORE: c_int = 0 + 531;
pub const LANGUAGE_MALTESE: c_int = 0 + 532;
pub const LANGUAGE_MALTESE_MALTA: c_int = 0 + 533;
pub const LANGUAGE_MANIPURI: c_int = 0 + 534;
pub const LANGUAGE_MANIPURI_INDIA: c_int = 0 + 535;
pub const LANGUAGE_MANX: c_int = 0 + 536;
pub const LANGUAGE_MANX_ISLE_OF_MAN: c_int = 0 + 537;
pub const LANGUAGE_MAORI: c_int = 0 + 538;
pub const LANGUAGE_MAORI_NEW_ZEALAND: c_int = 0 + 539;
pub const LANGUAGE_MAPUCHE: c_int = 0 + 540;
pub const LANGUAGE_MAPUCHE_CHILE: c_int = 0 + 541;
pub const LANGUAGE_MARATHI: c_int = 0 + 542;
pub const LANGUAGE_MARATHI_INDIA: c_int = 0 + 543;
pub const LANGUAGE_MASAI: c_int = 0 + 544;
pub const LANGUAGE_MASAI_KENYA: c_int = 0 + 545;
pub const LANGUAGE_MASAI_TANZANIA: c_int = 0 + 546;
pub const LANGUAGE_MAZANDERANI: c_int = 0 + 547;
pub const LANGUAGE_MAZANDERANI_IRAN: c_int = 0 + 548;
pub const LANGUAGE_MERU: c_int = 0 + 549;
pub const LANGUAGE_MERU_KENYA: c_int = 0 + 550;
pub const LANGUAGE_META: c_int = 0 + 551;
pub const LANGUAGE_META_CAMEROON: c_int = 0 + 552;
pub const LANGUAGE_MOHAWK: c_int = 0 + 553;
pub const LANGUAGE_MOHAWK_CANADA: c_int = 0 + 554;
pub const LANGUAGE_MOLDAVIAN: c_int = 0 + 555;
pub const LANGUAGE_MONGOLIAN: c_int = 0 + 556;
pub const LANGUAGE_MONGOLIAN_CYRILLIC: c_int = 0 + 557;
pub const LANGUAGE_MONGOLIAN_MONGOLIA: c_int = 0 + 558;
pub const LANGUAGE_MONGOLIAN_TRADITIONAL: c_int = 0 + 559;
pub const LANGUAGE_MONGOLIAN_TRADITIONAL_CHINA: c_int = 0 + 560;
pub const LANGUAGE_MONGOLIAN_TRADITIONAL_MONGOLIA: c_int = 0 + 561;
pub const LANGUAGE_MORISYEN: c_int = 0 + 562;
pub const LANGUAGE_MORISYEN_MAURITIUS: c_int = 0 + 563;
pub const LANGUAGE_MUNDANG: c_int = 0 + 564;
pub const LANGUAGE_MUNDANG_CAMEROON: c_int = 0 + 565;
pub const LANGUAGE_NAMA: c_int = 0 + 566;
pub const LANGUAGE_NAMA_NAMIBIA: c_int = 0 + 567;
pub const LANGUAGE_NAURU: c_int = 0 + 568;
pub const LANGUAGE_NEPALI: c_int = 0 + 569;
pub const LANGUAGE_NEPALI_INDIA: c_int = 0 + 570;
pub const LANGUAGE_NEPALI_NEPAL: c_int = 0 + 571;
pub const LANGUAGE_NGIEMBOON: c_int = 0 + 572;
pub const LANGUAGE_NGIEMBOON_CAMEROON: c_int = 0 + 573;
pub const LANGUAGE_NGOMBA: c_int = 0 + 574;
pub const LANGUAGE_NGOMBA_CAMEROON: c_int = 0 + 575;
pub const LANGUAGE_NKO: c_int = 0 + 576;
pub const LANGUAGE_NKO_GUINEA: c_int = 0 + 577;
pub const LANGUAGE_NORTHERN_LURI: c_int = 0 + 578;
pub const LANGUAGE_NORTHERN_LURI_IRAN: c_int = 0 + 579;
pub const LANGUAGE_NORTHERN_LURI_IRAQ: c_int = 0 + 580;
pub const LANGUAGE_NORTH_NDEBELE: c_int = 0 + 581;
pub const LANGUAGE_NORTH_NDEBELE_ZIMBABWE: c_int = 0 + 582;
pub const LANGUAGE_NORWEGIAN: c_int = 0 + 583;
pub const LANGUAGE_NORWEGIAN_BOKMAL: c_int = 0 + 584;
pub const LANGUAGE_NORWEGIAN_BOKMAL_NORWAY: c_int = 0 + 585;
pub const LANGUAGE_NORWEGIAN_BOKMAL_SVALBARD_AND_JAN_MAYEN: c_int = 0 + 586;
pub const LANGUAGE_NORWEGIAN_NYNORSK: c_int = 0 + 587;
pub const LANGUAGE_NORWEGIAN_NYNORSK_NORWAY: c_int = 0 + 588;
pub const LANGUAGE_NUER: c_int = 0 + 589;
pub const LANGUAGE_NUER_SOUTH_SUDAN: c_int = 0 + 590;
pub const LANGUAGE_NYANKOLE: c_int = 0 + 591;
pub const LANGUAGE_NYANKOLE_UGANDA: c_int = 0 + 592;
pub const LANGUAGE_OCCITAN: c_int = 0 + 593;
pub const LANGUAGE_OCCITAN_FRANCE: c_int = 0 + 594;
pub const LANGUAGE_ODIA: c_int = 0 + 595;
pub const LANGUAGE_ODIA_INDIA: c_int = 0 + 596;
pub const LANGUAGE_OROMO: c_int = 0 + 597;
pub const LANGUAGE_OROMO_ETHIOPIA: c_int = 0 + 598;
pub const LANGUAGE_OROMO_KENYA: c_int = 0 + 599;
pub const LANGUAGE_OSSETIC: c_int = 0 + 600;
pub const LANGUAGE_OSSETIC_GEORGIA: c_int = 0 + 601;
pub const LANGUAGE_OSSETIC_RUSSIA: c_int = 0 + 602;
pub const LANGUAGE_PAPIAMENTO: c_int = 0 + 603;
pub const LANGUAGE_PAPIAMENTO_CARIBBEAN: c_int = 0 + 604;
pub const LANGUAGE_PASHTO: c_int = 0 + 605;
pub const LANGUAGE_PASHTO_AFGHANISTAN: c_int = 0 + 606;
pub const LANGUAGE_PASHTO_PAKISTAN: c_int = 0 + 607;
pub const LANGUAGE_PERSIAN_IRAN: c_int = 0 + 608;
pub const LANGUAGE_POLISH: c_int = 0 + 609;
pub const LANGUAGE_POLISH_POLAND: c_int = 0 + 610;
pub const LANGUAGE_PORTUGUESE: c_int = 0 + 611;
pub const LANGUAGE_PORTUGUESE_ANGOLA: c_int = 0 + 612;
pub const LANGUAGE_PORTUGUESE_BRAZILIAN: c_int = 0 + 613;
pub const LANGUAGE_PORTUGUESE_CABO_VERDE: c_int = 0 + 614;
pub const LANGUAGE_PORTUGUESE_EQUATORIAL_GUINEA: c_int = 0 + 615;
pub const LANGUAGE_PORTUGUESE_GUINEA_BISSAU: c_int = 0 + 616;
pub const LANGUAGE_PORTUGUESE_LUXEMBOURG: c_int = 0 + 617;
pub const LANGUAGE_PORTUGUESE_MACAO_SAR: c_int = 0 + 618;
pub const LANGUAGE_PORTUGUESE_MOZAMBIQUE: c_int = 0 + 619;
pub const LANGUAGE_PORTUGUESE_PORTUGAL: c_int = 0 + 620;
pub const LANGUAGE_PORTUGUESE_SAO_TOME_AND_PRINCIPE: c_int = 0 + 621;
pub const LANGUAGE_PORTUGUESE_SWITZERLAND: c_int = 0 + 622;
pub const LANGUAGE_PORTUGUESE_TIMOR_LESTE: c_int = 0 + 623;
pub const LANGUAGE_PRUSSIAN: c_int = 0 + 624;
pub const LANGUAGE_PRUSSIAN_WORLD: c_int = 0 + 625;
pub const LANGUAGE_PUNJABI: c_int = 0 + 626;
pub const LANGUAGE_PUNJABI_ARABIC: c_int = 0 + 627;
pub const LANGUAGE_PUNJABI_GURMUKHI: c_int = 0 + 628;
pub const LANGUAGE_PUNJABI_INDIA: c_int = 0 + 629;
pub const LANGUAGE_PUNJABI_PAKISTAN: c_int = 0 + 630;
pub const LANGUAGE_QUECHUA: c_int = 0 + 631;
pub const LANGUAGE_QUECHUA_BOLIVIA: c_int = 0 + 632;
pub const LANGUAGE_QUECHUA_ECUADOR: c_int = 0 + 633;
pub const LANGUAGE_QUECHUA_MACRO: c_int = 0 + 634;
pub const LANGUAGE_QUECHUA_PERU: c_int = 0 + 635;
pub const LANGUAGE_RHAETO_ROMANCE: c_int = 0 + 636;
pub const LANGUAGE_RHAETO_ROMANCE_SWITZERLAND: c_int = 0 + 637;
pub const LANGUAGE_ROMANIAN: c_int = 0 + 638;
pub const LANGUAGE_ROMANIAN_MOLDOVA: c_int = 0 + 639;
pub const LANGUAGE_ROMANIAN_ROMANIA: c_int = 0 + 640;
pub const LANGUAGE_ROMBO: c_int = 0 + 641;
pub const LANGUAGE_ROMBO_TANZANIA: c_int = 0 + 642;
pub const LANGUAGE_RUSSIAN: c_int = 0 + 643;
pub const LANGUAGE_RUSSIAN_BELARUS: c_int = 0 + 644;
pub const LANGUAGE_RUSSIAN_KAZAKHSTAN: c_int = 0 + 645;
pub const LANGUAGE_RUSSIAN_KYRGYZSTAN: c_int = 0 + 646;
pub const LANGUAGE_RUSSIAN_MOLDOVA: c_int = 0 + 647;
pub const LANGUAGE_RUSSIAN_RUSSIA: c_int = 0 + 648;
pub const LANGUAGE_RUSSIAN_UKRAINE: c_int = 0 + 649;
pub const LANGUAGE_RWA: c_int = 0 + 650;
pub const LANGUAGE_RWA_TANZANIA: c_int = 0 + 651;
pub const LANGUAGE_SAHO: c_int = 0 + 652;
pub const LANGUAGE_SAHO_ERITREA: c_int = 0 + 653;
pub const LANGUAGE_SAKHA: c_int = 0 + 654;
pub const LANGUAGE_SAKHA_RUSSIA: c_int = 0 + 655;
pub const LANGUAGE_SAMBURU: c_int = 0 + 656;
pub const LANGUAGE_SAMBURU_KENYA: c_int = 0 + 657;
pub const LANGUAGE_SAMI: c_int = 0 + 658;
pub const LANGUAGE_SAMI_FINLAND: c_int = 0 + 659;
pub const LANGUAGE_SAMI_INARI: c_int = 0 + 660;
pub const LANGUAGE_SAMI_INARI_FINLAND: c_int = 0 + 661;
pub const LANGUAGE_SAMI_LULE: c_int = 0 + 662;
pub const LANGUAGE_SAMI_LULE_NORWAY: c_int = 0 + 663;
pub const LANGUAGE_SAMI_LULE_SWEDEN: c_int = 0 + 664;
pub const LANGUAGE_SAMI_NORWAY: c_int = 0 + 665;
pub const LANGUAGE_SAMI_SKOLT: c_int = 0 + 666;
pub const LANGUAGE_SAMI_SKOLT_FINLAND: c_int = 0 + 667;
pub const LANGUAGE_SAMI_SOUTHERN: c_int = 0 + 668;
pub const LANGUAGE_SAMI_SOUTHERN_NORWAY: c_int = 0 + 669;
pub const LANGUAGE_SAMI_SOUTHERN_SWEDEN: c_int = 0 + 670;
pub const LANGUAGE_SAMI_SWEDEN: c_int = 0 + 671;
pub const LANGUAGE_SAMOAN: c_int = 0 + 672;
pub const LANGUAGE_SANGHO: c_int = 0 + 673;
pub const LANGUAGE_SANGHO_CENTRAL_AFRICAN_REPUBLIC: c_int = 0 + 674;
pub const LANGUAGE_SANGU: c_int = 0 + 675;
pub const LANGUAGE_SANGU_TANZANIA: c_int = 0 + 676;
pub const LANGUAGE_SANSKRIT: c_int = 0 + 677;
pub const LANGUAGE_SANSKRIT_INDIA: c_int = 0 + 678;
pub const LANGUAGE_SCOTS_GAELIC: c_int = 0 + 679;
pub const LANGUAGE_SCOTS_GAELIC_UK: c_int = 0 + 680;
pub const LANGUAGE_SENA: c_int = 0 + 681;
pub const LANGUAGE_SENA_MOZAMBIQUE: c_int = 0 + 682;
pub const LANGUAGE_SERBIAN: c_int = 0 + 683;
pub const LANGUAGE_SERBIAN_CYRILLIC: c_int = 0 + 684;
pub const LANGUAGE_SERBIAN_CYRILLIC_BOSNIA_AND_HERZEGOVINA: c_int = 0 + 685;
pub const LANGUAGE_SERBIAN_CYRILLIC_KOSOVO: c_int = 0 + 686;
pub const LANGUAGE_SERBIAN_CYRILLIC_MONTENEGRO: c_int = 0 + 687;
pub const LANGUAGE_SERBIAN_CYRILLIC_SERBIA: c_int = 0 + 688;
pub const LANGUAGE_SERBIAN_CYRILLIC_YU: c_int = 0 + 689;
pub const LANGUAGE_SERBIAN_LATIN: c_int = 0 + 690;
pub const LANGUAGE_SERBIAN_LATIN_BOSNIA_AND_HERZEGOVINA: c_int = 0 + 691;
pub const LANGUAGE_SERBIAN_LATIN_KOSOVO: c_int = 0 + 692;
pub const LANGUAGE_SERBIAN_LATIN_MONTENEGRO: c_int = 0 + 693;
pub const LANGUAGE_SERBIAN_LATIN_SERBIA: c_int = 0 + 694;
pub const LANGUAGE_SERBIAN_LATIN_YU: c_int = 0 + 695;
pub const LANGUAGE_SERBIAN_SERBIA: c_int = 0 + 696;
pub const LANGUAGE_SERBIAN_YU: c_int = 0 + 697;
pub const LANGUAGE_SERBO_CROATIAN: c_int = 0 + 698;
pub const LANGUAGE_SESOTHO: c_int = 0 + 699;
pub const LANGUAGE_SESOTHO_LESOTHO: c_int = 0 + 700;
pub const LANGUAGE_SESOTHO_SA_LEBOA: c_int = 0 + 701;
pub const LANGUAGE_SESOTHO_SA_LEBOA_SOUTH_AFRICA: c_int = 0 + 702;
pub const LANGUAGE_SESOTHO_SOUTH_AFRICA: c_int = 0 + 703;
pub const LANGUAGE_SETSWANA: c_int = 0 + 704;
pub const LANGUAGE_SETSWANA_BOTSWANA: c_int = 0 + 705;
pub const LANGUAGE_SETSWANA_SOUTH_AFRICA: c_int = 0 + 706;
pub const LANGUAGE_SHAMBALA: c_int = 0 + 707;
pub const LANGUAGE_SHAMBALA_TANZANIA: c_int = 0 + 708;
pub const LANGUAGE_SHONA: c_int = 0 + 709;
pub const LANGUAGE_SHONA_LATIN: c_int = 0 + 710;
pub const LANGUAGE_SHONA_LATIN_ZIMBABWE: c_int = 0 + 711;
pub const LANGUAGE_SINDHI: c_int = 0 + 712;
pub const LANGUAGE_SINDHI_ARABIC: c_int = 0 + 713;
pub const LANGUAGE_SINDHI_DEVANAGARI: c_int = 0 + 714;
pub const LANGUAGE_SINDHI_DEVANAGARI_INDIA: c_int = 0 + 715;
pub const LANGUAGE_SINDHI_PAKISTAN: c_int = 0 + 716;
pub const LANGUAGE_SINHALESE: c_int = 0 + 717;
pub const LANGUAGE_SINHALESE_SRI_LANKA: c_int = 0 + 718;
pub const LANGUAGE_SISWATI: c_int = 0 + 719;
pub const LANGUAGE_SISWATI_ESWATINI: c_int = 0 + 720;
pub const LANGUAGE_SISWATI_SOUTH_AFRICA: c_int = 0 + 721;
pub const LANGUAGE_SLOVAK: c_int = 0 + 722;
pub const LANGUAGE_SLOVAK_SLOVAKIA: c_int = 0 + 723;
pub const LANGUAGE_SLOVENIAN: c_int = 0 + 724;
pub const LANGUAGE_SLOVENIAN_SLOVENIA: c_int = 0 + 725;
pub const LANGUAGE_SOGA: c_int = 0 + 726;
pub const LANGUAGE_SOGA_UGANDA: c_int = 0 + 727;
pub const LANGUAGE_SOMALI: c_int = 0 + 728;
pub const LANGUAGE_SOMALI_DJIBOUTI: c_int = 0 + 729;
pub const LANGUAGE_SOMALI_ETHIOPIA: c_int = 0 + 730;
pub const LANGUAGE_SOMALI_KENYA: c_int = 0 + 731;
pub const LANGUAGE_SOMALI_SOMALIA: c_int = 0 + 732;
pub const LANGUAGE_SOUTH_NDEBELE: c_int = 0 + 733;
pub const LANGUAGE_SOUTH_NDEBELE_SOUTH_AFRICA: c_int = 0 + 734;
pub const LANGUAGE_SPANISH: c_int = 0 + 735;
pub const LANGUAGE_SPANISH_ARGENTINA: c_int = 0 + 736;
pub const LANGUAGE_SPANISH_BELIZE: c_int = 0 + 737;
pub const LANGUAGE_SPANISH_BOLIVIA: c_int = 0 + 738;
pub const LANGUAGE_SPANISH_BRAZIL: c_int = 0 + 739;
pub const LANGUAGE_SPANISH_CHILE: c_int = 0 + 740;
pub const LANGUAGE_SPANISH_COLOMBIA: c_int = 0 + 741;
pub const LANGUAGE_SPANISH_COSTA_RICA: c_int = 0 + 742;
pub const LANGUAGE_SPANISH_CUBA: c_int = 0 + 743;
pub const LANGUAGE_SPANISH_DOMINICAN_REPUBLIC: c_int = 0 + 744;
pub const LANGUAGE_SPANISH_ECUADOR: c_int = 0 + 745;
pub const LANGUAGE_SPANISH_EL_SALVADOR: c_int = 0 + 746;
pub const LANGUAGE_SPANISH_EQUATORIAL_GUINEA: c_int = 0 + 747;
pub const LANGUAGE_SPANISH_GUATEMALA: c_int = 0 + 748;
pub const LANGUAGE_SPANISH_HONDURAS: c_int = 0 + 749;
pub const LANGUAGE_SPANISH_LATIN_AMERICA: c_int = 0 + 750;
pub const LANGUAGE_SPANISH_MEXICAN: c_int = 0 + 751;
pub const LANGUAGE_SPANISH_NICARAGUA: c_int = 0 + 752;
pub const LANGUAGE_SPANISH_PANAMA: c_int = 0 + 753;
pub const LANGUAGE_SPANISH_PARAGUAY: c_int = 0 + 754;
pub const LANGUAGE_SPANISH_PERU: c_int = 0 + 755;
pub const LANGUAGE_SPANISH_PHILIPPINES: c_int = 0 + 756;
pub const LANGUAGE_SPANISH_PUERTO_RICO: c_int = 0 + 757;
pub const LANGUAGE_SPANISH_SPAIN: c_int = 0 + 758;
pub const LANGUAGE_SPANISH_URUGUAY: c_int = 0 + 759;
pub const LANGUAGE_SPANISH_US: c_int = 0 + 760;
pub const LANGUAGE_SPANISH_VENEZUELA: c_int = 0 + 761;
pub const LANGUAGE_STANDARD_MOROCCAN_TAMAZIGHT: c_int = 0 + 762;
pub const LANGUAGE_STANDARD_MOROCCAN_TAMAZIGHT_TIFINAGH: c_int = 0 + 763;
pub const LANGUAGE_STANDARD_MOROCCAN_TAMAZIGHT_TIFINAGH_MOROCCO: c_int = 0 + 764;
pub const LANGUAGE_SUNDANESE: c_int = 0 + 765;
pub const LANGUAGE_SWAHILI: c_int = 0 + 766;
pub const LANGUAGE_SWAHILI_CONGO_DRC: c_int = 0 + 767;
pub const LANGUAGE_SWAHILI_KENYA: c_int = 0 + 768;
pub const LANGUAGE_SWAHILI_TANZANIA: c_int = 0 + 769;
pub const LANGUAGE_SWAHILI_UGANDA: c_int = 0 + 770;
pub const LANGUAGE_SWEDISH: c_int = 0 + 771;
pub const LANGUAGE_SWEDISH_ALAND_ISLANDS: c_int = 0 + 772;
pub const LANGUAGE_SWEDISH_FINLAND: c_int = 0 + 773;
pub const LANGUAGE_SWEDISH_SWEDEN: c_int = 0 + 774;
pub const LANGUAGE_SWISS_GERMAN: c_int = 0 + 775;
pub const LANGUAGE_SWISS_GERMAN_LIECHTENSTEIN: c_int = 0 + 776;
pub const LANGUAGE_SWISS_GERMAN_SWITZERLAND: c_int = 0 + 777;
pub const LANGUAGE_SYRIAC: c_int = 0 + 778;
pub const LANGUAGE_SYRIAC_SYRIA: c_int = 0 + 779;
pub const LANGUAGE_TACHELHIT: c_int = 0 + 780;
pub const LANGUAGE_TACHELHIT_LATIN: c_int = 0 + 781;
pub const LANGUAGE_TACHELHIT_LATIN_MOROCCO: c_int = 0 + 782;
pub const LANGUAGE_TACHELHIT_TIFINAGH: c_int = 0 + 783;
pub const LANGUAGE_TACHELHIT_TIFINAGH_MOROCCO: c_int = 0 + 784;
pub const LANGUAGE_TAGALOG: c_int = 0 + 785;
pub const LANGUAGE_TAITA: c_int = 0 + 786;
pub const LANGUAGE_TAITA_KENYA: c_int = 0 + 787;
pub const LANGUAGE_TAJIK: c_int = 0 + 788;
pub const LANGUAGE_TAJIK_CYRILLIC: c_int = 0 + 789;
pub const LANGUAGE_TAJIK_CYRILLIC_TAJIKISTAN: c_int = 0 + 790;
pub const LANGUAGE_TAMIL: c_int = 0 + 791;
pub const LANGUAGE_TAMIL_INDIA: c_int = 0 + 792;
pub const LANGUAGE_TAMIL_MALAYSIA: c_int = 0 + 793;
pub const LANGUAGE_TAMIL_SINGAPORE: c_int = 0 + 794;
pub const LANGUAGE_TAMIL_SRI_LANKA: c_int = 0 + 795;
pub const LANGUAGE_TASAWAQ: c_int = 0 + 796;
pub const LANGUAGE_TASAWAQ_NIGER: c_int = 0 + 797;
pub const LANGUAGE_TATAR: c_int = 0 + 798;
pub const LANGUAGE_TATAR_RUSSIA: c_int = 0 + 799;
pub const LANGUAGE_TELUGU: c_int = 0 + 800;
pub const LANGUAGE_TELUGU_INDIA: c_int = 0 + 801;
pub const LANGUAGE_TESO: c_int = 0 + 802;
pub const LANGUAGE_TESO_KENYA: c_int = 0 + 803;
pub const LANGUAGE_TESO_UGANDA: c_int = 0 + 804;
pub const LANGUAGE_THAI: c_int = 0 + 805;
pub const LANGUAGE_THAI_THAILAND: c_int = 0 + 806;
pub const LANGUAGE_TIBETAN: c_int = 0 + 807;
pub const LANGUAGE_TIBETAN_CHINA: c_int = 0 + 808;
pub const LANGUAGE_TIBETAN_INDIA: c_int = 0 + 809;
pub const LANGUAGE_TIGRE: c_int = 0 + 810;
pub const LANGUAGE_TIGRE_ERITREA: c_int = 0 + 811;
pub const LANGUAGE_TIGRINYA: c_int = 0 + 812;
pub const LANGUAGE_TIGRINYA_ERITREA: c_int = 0 + 813;
pub const LANGUAGE_TIGRINYA_ETHIOPIA: c_int = 0 + 814;
pub const LANGUAGE_TONGA: c_int = 0 + 815;
pub const LANGUAGE_TONGA_TONGA: c_int = 0 + 816;
pub const LANGUAGE_TSONGA: c_int = 0 + 817;
pub const LANGUAGE_TSONGA_SOUTH_AFRICA: c_int = 0 + 818;
pub const LANGUAGE_TURKISH: c_int = 0 + 819;
pub const LANGUAGE_TURKISH_CYPRUS: c_int = 0 + 820;
pub const LANGUAGE_TURKISH_TURKEY: c_int = 0 + 821;
pub const LANGUAGE_TURKMEN: c_int = 0 + 822;
pub const LANGUAGE_TURKMEN_TURKMENISTAN: c_int = 0 + 823;
pub const LANGUAGE_TWI: c_int = 0 + 824;
pub const LANGUAGE_UIGHUR: c_int = 0 + 825;
pub const LANGUAGE_UIGHUR_CHINA: c_int = 0 + 826;
pub const LANGUAGE_UKRAINIAN: c_int = 0 + 827;
pub const LANGUAGE_UKRAINIAN_UKRAINE: c_int = 0 + 828;
pub const LANGUAGE_UPPER_SORBIAN: c_int = 0 + 829;
pub const LANGUAGE_UPPER_SORBIAN_GERMANY: c_int = 0 + 830;
pub const LANGUAGE_URDU: c_int = 0 + 831;
pub const LANGUAGE_URDU_INDIA: c_int = 0 + 832;
pub const LANGUAGE_URDU_PAKISTAN: c_int = 0 + 833;
pub const LANGUAGE_UZBEK: c_int = 0 + 834;
pub const LANGUAGE_UZBEK_CYRILLIC: c_int = 0 + 835;
pub const LANGUAGE_UZBEK_CYRILLIC_UZBEKISTAN: c_int = 0 + 836;
pub const LANGUAGE_UZBEK_LATIN: c_int = 0 + 837;
pub const LANGUAGE_UZBEK_LATIN_UZBEKISTAN: c_int = 0 + 838;
pub const LANGUAGE_UZBEK_PERSO_ARABIC: c_int = 0 + 839;
pub const LANGUAGE_UZBEK_PERSO_ARABIC_AFGHANISTAN: c_int = 0 + 840;
pub const LANGUAGE_VAI: c_int = 0 + 841;
pub const LANGUAGE_VAI_LATIN: c_int = 0 + 842;
pub const LANGUAGE_VAI_LATIN_LIBERIA: c_int = 0 + 843;
pub const LANGUAGE_VAI_VAI: c_int = 0 + 844;
pub const LANGUAGE_VAI_VAI_LIBERIA: c_int = 0 + 845;
pub const LANGUAGE_VALENCIAN: c_int = 0 + 846;
pub const LANGUAGE_VENDA: c_int = 0 + 847;
pub const LANGUAGE_VENDA_SOUTH_AFRICA: c_int = 0 + 848;
pub const LANGUAGE_VIETNAMESE: c_int = 0 + 849;
pub const LANGUAGE_VIETNAMESE_VIETNAM: c_int = 0 + 850;
pub const LANGUAGE_VOLAPUK: c_int = 0 + 851;
pub const LANGUAGE_VOLAPUK_WORLD: c_int = 0 + 852;
pub const LANGUAGE_VUNJO: c_int = 0 + 853;
pub const LANGUAGE_VUNJO_TANZANIA: c_int = 0 + 854;
pub const LANGUAGE_WALSER: c_int = 0 + 855;
pub const LANGUAGE_WALSER_SWITZERLAND: c_int = 0 + 856;
pub const LANGUAGE_WELSH: c_int = 0 + 857;
pub const LANGUAGE_WELSH_UK: c_int = 0 + 858;
pub const LANGUAGE_WOLAYTTA: c_int = 0 + 859;
pub const LANGUAGE_WOLAYTTA_ETHIOPIA: c_int = 0 + 860;
pub const LANGUAGE_WOLOF: c_int = 0 + 861;
pub const LANGUAGE_WOLOF_SENEGAL: c_int = 0 + 862;
pub const LANGUAGE_XHOSA: c_int = 0 + 863;
pub const LANGUAGE_XHOSA_SOUTH_AFRICA: c_int = 0 + 864;
pub const LANGUAGE_YANGBEN: c_int = 0 + 865;
pub const LANGUAGE_YANGBEN_CAMEROON: c_int = 0 + 866;
pub const LANGUAGE_YI: c_int = 0 + 867;
pub const LANGUAGE_YIDDISH: c_int = 0 + 868;
pub const LANGUAGE_YIDDISH_WORLD: c_int = 0 + 869;
pub const LANGUAGE_YI_CHINA: c_int = 0 + 870;
pub const LANGUAGE_YORUBA: c_int = 0 + 871;
pub const LANGUAGE_YORUBA_BENIN: c_int = 0 + 872;
pub const LANGUAGE_YORUBA_NIGERIA: c_int = 0 + 873;
pub const LANGUAGE_ZARMA: c_int = 0 + 874;
pub const LANGUAGE_ZARMA_NIGER: c_int = 0 + 875;
pub const LANGUAGE_ZHUANG: c_int = 0 + 876;
pub const LANGUAGE_ZULU: c_int = 0 + 877;
pub const LANGUAGE_ZULU_SOUTH_AFRICA: c_int = 0 + 878;
pub const LANGUAGE_USER_DEFINED: c_int = 0 + 879;
pub const LANGUAGE_AZERI: c_int = LANGUAGE_AZERBAIJANI;
pub const LANGUAGE_AZERI_CYRILLIC: c_int = LANGUAGE_AZERBAIJANI_CYRILLIC;
pub const LANGUAGE_AZERI_LATIN: c_int = LANGUAGE_AZERBAIJANI_LATIN;
pub const LANGUAGE_BENGALI: c_int = LANGUAGE_BANGLA;
pub const LANGUAGE_BENGALI_BANGLADESH: c_int = LANGUAGE_BANGLA_BANGLADESH;
pub const LANGUAGE_BENGALI_INDIA: c_int = LANGUAGE_BANGLA_INDIA;
pub const LANGUAGE_BHUTANI: c_int = LANGUAGE_DZONGKHA;
pub const LANGUAGE_CHINESE_SIMPLIFIED: c_int = LANGUAGE_CHINESE_CHINA;
pub const LANGUAGE_CHINESE_TRADITIONAL: c_int = LANGUAGE_CHINESE_TAIWAN;
pub const LANGUAGE_CHINESE_MACAU: c_int = LANGUAGE_CHINESE_MACAO;
pub const LANGUAGE_KERNEWEK: c_int = LANGUAGE_CORNISH;
pub const LANGUAGE_MALAY_BRUNEI_DARUSSALAM: c_int = LANGUAGE_MALAY_BRUNEI;
pub const LANGUAGE_ORIYA: c_int = LANGUAGE_ODIA;
pub const LANGUAGE_ORIYA_INDIA: c_int = LANGUAGE_ODIA_INDIA;
pub const LANGUAGE_SPANISH_MODERN: c_int = LANGUAGE_SPANISH;
...
pub const MC_NO_AUTORESIZE: c_int = 0x0001;
//  ENUM: wxMediaState
...
pub const MEDIACTRLPLAYERCONTROLS_DEFAULT: c_int =
    MEDIACTRLPLAYERCONTROLS_STEP | MEDIACTRLPLAYERCONTROLS_VOLUME;
...
pub const PREVIEW_DEFAULT: c_int =
    (PREVIEW_PREVIOUS | PREVIEW_NEXT | PREVIEW_ZOOM | PREVIEW_FIRST | PREVIEW_GOTO | PREVIEW_LAST);
...
pub const PG_STRING_STORED_FLAGS: c_long =
    (PG_PROP_DISABLED | PG_PROP_HIDDEN | PG_PROP_NOEDITOR | PG_PROP_COLLAPSED);
//  SKIP: wxNullProperty
...
pub const PG_ITERATE_HIDDEN: c_long = PG_PROP_HIDDEN | PG_IT_CHILDREN(PG_PROP_COLLAPSED);
pub const PG_ITERATE_FIXED_CHILDREN: c_long =
    PG_IT_CHILDREN(PG_PROP_AGGREGATE) | PG_ITERATE_PROPERTIES;
pub const PG_ITERATE_CATEGORIES: c_long =
    PG_PROP_CATEGORY | PG_IT_CHILDREN(PG_PROP_CATEGORY) | PG_PROP_COLLAPSED;
pub const PG_ITERATE_ALL_PARENTS: c_long =
    PG_PROP_MISC_PARENT | PG_PROP_AGGREGATE | PG_PROP_CATEGORY;
pub const PG_ITERATE_ALL_PARENTS_RECURSIVELY: c_long =
    PG_ITERATE_ALL_PARENTS | PG_IT_CHILDREN(PG_ITERATE_ALL_PARENTS);
...
pub const PG_ITERATE_VISIBLE: c_long =
    PG_ITERATE_PROPERTIES | PG_PROP_CATEGORY | PG_IT_CHILDREN(PG_PROP_AGGREGATE);
pub const PG_ITERATE_ALL: c_long = PG_ITERATE_VISIBLE | PG_ITERATE_HIDDEN;
pub const PG_ITERATE_NORMAL: c_long = PG_ITERATE_PROPERTIES | PG_ITERATE_HIDDEN;
...
pub const RE_NOTEMPTY: c_int = 128;
...
pub const RIBBON_BUTTONBAR_BUTTON_HOVER_MASK: c_int =
    RIBBON_BUTTONBAR_BUTTON_NORMAL_HOVERED | RIBBON_BUTTONBAR_BUTTON_DROPDOWN_HOVERED;
pub const RIBBON_BUTTONBAR_BUTTON_NORMAL_ACTIVE: c_int = 1 << 5;
pub const RIBBON_BUTTONBAR_BUTTON_DROPDOWN_ACTIVE: c_int = 1 << 6;
pub const RIBBON_BUTTONBAR_BUTTON_ACTIVE_MASK: c_int =
    RIBBON_BUTTONBAR_BUTTON_NORMAL_ACTIVE | RIBBON_BUTTONBAR_BUTTON_DROPDOWN_ACTIVE;
...
pub const RICHTEXT_ORGANISER_ORGANISE: c_int = (RICHTEXT_ORGANISER_SHOW_ALL
    | RICHTEXT_ORGANISER_DELETE_STYLES
    | RICHTEXT_ORGANISER_CREATE_STYLES
    | RICHTEXT_ORGANISER_APPLY_STYLES
    | RICHTEXT_ORGANISER_EDIT_STYLES
    | RICHTEXT_ORGANISER_RENAME_STYLES);
pub const RICHTEXT_ORGANISER_BROWSE: c_int =
    (RICHTEXT_ORGANISER_SHOW_ALL | RICHTEXT_ORGANISER_OK_CANCEL);
pub const RICHTEXT_ORGANISER_BROWSE_NUMBERING: c_int =
    (RICHTEXT_ORGANISER_SHOW_LIST | RICHTEXT_ORGANISER_OK_CANCEL | RICHTEXT_ORGANISER_RENUMBER);
...
pub const STB_DEFAULT_STYLE: c_long =
    (STB_SIZEGRIP | STB_ELLIPSIZE_END | STB_SHOW_TIPS | FULL_REPAINT_ON_RESIZE);
...
pub const TEXT_ATTR_FONT_SIZE: c_int = (TEXT_ATTR_FONT_POINT_SIZE | TEXT_ATTR_FONT_PIXEL_SIZE);
pub const TEXT_ATTR_FONT: c_int = (TEXT_ATTR_FONT_FACE
    | TEXT_ATTR_FONT_SIZE
...
pub const TEXT_ATTR_BULLET: c_int = (TEXT_ATTR_BULLET_STYLE
...
pub const TEXT_ATTR_CHARACTER: c_int = (TEXT_ATTR_FONT
    | TEXT_ATTR_EFFECTS
    | TEXT_ATTR_BACKGROUND_COLOUR
    | TEXT_ATTR_TEXT_COLOUR
    | TEXT_ATTR_CHARACTER_STYLE_NAME
    | TEXT_ATTR_URL);
pub const TEXT_ATTR_PARAGRAPH: c_int = (TEXT_ATTR_ALIGNMENT
...
pub const DEFAULT_FRAME_STYLE: c_long = (SYSTEM_MENU
    | RESIZE_BORDER
    | MINIMIZE_BOX
    | MAXIMIZE_BOX
    | CLOSE_BOX
...
pub const CONTENT_PROTECTION_NONE: c_int = 0;
pub const CONTENT_PROTECTION_ENABLED: c_int = 0 + 1;
//  ENUM: @51
...
pub const FULLSCREEN_ALL: c_int = FULLSCREEN_NOMENUBAR
...
pub const TL_STYLE_MASK: c_int = TL_SINGLE | TL_MULTIPLE | TL_CHECKBOX | TL_3STATE | TL_USER_3STATE;
...
//  ENUM: @53
pub const Compare_CaseSensitive: c_int = 0;
pub const Compare_CaseInsensitive: c_int = 1;
