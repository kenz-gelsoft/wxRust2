...
///
/// See [`VariantDataInRust`] documentation for the class usage.
pub trait VariantDataMethods: ObjectRefDataMethods {
    ...
    fn clone(&self) -> Option<VariantDataInRust<false>> {
    ...
    fn get_value_class_info(&self) -> Option<ClassInfoInRust<false>> {
