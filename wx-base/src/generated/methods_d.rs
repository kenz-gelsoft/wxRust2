...
pub trait DateTimeMethods: WxRustMethods {
    ...
    ///
    /// [See `wxDateTime::ResetTime()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#acb537b1ef0b83b5a6724140c823a547c)
    ...
    ///
    /// [See `wxDateTime::Set()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#aceceac43ca2c9741401e7e34c588f087)
    ...
    ///
    /// [See `wxDateTime::Set()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#ae24090c2c5f3ab830d5edacc2c075f60)
    ...
    ///
    /// [See `wxDateTime::SetToCurrent()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#a10db5e371bada75b91435f4367cbdaa1)
    ...
    ///
    /// [See `wxDateTime::SetYear()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#ab574229577dcf8b1e430873f6701fa43)
    ...
    ///
    /// [See `wxDateTime::SetFromMSWSysTime()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#ae6eb1bdd0c691d82493a40e714705860)
    ...
    ///
    /// [See `wxDateTime::GetAsMSWSysTime()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#a9f760ab782406fd9d4db1e983b5490c3)
    fn get_as_msw_sys_time(&self, st: *mut c_void) {
        unsafe { ffi::wxDateTime_GetAsMSWSysTime(self.as_ptr(), st) }
    }
    /// Returns the century of this date.
    ///
    /// [See `wxDateTime::GetCentury()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#a7646edf22af11b72e503046c0bff3e17)
    ...
    ///
    /// [See `wxDateTime::GetDateOnly()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#a347ff4b250b96471b4ba10806b5e9fc4)
    ...
    ///
    /// [See `wxDateTime::GetWeekBasedYear()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#ad083f14ab1094ed025f1634523f2ea44)
    ...
    ///
    /// [See `wxDateTime::GetYear()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#ab20a8e0aa4aefe4dda3f93b1e75123d3)
    fn get_year(&self, tz: *const c_void) -> c_int {
        unsafe { ffi::wxDateTime_GetYear(self.as_ptr(), tz) }
    }
    /// Returns true if the object represents a valid time moment.
    ///
    /// [See `wxDateTime::IsValid()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#afd5350c926b486e77478d7c7d4fd7b9c)
    ...
    ///
    /// [See `wxDateTime::IsEarlierThan()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#a6d83ca062bb51235db017b3d855dbb5d)
    ...
    ///
    /// [See `wxDateTime::IsEqualTo()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#ac0cefa368b364f2bde861b668fb1b71f)
    ...
    ///
    /// [See `wxDateTime::IsEqualUpTo()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#aff57fac0e65af21cb4d55b83a3aed269)
    ...
    ///
    /// [See `wxDateTime::IsLaterThan()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#a4d3321c1e76f4c132fd2d0b302498824)
    ...
    ///
    /// [See `wxDateTime::IsSameDate()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#abb147359541012d11ca48f6db2be7c32)
    ...
    ///
    /// [See `wxDateTime::IsSameTime()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#a7d22bbf0ccab5c71a7173d8fa8a7cd41)
    ...
    ///
    /// [See `wxDateTime::IsStrictlyBetween()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#a550f265925b235de51e99a50222963fa)
    ...
    ///
    /// [See `wxDateTime::IsBetween()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#a0a5d356a798f5c95c729e6b5193dd9b1)
    ...
    ///
    /// [See `wxDateTime::Add()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#a18e32b187b6d6c94be921d4716b6366f)
    ...
    ///
    /// [See `wxDateTime::Add()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#ab4cae178a6004ba47a6fbac302c35d3d)
    ...
    ///
    /// [See `wxDateTime::Subtract()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#a78a988d03c8cca570d2f0294d987bc24)
    ...
    ///
    /// [See `wxDateTime::Subtract()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#aa8405d7b2d413775039a8ef5d65b9b80)
    ...
    ///
    /// [See `wxDateTime::Format()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#a6a60f071d74712eba58153113f5af23a)
    ...
    ///
    /// [See `wxDateTime::FormatDate()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#aeca948cb9628daabf2953a6a635a74b3)
    ...
    ///
    /// [See `wxDateTime::FormatISODate()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#aed6224e62881d28d60e54eefcb6798f1)
    ...
    ///
    /// [See `wxDateTime::FormatISOTime()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#aa370d17862e81fb89d78e6e087374320)
    ...
    ///
    /// [See `wxDateTime::FormatTime()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#a6f9e71f21079e007368040322005804f)
    ...
    ///
    /// [See `wxDateTime::ParseDateTime()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#a332a41f998bc3be6c0a9a81449112485)
    ...
    ///
    /// [See `wxDateTime::ParseFormat()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#a5d01d56c310d505a093f1a7f25086a1b)
    ...
    ///
    /// [See `wxDateTime::ParseISODate()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#a416e9e5e7395dd11a059cd116da7e6a2)
    ...
    ///
    /// [See `wxDateTime::ParseISOTime()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#adc4c1fb178f73958b151eabd36625f59)
    ...
    ///
    /// [See `wxDateTime::ParseRfc822Date()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#ab0f2485c52d0d3cf0196aaf0062d2f83)
    ...
    ///
    /// [See `wxDateTime::ParseTime()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#ac903b3227620e1b88019e76b807327e8)
    ...
    ///
    /// [See `wxDateTime::GetJDN()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#a0dd134019f8aa14da326f692575cbd22)
    fn get_jdn(&self) -> c_double {
        unsafe { ffi::wxDateTime_GetJDN(self.as_ptr()) }
    }
    /// Returns the JDN corresponding to this date.
    ///
    /// [See `wxDateTime::GetJulianDayNumber()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#a32b6bf7b2af58f8f3430796008544943)
    ...
    ///
    /// [See `wxDateTime::GetMJD()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#afd05be08550faff9bd1001c91313e637)
    ...
    ///
    /// [See `wxDateTime::GetModifiedJulianDayNumber()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#ab44bcea2d91e3562217e83f4a4c583ac)
    ...
    ///
    /// [See `wxDateTime::GetRataDie()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#a77384d94d7fbbb393c5b3ac239e744e5)
    ...
    ///
    /// [See `wxDateTime::FromTimezone()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#a64ecc639352e2fdb393d07131ef1f402)
    ...
    ///
    /// [See `wxDateTime::MakeFromTimezone()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#ac3311659f9a0c46a19a563e683f076b8)
    ...
    ///
    /// [See `wxDateTime::MakeTimezone()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#a4782b88f89f129c7e8127716cf3df58b)
    ...
    ///
    /// [See `wxDateTime::MakeUTC()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#a6c2fdc74ad77726e164b8139fbf2eaf3)
    ...
    ///
    /// [See `wxDateTime::ToTimezone()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#ac7c94044cece74f9e8b357204c460f5f)
    ...
    ///
    /// [See `wxDateTime::ToUTC()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#a528886a6a80ec4490b2a16679c10a683)
    ...
    ///
    /// [See `wxDateTime::ConvertYearToBC()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#a52e2fe22ededf8aaf3922a3e8136ddb0)
    ...
    ///
    /// [See `wxDateTime::GetAmPmStrings()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#a9ef535b0db4eeb117858a5b31ac00ae5)
    ...
    ///
    /// [See `wxDateTime::GetCentury()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#aa7da8657207e8872291e757bc6065b61)
    ...
    ///
    /// [See `wxDateTime::GetTmNow()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#ae55f6ba5606beb7a16e8eae572c90c52)
    ...
    ///
    /// [See `wxDateTime::GetFirstWeekDay()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#ae192eb65585f8b80e127c96ec1f97e83)
    ...
    ///
    /// [See `wxDateTime::Now()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#a6e6c37a0414bb4831e2cc03b37f498a2)
    fn now() -> DateTime {
    ...
    ///
    /// [See `wxDateTime::Today()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#af730202238b9acd5a5df2977fa40c569)
    fn today() -> DateTime {
    ...
    ///
    /// [See `wxDateTime::UNow()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_date_time.html#a0db1c9bac7b2d27d589cad2a38d1438c)
    fn u_now() -> DateTime {
