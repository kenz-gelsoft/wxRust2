...
pub trait FileNameMethods: WxRustMethods {
    ...
    ///
    /// [See `wxFileName::AppendDir()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#acd4448c31bed17a4d1886fc01bac6daa)
    ...
    ///
    /// [See `wxFileName::Assign()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#ab75d82f4024c6f15cc4247c8835da557)
    ...
    ///
    /// [See `wxFileName::AssignCwd()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#a1cf7a6e3a6ac0f34260ea79f48663cc8)
    ...
    ///
    /// [See `wxFileName::AssignHomeDir()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#a021419b87e867a31ff4af5b6e84911cd)
    ...
    ///
    /// [See `wxFileName::AssignTempFileName()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#a6c56af101aea8c3d98c693811a44db69)
    ...
    ///
    /// [See `wxFileName::AssignTempFileName()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#acf47b12b1de8c47fc5cbc2ec7b5fe628)
    ...
    /// The function calls CreateTempFileName() to create a temporary file name and open fileTemp with it.
    ///
    /// [See `wxFileName::AssignTempFileName()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#a0807cf78dcddc42d2467ee45cc108d08)
    ...
    ///
    /// [See `wxFileName::Clear()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#aa4fbb922dd41ee6012f15c6d162fb0b3)
    fn clear(&self) {
    ...
    ///
    /// [See `wxFileName::ClearExt()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#a03a2f73191dbf2392b9f1c8e850b407a)
    fn clear_ext(&self) {
        unsafe { ffi::wxFileName_ClearExt(self.as_ptr()) }
    }
    /// Returns true if the directory with this name exists.
    ///
    /// [See `wxFileName::DirExists()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#a787c72b7b71d1fa391c5ffd5170e1b17)
    fn dir_exists(&self) -> bool {
        unsafe { ffi::wxFileName_DirExists(self.as_ptr()) }
    }
    /// Turns off symlink dereferencing.
    ///
    /// [See `wxFileName::DontFollowLink()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#af1430dafaf1f522710b52f0a0bf0f060)
    ...
    ///
    /// [See `wxFileName::Exists()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#a3a67a151411ee2e7eabbcd6087691ee4)
    fn exists_int(&self, flags: c_int) -> bool {
        unsafe { ffi::wxFileName_Exists(self.as_ptr(), flags) }
    }
    /// Returns true if the file with this name exists.
    ///
    /// [See `wxFileName::FileExists()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#a52cb500b34e5338fbd8d3db5867ace9e)
    ...
    ///
    /// [See `wxFileName::GetDirCount()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#a3706feaa2a3d3576aa62eeac5094bdd4)
    fn get_dir_count(&self) -> usize {
        unsafe { ffi::wxFileName_GetDirCount(self.as_ptr()) }
    }
    /// Returns the directories in string array form.
    ///
    /// [See `wxFileName::GetDirs()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#ae7a4a2abba5a95a547dc35e1ed43a67b)
    fn get_dirs(&self) -> ArrayStringIsOwned<false> {
        unsafe { ArrayStringIsOwned::from_ptr(ffi::wxFileName_GetDirs(self.as_ptr())) }
    }
    /// Returns the file name extension.
    ///
    /// [See `wxFileName::GetExt()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#ae5e2d1095dceb2ff315dcfd57e824945)
    fn get_ext(&self) -> String {
        unsafe { WxString::from_ptr(ffi::wxFileName_GetExt(self.as_ptr())).into() }
    }
    /// Returns the full name (including extension but excluding directories).
    ///
    /// [See `wxFileName::GetFullName()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#abc779377cd917cc2487b76a5e0ff7949)
    ...
    ///
    /// [See `wxFileName::GetLongPath()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#ac9866d9a346e6baaa70371ce49d1e29c)
    ...
    ///
    /// [See `wxFileName::GetModificationTime()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#a81fb52063e04c58128f996c8292ce81f)
    fn get_modification_time(&self) -> DateTime {
        unsafe { DateTime::from_ptr(ffi::wxFileName_GetModificationTime(self.as_ptr())) }
    }
    /// Returns the name part of the filename (without extension).
    ///
    /// [See `wxFileName::GetName()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#ad8f3f744b2c926eee9567bb30f9868a9)
    ...
    ///
    /// [See `wxFileName::GetShortPath()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#a522f1e656caef976efd87f82b34b6a85)
    ...
    ///
    /// [See `wxFileName::GetTimes()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#a57f5777485c1409be723755b54a92a12)
    ...
    ///
    /// [See `wxFileName::GetVolume()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#a51afe14188bbfa6442598730db8a9881)
    ...
    ///
    /// [See `wxFileName::HasExt()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#afc1569201ca209ef97457f60cf272bfc)
    fn has_ext(&self) -> bool {
        unsafe { ffi::wxFileName_HasExt(self.as_ptr()) }
    }
    /// Returns true if a name is present.
    ///
    /// [See `wxFileName::HasName()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#a98f33bc4f026e7e396afdb0e1802f1cf)
    fn has_name(&self) -> bool {
        unsafe { ffi::wxFileName_HasName(self.as_ptr()) }
    }
    /// Returns true if a volume specifier is present.
    ///
    /// [See `wxFileName::HasVolume()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#a80820a2958875e8e3a4a4d6e367ae538)
    ...
    ///
    /// [See `wxFileName::InsertDir()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#ae722c59b18f226312565cccb1c70a83f)
    ...
    ///
    /// [See `wxFileName::IsDir()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#abd3d69deb2de515f51e76065f35e75cf)
    fn is_dir(&self) -> bool {
    ...
    ///
    /// [See `wxFileName::IsDirReadable()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#a6d3e8730fe07ccc288a9712f5272ea52)
    ...
    ///
    /// [See `wxFileName::IsDirWritable()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#a56d601e5a5a79b75b550da0e1a35e0da)
    ...
    ///
    /// [See `wxFileName::IsFileExecutable()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#afd7126bf8ce3f1d5ffe675179f5e4ca0)
    ...
    ///
    /// [See `wxFileName::IsFileReadable()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#ae1d433eda553c7db2ed533eef8ce3766)
    ...
    ///
    /// [See `wxFileName::IsFileWritable()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#a097707017ebc8d068e6fa4d38d9efb56)
    ...
    ///
    /// [See `wxFileName::IsOk()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#a1abe6ced5f0a8f69761cc91711b2a69f)
    fn is_ok(&self) -> bool {
    ...
    /// Creates a directory.
    ///
    /// [See `wxFileName::Mkdir()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#aa6cc6ee8389c6ce4f94fffa6bdf94b17)
    ...
    ///
    /// [See `wxFileName::PrependDir()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#a577475123161b94cb8f8a597cefe64d5)
    ...
    ///
    /// [See `wxFileName::RemoveDir()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#ad2b8491684c5bf97395ab9aa2f3d398b)
    ...
    ///
    /// [See `wxFileName::RemoveLastDir()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#ab1336b56add13e0f2830197a3680da94)
    ...
    ///
    /// [See `wxFileName::ResolveLink()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#a9c4d1743f75827d99951d033b00719ba)
    fn resolve_link(&self) -> FileName {
        unsafe { FileName::from_ptr(ffi::wxFileName_ResolveLink(self.as_ptr())) }
    }
    /// Deletes the specified directory from the file system.
    ///
    /// [See `wxFileName::Rmdir()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#a55d5f2f9af1a6430a74dfd75ec538028)
    ...
    ///
    /// [See `wxFileName::SetCwd()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#aa35ca9aa25e0db539031de039c63fd16)
    fn set_cwd(&self) -> bool {
        unsafe { ffi::wxFileName_SetCwd(self.as_ptr()) }
    }
    /// Sets the extension of the file name to be an empty extension.
    ///
    /// [See `wxFileName::SetEmptyExt()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#a2d5df1c71c011b0f8897dc51fe8d91ce)
    fn set_empty_ext(&self) {
        unsafe { ffi::wxFileName_SetEmptyExt(self.as_ptr()) }
    }
    /// Sets the extension of the file name.
    ///
    /// [See `wxFileName::SetExt()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#a65c37fa5017b400d41009bbab56f2774)
    ...
    ///
    /// [See `wxFileName::SetFullName()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#a2490c8f2cc92fb88196adc33809a36c0)
    ...
    ///
    /// [See `wxFileName::SetName()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#a1bf12dfe55c3a2a56982a7a731fa1230)
    ...
    ///
    /// [See `wxFileName::SetPermissions()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#ae1b6847990f5b41f5b53fb46a5e5fb79)
    ...
    ///
    /// [See `wxFileName::SetTimes()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#a38d689624c41dd79170fc94fc6be47cf)
    ...
    ///
    /// [See `wxFileName::SetVolume()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#a0c8e256bd978ab9d0cc3c640758b2e2f)
    ...
    ///
    /// [See `wxFileName::ShouldFollowLink()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#a70a36037ef773e2a00eddb7532e8a3f7)
    fn should_follow_link(&self) -> bool {
        unsafe { ffi::wxFileName_ShouldFollowLink(self.as_ptr()) }
    }
    /// Sets the access and modification times to the current moment.
    ///
    /// [See `wxFileName::Touch()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#aaf2926a7cb0ad2dd79f9c9e14d4c38c1)
    fn touch(&self) -> bool {
    ...
    ///
    /// [See `wxFileName::CreateTempFileName()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#a416af84fddd624a3b457dbffbe174317)
    ...
    ///
    /// [See `wxFileName::CreateTempFileName()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#a5a03fe160df4807b4de1c3bd0696d2ad)
    ...
    ///
    /// [See `wxFileName::DirExists()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#a706cd439af5469ff913bb022dff1ed71)
    ...
    ///
    /// [See `wxFileName::Exists()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#a1229d995f7ba67e0b66f5fb556debfb1)
    ...
    ///
    /// [See `wxFileName::FileExists()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#ab8a8e5bfeaf12b6479ffc295a68137b9)
    ...
    ///
    /// [See `wxFileName::GetCwd()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#af697f1c0f7864fc35ac0e8198eacc84d)
    ...
    ///
    /// [See `wxFileName::GetHomeDir()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#a8699fafd7b38069c2af0b4f0de89c180)
    ...
    ///
    /// [See `wxFileName::GetTempDir()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#ada549d0b26eb20fc03f42f2182b05fc9)
    ...
    ///
    /// [See `wxFileName::IsDirReadable()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#a37759678b0b0e4f01076c4358a2e63b9)
    ...
    ///
    /// [See `wxFileName::IsDirWritable()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#a1af163f5c99159a34be2f905eb1ec03b)
    ...
    /// Returns true if a file with this name exists and if this process has execute permissions on it.
    ///
    /// [See `wxFileName::IsFileExecutable()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#a65973db654e5b7b03eac0079b34f4694)
    ...
    /// Returns true if a file with this name exists and if this process has read permissions on it.
    ///
    /// [See `wxFileName::IsFileReadable()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#aaf33a5de7f79587a58f9e20ae22d89b4)
    ...
    /// Returns true if a file with this name exists and if this process has write permissions on it.
    ///
    /// [See `wxFileName::IsFileWritable()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#ac430b77411e87a46f7a354bcf384cf65)
    ...
    /// Creates a directory.
    ///
    /// [See `wxFileName::Mkdir()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#ac2006b2fb30c0c0f11ef44560e1a62c7)
    ...
    /// Deletes the specified directory from the file system.
    ///
    /// [See `wxFileName::Rmdir()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#aa0aa5becff9a6d91ac5108bea7f12932)
    ...
    /// Changes the current working directory.
    ///
    /// [See `wxFileName::SetCwd()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#a5c1d005ca788d42ca5d1c7bf8ff3d6b6)
    ...
    ///
    /// [See `wxFileName::URLToFileName()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#a2741a6fa2caf95bb539a562dd4cbadf9)
    ...
    ///
    /// [See `wxFileName::FileNameToURL()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#a0eed399043b21d4e397e539c46e557e8)
    ...
    ///
    /// [See `wxFileName::StripExtension()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_file_name.html#a1cc6ef65bdf702fc220893d1e1db1141)
