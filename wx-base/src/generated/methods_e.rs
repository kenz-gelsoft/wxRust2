...
///
/// See [`EventFromCpp`] documentation for the class usage.
pub trait EventMethods: ObjectMethods {
    ...
    fn get_event_object(&self) -> Option<ObjectFromCpp<false>> {
    ...
    fn get_event_user_data(&self) -> Option<ObjectFromCpp<false>> {
...
///
/// See [`EvtHandlerFromCpp`] documentation for the class usage.
