...
///
/// See [`TimerInRust`] documentation for the class usage.
...
///
/// See [`TimerEventInRust`] documentation for the class usage.
pub trait TimerEventMethods: EventMethods {
    ...
    fn get_timer(&self) -> TimerInRust<false> {
        unsafe { TimerInRust::from_ptr(ffi::wxTimerEvent_GetTimer(self.as_ptr())) }
    }
}
