...
const wxPG_ATTR_DEFAULT_VALUE: i32 = wxS("DefaultValue");
const wxPG_ATTR_MIN: i32 = wxS("Min");
const wxPG_ATTR_MAX: i32 = wxS("Max");
const wxPG_ATTR_UNITS: i32 = wxS("Units");
const wxPG_ATTR_HINT: i32 = wxS("Hint");
const wxPG_ATTR_AUTOCOMPLETE: i32 = wxS("AutoComplete");
const wxPG_BOOL_USE_CHECKBOX: i32 = wxS("UseCheckbox");
const wxPG_BOOL_USE_DOUBLE_CLICK_CYCLING: i32 = wxS("UseDClickCycling");
const wxPG_FLOAT_PRECISION: i32 = wxS("Precision");
const wxPG_STRING_PASSWORD: i32 = wxS("Password");
const wxPG_UINT_BASE: i32 = wxS("Base");
const wxPG_UINT_PREFIX: i32 = wxS("Prefix");
const wxPG_DIALOG_TITLE: i32 = wxS("DialogTitle");
const wxPG_FILE_WILDCARD: i32 = wxS("Wildcard");
const wxPG_FILE_SHOW_FULL_PATH: i32 = wxS("ShowFullPath");
const wxPG_FILE_SHOW_RELATIVE_PATH: i32 = wxS("ShowRelativePath");
const wxPG_FILE_INITIAL_PATH: i32 = wxS("InitialPath");
const wxPG_FILE_DIALOG_STYLE: i32 = wxS("DialogStyle");
const wxPG_ARRAY_DELIMITER: i32 = wxS("Delimiter");
const wxPG_DATE_FORMAT: i32 = wxS("DateFormat");
const wxPG_DATE_PICKER_STYLE: i32 = wxS("PickerStyle");
const wxPG_ATTR_SPINCTRL_STEP: i32 = wxS("Step");
const wxPG_ATTR_SPINCTRL_WRAP: i32 = wxS("Wrap");
const wxPG_ATTR_SPINCTRL_MOTION: i32 = wxS("MotionSpin");
const wxPG_ATTR_MULTICHOICE_USERSTRINGMODE: i32 = wxS("UserStringMode");
const wxPG_COLOUR_ALLOW_CUSTOM: i32 = wxS("AllowCustom");
const wxPG_COLOUR_HAS_ALPHA: i32 = wxS("HasAlpha");
...
const wxIMAGE_OPTION_QUALITY: i32 = wxString("quality");
const wxIMAGE_OPTION_FILENAME: i32 = wxString("FileName");
const wxIMAGE_OPTION_RESOLUTION: i32 = wxString("Resolution");
const wxIMAGE_OPTION_RESOLUTIONX: i32 = wxString("ResolutionX");
const wxIMAGE_OPTION_RESOLUTIONY: i32 = wxString("ResolutionY");
const wxIMAGE_OPTION_RESOLUTIONUNIT: i32 = wxString("ResolutionUnit");
const wxIMAGE_OPTION_MAX_WIDTH: i32 = wxString("MaxWidth");
const wxIMAGE_OPTION_MAX_HEIGHT: i32 = wxString("MaxHeight");
const wxIMAGE_OPTION_ORIGINAL_WIDTH: i32 = wxString("OriginalWidth");
const wxIMAGE_OPTION_ORIGINAL_HEIGHT: i32 = wxString("OriginalHeight");
const wxIMAGE_OPTION_BMP_FORMAT: i32 = wxString("wxBMP_FORMAT");
const wxIMAGE_OPTION_CUR_HOTSPOT_X: i32 = wxString("HotSpotX");
const wxIMAGE_OPTION_CUR_HOTSPOT_Y: i32 = wxString("HotSpotY");
const wxIMAGE_OPTION_GIF_COMMENT: i32 = wxString("GifComment");
const wxIMAGE_OPTION_GIF_TRANSPARENCY: i32 = wxString("Transparency");
const wxIMAGE_OPTION_GIF_TRANSPARENCY_HIGHLIGHT: i32 = wxString("Highlight");
const wxIMAGE_OPTION_GIF_TRANSPARENCY_UNCHANGED: i32 = wxString("Unchanged");
const wxIMAGE_OPTION_PNG_FORMAT: i32 = wxString("PngFormat");
const wxIMAGE_OPTION_PNG_BITDEPTH: i32 = wxString("PngBitDepth");
const wxIMAGE_OPTION_PNG_FILTER: i32 = wxString("PngF");
const wxIMAGE_OPTION_PNG_COMPRESSION_LEVEL: i32 = wxString("PngZL");
const wxIMAGE_OPTION_PNG_COMPRESSION_MEM_LEVEL: i32 = wxString("PngZM");
const wxIMAGE_OPTION_PNG_COMPRESSION_STRATEGY: i32 = wxString("PngZS");
const wxIMAGE_OPTION_PNG_COMPRESSION_BUFFER_SIZE: i32 = wxString("PngZB");
const wxIMAGE_OPTION_TIFF_BITSPERSAMPLE: i32 = wxString("BitsPerSample");
const wxIMAGE_OPTION_TIFF_SAMPLESPERPIXEL: i32 = wxString("SamplesPerPixel");
const wxIMAGE_OPTION_TIFF_COMPRESSION: i32 = wxString("Compression");
const wxIMAGE_OPTION_TIFF_PHOTOMETRIC: i32 = wxString("Photometric");
const wxIMAGE_OPTION_TIFF_IMAGEDESCRIPTOR: i32 = wxString("ImageDescriptor");
const wxBITMAP_SCREEN_DEPTH: i32 = (-1);
const wxIMAGE_OPTION_GIF_COMMENT: i32 = wxT("GifComment");
...
const wxIMAGE_OPTION_PNG_FORMAT: i32 = wxT("PngFormat");
const wxIMAGE_OPTION_PNG_BITDEPTH: i32 = wxT("PngBitDepth");
const wxIMAGE_OPTION_PNG_FILTER: i32 = wxT("PngF");
const wxIMAGE_OPTION_PNG_COMPRESSION_LEVEL: i32 = wxT("PngZL");
const wxIMAGE_OPTION_PNG_COMPRESSION_MEM_LEVEL: i32 = wxT("PngZM");
const wxIMAGE_OPTION_PNG_COMPRESSION_STRATEGY: i32 = wxT("PngZS");
const wxIMAGE_OPTION_PNG_COMPRESSION_BUFFER_SIZE: i32 = wxT("PngZB");
