...
pub const wxSVG_SHAPE_RENDERING_AUTO: c_int = 0;
pub const wxSVG_SHAPE_RENDERING_OPTIMIZE_SPEED: c_int = 0 + 1;
pub const wxSVG_SHAPE_RENDERING_CRISP_EDGES: c_int = 0 + 2;
pub const wxSVG_SHAPE_RENDERING_GEOMETRIC_PRECISION: c_int = 0 + 3;
pub const wxSVG_SHAPE_RENDERING_OPTIMISE_SPEED: c_int = wxSVG_SHAPE_RENDERING_OPTIMIZE_SPEED;
...
pub const wxLOCALE_DONT_LOAD_DEFAULT: c_int = 0x0000;
pub const wxLOCALE_LOAD_DEFAULT: c_int = 0x0001;
...
pub const wxGridSelectNone: c_int = 0 + 4;
//  ENUM: CellSpan
...
pub const wxSTC_WS_VISIBLEONLYININDENT: c_int = 3;
pub const wxSTC_TD_LONGARROW: c_int = 0;
pub const wxSTC_TD_STRIKEOUT: c_int = 1;
...
pub const wxSTC_IME_WINDOWED: c_int = 0;
pub const wxSTC_IME_INLINE: c_int = 1;
...
pub const wxSTC_MARK_BOOKMARK: c_int = 31;
...
pub const wxSTC_MARGIN_COLOUR: c_int = 6;
...
pub const wxSTC_STYLE_FOLDDISPLAYTEXT: c_int = 39;
...
pub const wxSTC_CHARSET_OEM866: c_int = 866;
...
pub const wxSTC_CASE_CAMEL: c_int = 3;
...
pub const wxSTC_INDIC_SQUIGGLEPIXMAP: c_int = 13;
pub const wxSTC_INDIC_COMPOSITIONTHICK: c_int = 14;
pub const wxSTC_INDIC_COMPOSITIONTHIN: c_int = 15;
pub const wxSTC_INDIC_FULLBOX: c_int = 16;
pub const wxSTC_INDIC_TEXTFORE: c_int = 17;
pub const wxSTC_INDIC_POINT: c_int = 18;
pub const wxSTC_INDIC_POINTCHARACTER: c_int = 19;
pub const wxSTC_INDIC_IME: c_int = 32;
pub const wxSTC_INDIC_IME_MAX: c_int = 35;
pub const wxSTC_INDIC_MAX: c_int = 35;
pub const wxSTC_INDIC_CONTAINER: c_int = 8;
pub const wxSTC_INDICVALUEBIT: c_int = 0x1000000;
pub const wxSTC_INDICVALUEMASK: c_int = 0xFFFFFF;
pub const wxSTC_INDICFLAG_VALUEFORE: c_int = 1;
...
pub const wxSTC_FIND_WHOLEWORD: c_int = 0x2;
pub const wxSTC_FIND_MATCHCASE: c_int = 0x4;
...
pub const wxSTC_FOLDDISPLAYTEXT_HIDDEN: c_int = 0;
pub const wxSTC_FOLDDISPLAYTEXT_STANDARD: c_int = 1;
pub const wxSTC_FOLDDISPLAYTEXT_BOXED: c_int = 2;
pub const wxSTC_FOLDACTION_CONTRACT: c_int = 0;
pub const wxSTC_FOLDACTION_EXPAND: c_int = 1;
pub const wxSTC_FOLDACTION_TOGGLE: c_int = 2;
pub const wxSTC_AUTOMATICFOLD_SHOW: c_int = 0x0001;
pub const wxSTC_AUTOMATICFOLD_CLICK: c_int = 0x0002;
pub const wxSTC_AUTOMATICFOLD_CHANGE: c_int = 0x0004;
...
pub const wxSTC_FOLDFLAG_LINESTATE: c_int = 0x0080;
pub const wxSTC_TIME_FOREVER: c_int = 10000000;
pub const wxSTC_IDLESTYLING_NONE: c_int = 0;
pub const wxSTC_IDLESTYLING_TOVISIBLE: c_int = 1;
pub const wxSTC_IDLESTYLING_AFTERVISIBLE: c_int = 2;
pub const wxSTC_IDLESTYLING_ALL: c_int = 3;
pub const wxSTC_WRAP_NONE: c_int = 0;
pub const wxSTC_WRAP_WORD: c_int = 1;
pub const wxSTC_WRAP_CHAR: c_int = 2;
pub const wxSTC_WRAP_WHITESPACE: c_int = 3;
...
pub const wxSTC_PHASES_ONE: c_int = 0;
pub const wxSTC_PHASES_TWO: c_int = 1;
pub const wxSTC_PHASES_MULTIPLE: c_int = 2;
...
pub const wxSTC_EDGE_MULTILINE: c_int = 3;
pub const wxSTC_POPUP_NEVER: c_int = 0;
pub const wxSTC_POPUP_ALL: c_int = 1;
pub const wxSTC_POPUP_TEXT: c_int = 2;
pub const wxSTC_STATUS_OK: c_int = 0;
pub const wxSTC_STATUS_FAILURE: c_int = 1;
pub const wxSTC_STATUS_BADALLOC: c_int = 2;
pub const wxSTC_STATUS_WARN_START: c_int = 1000;
pub const wxSTC_STATUS_WARN_REGEX: c_int = 1001;
...
pub const wxSTC_MULTIAUTOC_ONCE: c_int = 0;
pub const wxSTC_MULTIAUTOC_EACH: c_int = 1;
pub const wxSTC_ORDER_PRESORTED: c_int = 0;
pub const wxSTC_ORDER_PERFORMSORT: c_int = 1;
pub const wxSTC_ORDER_CUSTOM: c_int = 2;
...
pub const wxSTC_ANNOTATION_INDENTED: c_int = 3;
pub const wxSTC_UNDO_MAY_COALESCE: c_int = 1;
pub const wxSTC_VS_NONE: c_int = 0;
pub const wxSTC_VS_RECTANGULARSELECTION: c_int = 1;
pub const wxSTC_VS_USERACCESSIBLE: c_int = 2;
pub const wxSTC_VS_NOWRAPLINESTART: c_int = 4;
pub const wxSTC_TECHNOLOGY_DEFAULT: c_int = 0;
pub const wxSTC_TECHNOLOGY_DIRECTWRITE: c_int = 1;
pub const wxSTC_LINE_END_TYPE_DEFAULT: c_int = 0;
pub const wxSTC_LINE_END_TYPE_UNICODE: c_int = 1;
...
pub const wxSTC_MOD_INSERTCHECK: c_int = 0x100000;
pub const wxSTC_MOD_CHANGETABSTOPS: c_int = 0x200000;
pub const wxSTC_MODEVENTMASKALL: c_int = 0x3FFFFF;
...
pub const wxSTC_KEYMOD_NORM: c_int = 0;
pub const wxSTC_KEYMOD_SHIFT: c_int = 1;
pub const wxSTC_KEYMOD_CTRL: c_int = 2;
pub const wxSTC_KEYMOD_ALT: c_int = 4;
pub const wxSTC_KEYMOD_SUPER: c_int = 8;
pub const wxSTC_KEYMOD_META: c_int = 16;
pub const wxSTC_AC_FILLUP: c_int = 1;
pub const wxSTC_AC_DOUBLECLICK: c_int = 2;
pub const wxSTC_AC_TAB: c_int = 3;
pub const wxSTC_AC_NEWLINE: c_int = 4;
pub const wxSTC_AC_COMMAND: c_int = 5;
...
pub const wxSTC_LEX_LITERATEHASKELL: c_int = 108;
pub const wxSTC_LEX_STTXT: c_int = 109;
pub const wxSTC_LEX_KVIRC: c_int = 110;
pub const wxSTC_LEX_RUST: c_int = 111;
pub const wxSTC_LEX_DMAP: c_int = 112;
pub const wxSTC_LEX_AS: c_int = 113;
pub const wxSTC_LEX_DMIS: c_int = 114;
pub const wxSTC_LEX_REGISTRY: c_int = 115;
pub const wxSTC_LEX_BIBTEX: c_int = 116;
pub const wxSTC_LEX_SREC: c_int = 117;
pub const wxSTC_LEX_IHEX: c_int = 118;
pub const wxSTC_LEX_TEHEX: c_int = 119;
pub const wxSTC_LEX_JSON: c_int = 120;
pub const wxSTC_LEX_EDIFACT: c_int = 121;
...
pub const wxSTC_C_PREPROCESSORCOMMENTDOC: c_int = 24;
pub const wxSTC_C_USERLITERAL: c_int = 25;
pub const wxSTC_C_TASKMARKER: c_int = 26;
pub const wxSTC_C_ESCAPESEQUENCE: c_int = 27;
...
pub const wxSTC_B_COMMENTBLOCK: c_int = 19;
pub const wxSTC_B_DOCLINE: c_int = 20;
pub const wxSTC_B_DOCBLOCK: c_int = 21;
pub const wxSTC_B_DOCKEYWORD: c_int = 22;
...
pub const wxSTC_ERR_GCC_INCLUDED_FROM: c_int = 22;
pub const wxSTC_ERR_ESCSEQ: c_int = 23;
pub const wxSTC_ERR_ESCSEQ_UNKNOWN: c_int = 24;
pub const wxSTC_ERR_ES_BLACK: c_int = 40;
pub const wxSTC_ERR_ES_RED: c_int = 41;
pub const wxSTC_ERR_ES_GREEN: c_int = 42;
pub const wxSTC_ERR_ES_BROWN: c_int = 43;
pub const wxSTC_ERR_ES_BLUE: c_int = 44;
pub const wxSTC_ERR_ES_MAGENTA: c_int = 45;
pub const wxSTC_ERR_ES_CYAN: c_int = 46;
pub const wxSTC_ERR_ES_GRAY: c_int = 47;
pub const wxSTC_ERR_ES_DARK_GRAY: c_int = 48;
pub const wxSTC_ERR_ES_BRIGHT_RED: c_int = 49;
pub const wxSTC_ERR_ES_BRIGHT_GREEN: c_int = 50;
pub const wxSTC_ERR_ES_YELLOW: c_int = 51;
pub const wxSTC_ERR_ES_BRIGHT_BLUE: c_int = 52;
pub const wxSTC_ERR_ES_BRIGHT_MAGENTA: c_int = 53;
pub const wxSTC_ERR_ES_BRIGHT_CYAN: c_int = 54;
pub const wxSTC_ERR_ES_WHITE: c_int = 55;
...
pub const wxSTC_BAAN_WORD3: c_int = 11;
pub const wxSTC_BAAN_WORD4: c_int = 12;
pub const wxSTC_BAAN_WORD5: c_int = 13;
pub const wxSTC_BAAN_WORD6: c_int = 14;
pub const wxSTC_BAAN_WORD7: c_int = 15;
pub const wxSTC_BAAN_WORD8: c_int = 16;
pub const wxSTC_BAAN_WORD9: c_int = 17;
pub const wxSTC_BAAN_TABLEDEF: c_int = 18;
pub const wxSTC_BAAN_TABLESQL: c_int = 19;
pub const wxSTC_BAAN_FUNCTION: c_int = 20;
pub const wxSTC_BAAN_DOMDEF: c_int = 21;
pub const wxSTC_BAAN_FUNCDEF: c_int = 22;
pub const wxSTC_BAAN_OBJECTDEF: c_int = 23;
pub const wxSTC_BAAN_DEFINEDEF: c_int = 24;
...
pub const wxSTC_V_COMMENT_WORD: c_int = 20;
pub const wxSTC_V_INPUT: c_int = 21;
pub const wxSTC_V_OUTPUT: c_int = 22;
pub const wxSTC_V_INOUT: c_int = 23;
pub const wxSTC_V_PORT_CONNECT: c_int = 24;
...
pub const wxSTC_KIX_COMMENTSTREAM: c_int = 10;
...
pub const wxSTC_VHDL_BLOCK_COMMENT: c_int = 15;
...
pub const wxSTC_HA_PRAGMA: c_int = 17;
pub const wxSTC_HA_PREPROCESSOR: c_int = 18;
pub const wxSTC_HA_STRINGEOL: c_int = 19;
pub const wxSTC_HA_RESERVED_OPERATOR: c_int = 20;
pub const wxSTC_HA_LITERATE_COMMENT: c_int = 21;
pub const wxSTC_HA_LITERATE_CODEDELIM: c_int = 22;
...
pub const wxSTC_SQL_QOPERATOR: c_int = 24;
...
pub const wxSTC_ABL_DEFAULT: c_int = 0;
pub const wxSTC_ABL_NUMBER: c_int = 1;
pub const wxSTC_ABL_WORD: c_int = 2;
pub const wxSTC_ABL_STRING: c_int = 3;
pub const wxSTC_ABL_CHARACTER: c_int = 4;
pub const wxSTC_ABL_PREPROCESSOR: c_int = 5;
pub const wxSTC_ABL_OPERATOR: c_int = 6;
pub const wxSTC_ABL_IDENTIFIER: c_int = 7;
pub const wxSTC_ABL_BLOCK: c_int = 8;
pub const wxSTC_ABL_END: c_int = 9;
pub const wxSTC_ABL_COMMENT: c_int = 10;
pub const wxSTC_ABL_TASKMARKER: c_int = 11;
pub const wxSTC_ABL_LINECOMMENT: c_int = 12;
...
pub const wxSTC_POWERSHELL_HERE_STRING: c_int = 14;
pub const wxSTC_POWERSHELL_HERE_CHARACTER: c_int = 15;
pub const wxSTC_POWERSHELL_COMMENTDOCKEYWORD: c_int = 16;
...
pub const wxSTC_MYSQL_PLACEHOLDER: c_int = 22;
...
pub const wxSTC_PO_PROGRAMMER_COMMENT: c_int = 9;
pub const wxSTC_PO_REFERENCE: c_int = 10;
pub const wxSTC_PO_FLAGS: c_int = 11;
pub const wxSTC_PO_MSGID_TEXT_EOL: c_int = 12;
pub const wxSTC_PO_MSGSTR_TEXT_EOL: c_int = 13;
pub const wxSTC_PO_MSGCTXT_TEXT_EOL: c_int = 14;
pub const wxSTC_PO_ERROR: c_int = 15;
...
pub const wxSTC_COFFEESCRIPT_INSTANCEPROPERTY: c_int = 25;
...
pub const wxSTC_STTXT_DEFAULT: c_int = 0;
pub const wxSTC_STTXT_COMMENT: c_int = 1;
pub const wxSTC_STTXT_COMMENTLINE: c_int = 2;
pub const wxSTC_STTXT_KEYWORD: c_int = 3;
pub const wxSTC_STTXT_TYPE: c_int = 4;
pub const wxSTC_STTXT_FUNCTION: c_int = 5;
pub const wxSTC_STTXT_FB: c_int = 6;
pub const wxSTC_STTXT_NUMBER: c_int = 7;
pub const wxSTC_STTXT_HEXNUMBER: c_int = 8;
pub const wxSTC_STTXT_PRAGMA: c_int = 9;
pub const wxSTC_STTXT_OPERATOR: c_int = 10;
pub const wxSTC_STTXT_CHARACTER: c_int = 11;
pub const wxSTC_STTXT_STRING1: c_int = 12;
pub const wxSTC_STTXT_STRING2: c_int = 13;
pub const wxSTC_STTXT_STRINGEOL: c_int = 14;
pub const wxSTC_STTXT_IDENTIFIER: c_int = 15;
pub const wxSTC_STTXT_DATETIME: c_int = 16;
pub const wxSTC_STTXT_VARS: c_int = 17;
pub const wxSTC_STTXT_PRAGMAS: c_int = 18;
pub const wxSTC_KVIRC_DEFAULT: c_int = 0;
pub const wxSTC_KVIRC_COMMENT: c_int = 1;
pub const wxSTC_KVIRC_COMMENTBLOCK: c_int = 2;
pub const wxSTC_KVIRC_STRING: c_int = 3;
pub const wxSTC_KVIRC_WORD: c_int = 4;
pub const wxSTC_KVIRC_KEYWORD: c_int = 5;
pub const wxSTC_KVIRC_FUNCTION_KEYWORD: c_int = 6;
pub const wxSTC_KVIRC_FUNCTION: c_int = 7;
pub const wxSTC_KVIRC_VARIABLE: c_int = 8;
pub const wxSTC_KVIRC_NUMBER: c_int = 9;
pub const wxSTC_KVIRC_OPERATOR: c_int = 10;
pub const wxSTC_KVIRC_STRING_FUNCTION: c_int = 11;
pub const wxSTC_KVIRC_STRING_VARIABLE: c_int = 12;
pub const wxSTC_RUST_DEFAULT: c_int = 0;
pub const wxSTC_RUST_COMMENTBLOCK: c_int = 1;
pub const wxSTC_RUST_COMMENTLINE: c_int = 2;
pub const wxSTC_RUST_COMMENTBLOCKDOC: c_int = 3;
pub const wxSTC_RUST_COMMENTLINEDOC: c_int = 4;
pub const wxSTC_RUST_NUMBER: c_int = 5;
pub const wxSTC_RUST_WORD: c_int = 6;
pub const wxSTC_RUST_WORD2: c_int = 7;
pub const wxSTC_RUST_WORD3: c_int = 8;
pub const wxSTC_RUST_WORD4: c_int = 9;
pub const wxSTC_RUST_WORD5: c_int = 10;
pub const wxSTC_RUST_WORD6: c_int = 11;
pub const wxSTC_RUST_WORD7: c_int = 12;
pub const wxSTC_RUST_STRING: c_int = 13;
pub const wxSTC_RUST_STRINGR: c_int = 14;
pub const wxSTC_RUST_CHARACTER: c_int = 15;
pub const wxSTC_RUST_OPERATOR: c_int = 16;
pub const wxSTC_RUST_IDENTIFIER: c_int = 17;
pub const wxSTC_RUST_LIFETIME: c_int = 18;
pub const wxSTC_RUST_MACRO: c_int = 19;
pub const wxSTC_RUST_LEXERROR: c_int = 20;
pub const wxSTC_RUST_BYTESTRING: c_int = 21;
pub const wxSTC_RUST_BYTESTRINGR: c_int = 22;
pub const wxSTC_RUST_BYTECHARACTER: c_int = 23;
pub const wxSTC_DMAP_DEFAULT: c_int = 0;
pub const wxSTC_DMAP_COMMENT: c_int = 1;
pub const wxSTC_DMAP_NUMBER: c_int = 2;
pub const wxSTC_DMAP_STRING1: c_int = 3;
pub const wxSTC_DMAP_STRING2: c_int = 4;
pub const wxSTC_DMAP_STRINGEOL: c_int = 5;
pub const wxSTC_DMAP_OPERATOR: c_int = 6;
pub const wxSTC_DMAP_IDENTIFIER: c_int = 7;
pub const wxSTC_DMAP_WORD: c_int = 8;
pub const wxSTC_DMAP_WORD2: c_int = 9;
pub const wxSTC_DMAP_WORD3: c_int = 10;
pub const wxSTC_DMIS_DEFAULT: c_int = 0;
pub const wxSTC_DMIS_COMMENT: c_int = 1;
pub const wxSTC_DMIS_STRING: c_int = 2;
pub const wxSTC_DMIS_NUMBER: c_int = 3;
pub const wxSTC_DMIS_KEYWORD: c_int = 4;
pub const wxSTC_DMIS_MAJORWORD: c_int = 5;
pub const wxSTC_DMIS_MINORWORD: c_int = 6;
pub const wxSTC_DMIS_UNSUPPORTED_MAJOR: c_int = 7;
pub const wxSTC_DMIS_UNSUPPORTED_MINOR: c_int = 8;
pub const wxSTC_DMIS_LABEL: c_int = 9;
pub const wxSTC_REG_DEFAULT: c_int = 0;
pub const wxSTC_REG_COMMENT: c_int = 1;
pub const wxSTC_REG_VALUENAME: c_int = 2;
pub const wxSTC_REG_STRING: c_int = 3;
pub const wxSTC_REG_HEXDIGIT: c_int = 4;
pub const wxSTC_REG_VALUETYPE: c_int = 5;
pub const wxSTC_REG_ADDEDKEY: c_int = 6;
pub const wxSTC_REG_DELETEDKEY: c_int = 7;
pub const wxSTC_REG_ESCAPED: c_int = 8;
pub const wxSTC_REG_KEYPATH_GUID: c_int = 9;
pub const wxSTC_REG_STRING_GUID: c_int = 10;
pub const wxSTC_REG_PARAMETER: c_int = 11;
pub const wxSTC_REG_OPERATOR: c_int = 12;
pub const wxSTC_BIBTEX_DEFAULT: c_int = 0;
pub const wxSTC_BIBTEX_ENTRY: c_int = 1;
pub const wxSTC_BIBTEX_UNKNOWN_ENTRY: c_int = 2;
pub const wxSTC_BIBTEX_KEY: c_int = 3;
pub const wxSTC_BIBTEX_PARAMETER: c_int = 4;
pub const wxSTC_BIBTEX_VALUE: c_int = 5;
pub const wxSTC_BIBTEX_COMMENT: c_int = 6;
pub const wxSTC_HEX_DEFAULT: c_int = 0;
pub const wxSTC_HEX_RECSTART: c_int = 1;
pub const wxSTC_HEX_RECTYPE: c_int = 2;
pub const wxSTC_HEX_RECTYPE_UNKNOWN: c_int = 3;
pub const wxSTC_HEX_BYTECOUNT: c_int = 4;
pub const wxSTC_HEX_BYTECOUNT_WRONG: c_int = 5;
pub const wxSTC_HEX_NOADDRESS: c_int = 6;
pub const wxSTC_HEX_DATAADDRESS: c_int = 7;
pub const wxSTC_HEX_RECCOUNT: c_int = 8;
pub const wxSTC_HEX_STARTADDRESS: c_int = 9;
pub const wxSTC_HEX_ADDRESSFIELD_UNKNOWN: c_int = 10;
pub const wxSTC_HEX_EXTENDEDADDRESS: c_int = 11;
pub const wxSTC_HEX_DATA_ODD: c_int = 12;
pub const wxSTC_HEX_DATA_EVEN: c_int = 13;
pub const wxSTC_HEX_DATA_UNKNOWN: c_int = 14;
pub const wxSTC_HEX_DATA_EMPTY: c_int = 15;
pub const wxSTC_HEX_CHECKSUM: c_int = 16;
pub const wxSTC_HEX_CHECKSUM_WRONG: c_int = 17;
pub const wxSTC_HEX_GARBAGE: c_int = 18;
pub const wxSTC_JSON_DEFAULT: c_int = 0;
pub const wxSTC_JSON_NUMBER: c_int = 1;
pub const wxSTC_JSON_STRING: c_int = 2;
pub const wxSTC_JSON_STRINGEOL: c_int = 3;
pub const wxSTC_JSON_PROPERTYNAME: c_int = 4;
pub const wxSTC_JSON_ESCAPESEQUENCE: c_int = 5;
pub const wxSTC_JSON_LINECOMMENT: c_int = 6;
pub const wxSTC_JSON_BLOCKCOMMENT: c_int = 7;
pub const wxSTC_JSON_OPERATOR: c_int = 8;
pub const wxSTC_JSON_URI: c_int = 9;
pub const wxSTC_JSON_COMPACTIRI: c_int = 10;
pub const wxSTC_JSON_KEYWORD: c_int = 11;
pub const wxSTC_JSON_LDKEYWORD: c_int = 12;
pub const wxSTC_JSON_ERROR: c_int = 13;
pub const wxSTC_EDI_DEFAULT: c_int = 0;
pub const wxSTC_EDI_SEGMENTSTART: c_int = 1;
pub const wxSTC_EDI_SEGMENTEND: c_int = 2;
pub const wxSTC_EDI_SEP_ELEMENT: c_int = 3;
pub const wxSTC_EDI_SEP_COMPOSITE: c_int = 4;
pub const wxSTC_EDI_SEP_RELEASE: c_int = 5;
pub const wxSTC_EDI_UNA: c_int = 6;
pub const wxSTC_EDI_UNH: c_int = 7;
pub const wxSTC_EDI_BADSEGMENT: c_int = 8;
...
pub const wxSTC_CMD_VCHOMEDISPLAY: c_int = 2652;
pub const wxSTC_CMD_VCHOMEDISPLAYEXTEND: c_int = 2653;
...
pub const wxOS_WINDOWS: c_int = wxOS_WINDOWS_NT;
...
pub const wxPORT_QT: c_int = 1 << 10;
//  ENUM: wxBitness
pub const wxBITNESS_INVALID: c_int = -1;
pub const wxBITNESS_32: c_int = -1 + 1;
pub const wxBITNESS_64: c_int = -1 + 2;
pub const wxBITNESS_MAX: c_int = -1 + 3;
//  ENUM: wxArchitecture
...
pub const wxCLRP_SHOW_ALPHA: c_int = 0x0010;
...
pub const wxDF_PNG: c_int =              31;
pub const wxDF_MAX: c_int =              31 + 1;
//  ENUM: wxKeyCode
...
pub const wxLANGUAGE_CATALAN: c_int = 0 + 43;
pub const wxLANGUAGE_CHINESE: c_int = 0 + 44;
pub const wxLANGUAGE_CHINESE_SIMPLIFIED: c_int = 0 + 45;
pub const wxLANGUAGE_CHINESE_TRADITIONAL: c_int = 0 + 46;
pub const wxLANGUAGE_CHINESE_HONGKONG: c_int = 0 + 47;
pub const wxLANGUAGE_CHINESE_MACAU: c_int = 0 + 48;
pub const wxLANGUAGE_CHINESE_SINGAPORE: c_int = 0 + 49;
pub const wxLANGUAGE_CHINESE_TAIWAN: c_int = 0 + 50;
pub const wxLANGUAGE_CORSICAN: c_int = 0 + 51;
pub const wxLANGUAGE_CROATIAN: c_int = 0 + 52;
pub const wxLANGUAGE_CZECH: c_int = 0 + 53;
pub const wxLANGUAGE_DANISH: c_int = 0 + 54;
pub const wxLANGUAGE_DUTCH: c_int = 0 + 55;
pub const wxLANGUAGE_DUTCH_BELGIAN: c_int = 0 + 56;
pub const wxLANGUAGE_ENGLISH: c_int = 0 + 57;
pub const wxLANGUAGE_ENGLISH_UK: c_int = 0 + 58;
pub const wxLANGUAGE_ENGLISH_US: c_int = 0 + 59;
pub const wxLANGUAGE_ENGLISH_AUSTRALIA: c_int = 0 + 60;
pub const wxLANGUAGE_ENGLISH_BELIZE: c_int = 0 + 61;
pub const wxLANGUAGE_ENGLISH_BOTSWANA: c_int = 0 + 62;
pub const wxLANGUAGE_ENGLISH_CANADA: c_int = 0 + 63;
pub const wxLANGUAGE_ENGLISH_CARIBBEAN: c_int = 0 + 64;
pub const wxLANGUAGE_ENGLISH_DENMARK: c_int = 0 + 65;
pub const wxLANGUAGE_ENGLISH_EIRE: c_int = 0 + 66;
pub const wxLANGUAGE_ENGLISH_ISRAEL: c_int = 0 + 67;
...
pub const wxLANGUAGE_KABYLE: c_int = 0 + 114;
pub const wxLANGUAGE_KANNADA: c_int = 0 + 115;
pub const wxLANGUAGE_KASHMIRI: c_int = 0 + 116;
pub const wxLANGUAGE_KASHMIRI_INDIA: c_int = 0 + 117;
pub const wxLANGUAGE_KAZAKH: c_int = 0 + 118;
pub const wxLANGUAGE_KERNEWEK: c_int = 0 + 119;
pub const wxLANGUAGE_KHMER: c_int = 0 + 120;
pub const wxLANGUAGE_KINYARWANDA: c_int = 0 + 121;
pub const wxLANGUAGE_KIRGHIZ: c_int = 0 + 122;
pub const wxLANGUAGE_KIRUNDI: c_int = 0 + 123;
pub const wxLANGUAGE_KONKANI: c_int = 0 + 124;
pub const wxLANGUAGE_KOREAN: c_int = 0 + 125;
pub const wxLANGUAGE_KURDISH: c_int = 0 + 126;
pub const wxLANGUAGE_LAOTHIAN: c_int = 0 + 127;
pub const wxLANGUAGE_LATIN: c_int = 0 + 128;
pub const wxLANGUAGE_LATVIAN: c_int = 0 + 129;
pub const wxLANGUAGE_LINGALA: c_int = 0 + 130;
pub const wxLANGUAGE_LITHUANIAN: c_int = 0 + 131;
pub const wxLANGUAGE_MACEDONIAN: c_int = 0 + 132;
pub const wxLANGUAGE_MALAGASY: c_int = 0 + 133;
pub const wxLANGUAGE_MALAY: c_int = 0 + 134;
pub const wxLANGUAGE_MALAYALAM: c_int = 0 + 135;
pub const wxLANGUAGE_MALAY_BRUNEI_DARUSSALAM: c_int = 0 + 136;
pub const wxLANGUAGE_MALAY_MALAYSIA: c_int = 0 + 137;
pub const wxLANGUAGE_MALTESE: c_int = 0 + 138;
pub const wxLANGUAGE_MANIPURI: c_int = 0 + 139;
pub const wxLANGUAGE_MAORI: c_int = 0 + 140;
pub const wxLANGUAGE_MARATHI: c_int = 0 + 141;
pub const wxLANGUAGE_MOLDAVIAN: c_int = 0 + 142;
pub const wxLANGUAGE_MONGOLIAN: c_int = 0 + 143;
pub const wxLANGUAGE_NAURU: c_int = 0 + 144;
pub const wxLANGUAGE_NEPALI: c_int = 0 + 145;
pub const wxLANGUAGE_NEPALI_INDIA: c_int = 0 + 146;
pub const wxLANGUAGE_NORWEGIAN_BOKMAL: c_int = 0 + 147;
pub const wxLANGUAGE_NORWEGIAN_NYNORSK: c_int = 0 + 148;
pub const wxLANGUAGE_OCCITAN: c_int = 0 + 149;
pub const wxLANGUAGE_ORIYA: c_int = 0 + 150;
pub const wxLANGUAGE_OROMO: c_int = 0 + 151;
pub const wxLANGUAGE_PASHTO: c_int = 0 + 152;
pub const wxLANGUAGE_POLISH: c_int = 0 + 153;
pub const wxLANGUAGE_PORTUGUESE: c_int = 0 + 154;
pub const wxLANGUAGE_PORTUGUESE_BRAZILIAN: c_int = 0 + 155;
pub const wxLANGUAGE_PUNJABI: c_int = 0 + 156;
pub const wxLANGUAGE_QUECHUA: c_int = 0 + 157;
pub const wxLANGUAGE_RHAETO_ROMANCE: c_int = 0 + 158;
pub const wxLANGUAGE_ROMANIAN: c_int = 0 + 159;
pub const wxLANGUAGE_RUSSIAN: c_int = 0 + 160;
pub const wxLANGUAGE_RUSSIAN_UKRAINE: c_int = 0 + 161;
pub const wxLANGUAGE_SAMI: c_int = 0 + 162;
pub const wxLANGUAGE_SAMOAN: c_int = 0 + 163;
pub const wxLANGUAGE_SANGHO: c_int = 0 + 164;
pub const wxLANGUAGE_SANSKRIT: c_int = 0 + 165;
pub const wxLANGUAGE_SCOTS_GAELIC: c_int = 0 + 166;
pub const wxLANGUAGE_SERBIAN: c_int = 0 + 167;
pub const wxLANGUAGE_SERBIAN_CYRILLIC: c_int = 0 + 168;
pub const wxLANGUAGE_SERBIAN_LATIN: c_int = 0 + 169;
pub const wxLANGUAGE_SERBO_CROATIAN: c_int = 0 + 170;
pub const wxLANGUAGE_SESOTHO: c_int = 0 + 171;
pub const wxLANGUAGE_SETSWANA: c_int = 0 + 172;
pub const wxLANGUAGE_SHONA: c_int = 0 + 173;
pub const wxLANGUAGE_SINDHI: c_int = 0 + 174;
pub const wxLANGUAGE_SINHALESE: c_int = 0 + 175;
pub const wxLANGUAGE_SISWATI: c_int = 0 + 176;
pub const wxLANGUAGE_SLOVAK: c_int = 0 + 177;
pub const wxLANGUAGE_SLOVENIAN: c_int = 0 + 178;
pub const wxLANGUAGE_SOMALI: c_int = 0 + 179;
pub const wxLANGUAGE_SPANISH: c_int = 0 + 180;
pub const wxLANGUAGE_SPANISH_ARGENTINA: c_int = 0 + 181;
pub const wxLANGUAGE_SPANISH_BOLIVIA: c_int = 0 + 182;
pub const wxLANGUAGE_SPANISH_CHILE: c_int = 0 + 183;
pub const wxLANGUAGE_SPANISH_COLOMBIA: c_int = 0 + 184;
pub const wxLANGUAGE_SPANISH_COSTA_RICA: c_int = 0 + 185;
pub const wxLANGUAGE_SPANISH_DOMINICAN_REPUBLIC: c_int = 0 + 186;
pub const wxLANGUAGE_SPANISH_ECUADOR: c_int = 0 + 187;
pub const wxLANGUAGE_SPANISH_EL_SALVADOR: c_int = 0 + 188;
pub const wxLANGUAGE_SPANISH_GUATEMALA: c_int = 0 + 189;
pub const wxLANGUAGE_SPANISH_HONDURAS: c_int = 0 + 190;
pub const wxLANGUAGE_SPANISH_MEXICAN: c_int = 0 + 191;
pub const wxLANGUAGE_SPANISH_MODERN: c_int = 0 + 192;
pub const wxLANGUAGE_SPANISH_NICARAGUA: c_int = 0 + 193;
pub const wxLANGUAGE_SPANISH_PANAMA: c_int = 0 + 194;
pub const wxLANGUAGE_SPANISH_PARAGUAY: c_int = 0 + 195;
pub const wxLANGUAGE_SPANISH_PERU: c_int = 0 + 196;
pub const wxLANGUAGE_SPANISH_PUERTO_RICO: c_int = 0 + 197;
pub const wxLANGUAGE_SPANISH_URUGUAY: c_int = 0 + 198;
pub const wxLANGUAGE_SPANISH_US: c_int = 0 + 199;
pub const wxLANGUAGE_SPANISH_VENEZUELA: c_int = 0 + 200;
pub const wxLANGUAGE_SUNDANESE: c_int = 0 + 201;
pub const wxLANGUAGE_SWAHILI: c_int = 0 + 202;
pub const wxLANGUAGE_SWEDISH: c_int = 0 + 203;
pub const wxLANGUAGE_SWEDISH_FINLAND: c_int = 0 + 204;
pub const wxLANGUAGE_TAGALOG: c_int = 0 + 205;
pub const wxLANGUAGE_TAJIK: c_int = 0 + 206;
pub const wxLANGUAGE_TAMIL: c_int = 0 + 207;
pub const wxLANGUAGE_TATAR: c_int = 0 + 208;
pub const wxLANGUAGE_TELUGU: c_int = 0 + 209;
pub const wxLANGUAGE_THAI: c_int = 0 + 210;
pub const wxLANGUAGE_TIBETAN: c_int = 0 + 211;
pub const wxLANGUAGE_TIGRINYA: c_int = 0 + 212;
pub const wxLANGUAGE_TONGA: c_int = 0 + 213;
pub const wxLANGUAGE_TSONGA: c_int = 0 + 214;
pub const wxLANGUAGE_TURKISH: c_int = 0 + 215;
pub const wxLANGUAGE_TURKMEN: c_int = 0 + 216;
pub const wxLANGUAGE_TWI: c_int = 0 + 217;
pub const wxLANGUAGE_UIGHUR: c_int = 0 + 218;
pub const wxLANGUAGE_UKRAINIAN: c_int = 0 + 219;
pub const wxLANGUAGE_URDU: c_int = 0 + 220;
pub const wxLANGUAGE_URDU_INDIA: c_int = 0 + 221;
pub const wxLANGUAGE_URDU_PAKISTAN: c_int = 0 + 222;
pub const wxLANGUAGE_UZBEK: c_int = 0 + 223;
pub const wxLANGUAGE_UZBEK_CYRILLIC: c_int = 0 + 224;
pub const wxLANGUAGE_UZBEK_LATIN: c_int = 0 + 225;
pub const wxLANGUAGE_VALENCIAN: c_int = 0 + 226;
pub const wxLANGUAGE_VIETNAMESE: c_int = 0 + 227;
pub const wxLANGUAGE_VOLAPUK: c_int = 0 + 228;
pub const wxLANGUAGE_WELSH: c_int = 0 + 229;
pub const wxLANGUAGE_WOLOF: c_int = 0 + 230;
pub const wxLANGUAGE_XHOSA: c_int = 0 + 231;
pub const wxLANGUAGE_YIDDISH: c_int = 0 + 232;
pub const wxLANGUAGE_YORUBA: c_int = 0 + 233;
pub const wxLANGUAGE_ZHUANG: c_int = 0 + 234;
pub const wxLANGUAGE_ZULU: c_int = 0 + 235;
pub const wxLANGUAGE_USER_DEFINED: c_int = 0 + 236;
pub const wxLANGUAGE_CAMBODIAN: c_int = wxLANGUAGE_KHMER;
...
pub const wxPG_BASE_OCT: c_int = 8;
pub const wxPG_BASE_DEC: c_int = 10;
pub const wxPG_BASE_HEX: c_int = 16;
pub const wxPG_BASE_HEXL: c_int = 32;
pub const wxPG_PREFIX_NONE: c_int = 0;
pub const wxPG_PREFIX_0x: c_int = 1;
pub const wxPG_PREFIX_DOLLAR_SIGN: c_int = 2;
...
pub const wxFILTER_XDIGITS: c_int = 0 + 11;
pub const wxFILTER_SPACE: c_int = 0 + 12;
...
//  ENUM: @55
pub const wxTOUCH_NONE: c_int = 0;
pub const wxTOUCH_VERTICAL_PAN_GESTURE: c_int = 0 + 1;
pub const wxTOUCH_HORIZONTAL_PAN_GESTURE: c_int = 0 + 2;
pub const wxTOUCH_PAN_GESTURES: c_int = 0 + 3;
pub const wxTOUCH_ZOOM_GESTURE: c_int = 0 + 4;
pub const wxTOUCH_ROTATE_GESTURE: c_int = 0 + 5;
pub const wxTOUCH_PRESS_GESTURES: c_int = 0 + 6;
pub const wxTOUCH_ALL_GESTURES: c_int = 0 + 7;
//  ENUM: @56
...
pub const Type_Boolean: c_int = 0 + 1;
pub const Type_Integer: c_int = 0 + 2;
pub const Type_Float: c_int = 0 + 3;
...
pub const wxIMAGE_ALPHA_BLEND_OVER: c_int = 0;
pub const wxIMAGE_ALPHA_BLEND_COMPOSE: c_int = 1;
//  ENUM: wxImagePNGType
...
pub const wxWEBVIEW_NAV_ACTION_NONE: c_int = 0;
pub const wxWEBVIEW_NAV_ACTION_USER: c_int = 0 + 1;
pub const wxWEBVIEW_NAV_ACTION_OTHER: c_int = 0 + 2;
//  ENUM: wxWebViewUserScriptInjectionTime
pub const wxWEBVIEW_INJECT_AT_DOCUMENT_START: c_int = 0;
pub const wxWEBVIEW_INJECT_AT_DOCUMENT_END: c_int = 0 + 1;
//  ENUM: wxWebViewIE_EmulationLevel
pub const wxWEBVIEWIE_EMU_DEFAULT: c_int =    0;
pub const wxWEBVIEWIE_EMU_IE7: c_int =        7000;
pub const wxWEBVIEWIE_EMU_IE8: c_int =        8000;
pub const wxWEBVIEWIE_EMU_IE8_FORCE: c_int =  8888;
pub const wxWEBVIEWIE_EMU_IE9: c_int =        9000;
pub const wxWEBVIEWIE_EMU_IE9_FORCE: c_int =  9999;
pub const wxWEBVIEWIE_EMU_IE10: c_int =       10000;
pub const wxWEBVIEWIE_EMU_IE10_FORCE: c_int = 10001;
pub const wxWEBVIEWIE_EMU_IE11: c_int =       11000;
pub const wxWEBVIEWIE_EMU_IE11_FORCE: c_int = 11001;
...
//  ENUM: @43
pub const wxCONTROL_NONE: c_int = 0x00000000;
...
pub const wxCONTROL_CELL: c_int = wxCONTROL_SPECIAL;
...
pub const wxSYS_CARET_ON_MSEC: c_int = 0 + 38;
pub const wxSYS_CARET_OFF_MSEC: c_int = 0 + 39;
pub const wxSYS_CARET_TIMEOUT_MSEC: c_int = 0 + 40;
...
pub const wxPU_CONTAINS_CONTROLS: c_int = 0x0001;
...
pub const wxHD_BITMAP_ON_RIGHT: c_int = 0x0004;
...
pub const wxStrip_CJKMnemonics: c_int = 4;
pub const wxStrip_All: c_int = wxStrip_Mnemonics | wxStrip_Accel;
pub const wxStrip_Menu: c_int = wxStrip_All | wxStrip_CJKMnemonics;
//  ENUM: @54
...
pub const wxZIP_FORMAT_DEFAULT: c_int = 0;
pub const wxZIP_FORMAT_ZIP64: c_int = 0 + 1;
...
pub const wxFH_PATH_SHOW_IF_DIFFERENT: c_int = 0;
pub const wxFH_PATH_SHOW_NEVER: c_int = 0 + 1;
pub const wxFH_PATH_SHOW_ALWAYS: c_int = 0 + 2;
...
pub const wxDIRCTRL_DEFAULT_STYLE: c_int = wxDIRCTRL_3D_INTERNAL;
...
pub const wxXRC_USE_ENVVARS: c_int = 8;
...
pub const wxRICHTEXT_HANDLER_USE_CSS: c_int = 0x1000;
...
pub const wxTEXT_BOX_ATTR_BOX_STYLE_NAME: c_int = 0x00000010;
pub const wxTEXT_BOX_ATTR_WHITESPACE: c_int = 0x00000020;
pub const wxTEXT_BOX_ATTR_CORNER_RADIUS: c_int = 0x00000040;
...
pub const wxTEXT_BOX_ATTR_WHITESPACE_NONE: c_int = 0;
pub const wxTEXT_BOX_ATTR_WHITESPACE_NORMAL: c_int = 1;
pub const wxTEXT_BOX_ATTR_WHITESPACE_NO_WRAP: c_int = 2;
pub const wxTEXT_BOX_ATTR_WHITESPACE_PREFORMATTED: c_int = 3;
pub const wxTEXT_BOX_ATTR_WHITESPACE_PREFORMATTED_LINE: c_int = 4;
pub const wxTEXT_BOX_ATTR_WHITESPACE_PREFORMATTED_WRAP: c_int = 5;
...
pub const wxTEXT_ATTR_AVOID_PAGE_BREAK_BEFORE: c_int = 0x20000000;
pub const wxTEXT_ATTR_AVOID_PAGE_BREAK_AFTER: c_int =  0x40000000;
...
pub const wxTEXT_ATTR_EFFECT_RTL: c_int = 0x00000400;
pub const wxTEXT_ATTR_EFFECT_SUPPRESS_HYPHENATION: c_int = 0x00001000;
...
pub const wxTEXT_ATTR_UNDERLINE_NONE: c_int = 0;
pub const wxTEXT_ATTR_UNDERLINE_SOLID: c_int = 0 + 1;
pub const wxTEXT_ATTR_UNDERLINE_DOUBLE: c_int = 0 + 2;
pub const wxTEXT_ATTR_UNDERLINE_SPECIAL: c_int = 0 + 3;
...
pub const wxPOWER_RESOURCE_SCREEN: c_int = 0;
pub const wxPOWER_RESOURCE_SYSTEM: c_int = 0 + 1;
...
pub const wxTASKBAR_BUTTON_NO_PROGRESS: c_int = 0;
pub const wxTASKBAR_BUTTON_INDETERMINATE: c_int = 1;
pub const wxTASKBAR_BUTTON_NORMAL: c_int = 2;
pub const wxTASKBAR_BUTTON_ERROR: c_int = 4;
pub const wxTASKBAR_BUTTON_PAUSED: c_int = 8;
//  ENUM: wxTaskBarJumpListItemType
pub const wxTASKBAR_JUMP_LIST_SEPARATOR: c_int = 0;
pub const wxTASKBAR_JUMP_LIST_TASK: c_int = 0 + 1;
pub const wxTASKBAR_JUMP_LIST_DESTINATION: c_int = 0 + 2;
...
//  ENUM: wxPenQuality
pub const wxPEN_QUALITY_DEFAULT: c_int = 0;
pub const wxPEN_QUALITY_LOW: c_int = 0 + 1;
pub const wxPEN_QUALITY_HIGH: c_int = 0 + 2;
//  ENUM: wxPenJoin
...
//  ENUM: wxGradientType
pub const wxGRADIENT_NONE: c_int = 0;
...
pub const wxGA_PROGRESS: c_int = 0x0010;
pub const wxGA_SMOOTH: c_int = 0x0020;
pub const wxGA_TEXT: c_int = 0x0040;
...
pub const wxCMD_LINE_HIDDEN: c_int = 0x40;
