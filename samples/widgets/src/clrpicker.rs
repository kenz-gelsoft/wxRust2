...
impl ColourPickerPage {
    fn from(v: c_int) -> Option<Self> {
        use ColourPickerPage::*;
        for e in [
            Reset,
            Add,
            AddText,
...
impl From<ColourPickerPage> for c_int {
    fn from(w: ColourPickerPage) -> Self {
        w as c_int
    }
}
...
pub struct ColourPickerWidgetsPage {
    ...
    // the choice itself
    choice: Rc<RefCell<Option<wx::ColourPickerCtrl>>>,
...
impl WidgetsPage for ColourPickerWidgetsPage {
    ...
    fn create_content(&self) {
        ...
        //     .id(ColourPickerPage::Reset.into())
        //     .label("&Reset")
        //     .build();
        ...
        // let sizer_row = wx::BoxSizer::new(wx::HORIZONTAL);
        // let btn = wx::Button::builder(Some(&self.base))
        //     .id(ColourPickerPage::Delete.into())
        //     .label("&Delete this item")
        //     .build();
        // let text_delete = wx::TextCtrl::builder(Some(&self.base))
        //     .id(ColourPickerPage::DeleteText.into())
        //     .build();
        // sizer_row.add_window_int(Some(&btn), 0, wx::RIGHT, 5, wx::Object::none());
        ...
        // let btn = wx::Button::builder(Some(&self.base))
        //     .id(ColourPickerPage::DeleteSel.into())
        //     .label("Delete &selection")
        //     .build();
        // sizer_middle.add_window_int(Some(&btn), 0, wx::ALL | wx::GROW, 5, wx::Object::none());

        // let btn = wx::Button::builder(Some(&self.base))
        //     .id(ColourPickerPage::Clear.into())
        //     .label("&Clear")
        //     .build();
        // sizer_middle.add_window_int(Some(&btn), 0, wx::ALL | wx::GROW, 5, wx::Object::none());

        // let btn = wx::Button::builder(Some(&self.base))
        //     .id(ColourPickerPage::ContainerTests.into())
        //     .label("Run &tests")
        //     .build();
        // sizer_middle.add_window_int(Some(&btn), 0, wx::ALL | wx::GROW, 5, wx::Object::none());
        ...
        // let choice = wx::ColourPicker::builder(Some(&self.base))
        //     .id(ColourPickerPage::ColourPicker.into())
        //     .build();
    ...
    fn handle_button(&self, event: &wx::CommandEvent) {
        ...
        if let Some(m) = ColourPickerPage::from(event.get_id()) {
            if let Some(config_ui) = self.config_ui.borrow().as_ref() {
                match m {
                    ColourPickerPage::Reset => self.on_button_reset(),
                    ColourPickerPage::Change => self.on_button_change(config_ui),
                    ColourPickerPage::Delete => self.on_button_delete(config_ui),
                    ColourPickerPage::DeleteSel => self.on_button_delete_sel(),
                    ColourPickerPage::Clear => self.on_button_clear(),
                    ColourPickerPage::Add => self.on_button_add(config_ui),
                    ColourPickerPage::AddSeveral => self.on_button_add_several(),
                    ColourPickerPage::AddMany => self.on_button_add_many(),
...
impl ColourPickerWidgetsPage {
    ...
    fn create_choice(&self) {
        ...
        //     let new_choice = wx::ColourPicker::builder(Some(&self.base))
        //         .id(ColourPickerPage::ColourPicker.into())
        //         .style(flags)
        //         .build();
