...
fn main() {
    wx::App::run(|_| {
        ...
        frame.base.bind(wx::RUST_EVT_MENU, move |event: &wx::CommandEvent| {
...
impl MyFrame {
    fn new(title: &str) -> Self {
        let frame = wx::Frame::new(wx::Window::none(), wx::ID_ANY, title, 
                &wx::Point::default(), &wx::Size::default(),
                wx::DEFAULT_FRAME_STYLE, "");
        let file_menu = wx::Menu::new();
        let help_menu = wx::Menu::new();
        help_menu.append_int_str(MINIMAL_ABOUT, "&About\tF1", "Show about dialog", wx::ITEM_NORMAL);
        file_menu.append_int_str(MINIMAL_QUIT, "E&xit\tAlt-X", "Quit this program", wx::ITEM_NORMAL);
    ...
    fn on_about(&self) {
        wx::message_box(
            ...
            (wx::OK | wx::ICON_INFORMATION as c_long).try_into().unwrap(),
            Some(&self.base),
        )
    }
}
