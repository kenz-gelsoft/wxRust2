...
// wxQuantize
/// This trait represents C++ [`wxQuantize`](https://docs.wxwidgets.org/3.2/classwx_quantize.html) class's methods and inheritance.
///
...
pub trait QuantizeMethods: ObjectMethods {
    ...
    ///
    /// [See `wxQuantize::DoQuantize()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_quantize.html#af08475e1608d344b597799d1c575b13c)
    fn do_quantize(
        w: c_uint,
        h: c_uint,
        in_rows: *mut c_void,
    ...
    ///
    /// [See `wxQuantize::Quantize()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_quantize.html#a1c1c9e1fef4fff61f0aafc8dd3e6c65c)
    ...
    ///
    /// [See `wxQuantize::Quantize()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_quantize.html#aa99e73bbc0f939bb4d7f40ca761ce31f)
...
/// This trait represents C++ [`wxQueryLayoutInfoEvent`](https://docs.wxwidgets.org/3.2/classwx_query_layout_info_event.html) class's methods and inheritance.
///
...
pub trait QueryLayoutInfoEventMethods: EventMethods {
    ...
    ///
    /// [See `wxQueryLayoutInfoEvent::GetFlags()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_query_layout_info_event.html#a5473a15165e30136dbd3f37df3c56214)
    ...
    ///
    /// [See `wxQueryLayoutInfoEvent::GetRequestedLength()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_query_layout_info_event.html#ad21f4fce3a1843e868bf6dabf200e491)
    ...
    ///
    /// [See `wxQueryLayoutInfoEvent::GetSize()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_query_layout_info_event.html#a6350973483b59a95f172f64926936c36)
    ...
    ///
    /// [See `wxQueryLayoutInfoEvent::SetFlags()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_query_layout_info_event.html#a5cefb50301df556df7841cd33be945c7)
    ...
    ///
    /// [See `wxQueryLayoutInfoEvent::SetRequestedLength()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_query_layout_info_event.html#ad844a6dfbe69cf48303823d2573810cf)
    ...
    ///
    /// [See `wxQueryLayoutInfoEvent::SetSize()`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_query_layout_info_event.html#a47ec467f4476fb22fccebb2ad7365bb4)
