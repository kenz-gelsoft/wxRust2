...
wxwidgets! {
    ...
    /// - [`UIActionSimulator`] represents a C++ `wxUIActionSimulator` class instance which your code has ownership, [`UIActionSimulatorFromCpp`]`<false>` represents one which don't own.
    ...
    class UIActionSimulator
        = UIActionSimulatorFromCpp<true>(wxUIActionSimulator) impl
...
impl Clone for UIActionSimulatorFromCpp<false> {
    fn clone(&self) -> Self {
        Self(self.0)
    }
}
...
wxwidgets! {
    ...
    /// - [`URLDataObject`] represents a C++ `wxURLDataObject` class instance which your code has ownership, [`URLDataObjectFromCpp`]`<false>` represents one which don't own.
    ...
    class URLDataObject
        = URLDataObjectFromCpp<true>(wxURLDataObject) impl
...
impl Clone for URLDataObjectFromCpp<false> {
    fn clone(&self) -> Self {
        Self(self.0)
    }
}
...
wxwidgets! {
    ...
    /// - [`UpdateUIEvent`] represents a C++ `wxUpdateUIEvent` class instance which your code has ownership, [`UpdateUIEventFromCpp`]`<false>` represents one which don't own.
    ...
    class UpdateUIEvent
        = UpdateUIEventFromCpp<true>(wxUpdateUIEvent) impl
...
impl Clone for UpdateUIEventFromCpp<false> {
    fn clone(&self) -> Self {
        Self(self.0)
    }
}
