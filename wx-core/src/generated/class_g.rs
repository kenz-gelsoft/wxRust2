...
impl<const IN_RUST: bool> GBPositionInRust<IN_RUST> {
    ...
    pub fn new() -> GBPositionInRust<IN_RUST> {
    ...
    pub fn new_with_int(row: c_int, col: c_int) -> GBPositionInRust<IN_RUST> {
...
impl<const IN_RUST: bool> Drop for GBPositionInRust<IN_RUST> {
    fn drop(&mut self) {
        if IN_RUST {
...
impl<const IN_RUST: bool> GBSizerItemInRust<IN_RUST> {
...
impl<const IN_RUST: bool> From<GBSizerItemInRust<IN_RUST>> for SizerItemInRust<IN_RUST> {
    fn from(o: GBSizerItemInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> From<GBSizerItemInRust<IN_RUST>> for ObjectInRust<IN_RUST> {
    fn from(o: GBSizerItemInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> DynamicCast for GBSizerItemInRust<IN_RUST> {
    fn class_info() -> ClassInfoInRust<false> {
        unsafe { ClassInfoInRust::from_ptr(ffi::wxGBSizerItem_CLASSINFO()) }
    }
}
impl<const IN_RUST: bool> Drop for GBSizerItemInRust<IN_RUST> {
    fn drop(&mut self) {
        if IN_RUST {
...
impl<const IN_RUST: bool> GBSpanInRust<IN_RUST> {
    ...
    pub fn new() -> GBSpanInRust<IN_RUST> {
    ...
    pub fn new_with_int(rowspan: c_int, colspan: c_int) -> GBSpanInRust<IN_RUST> {
...
impl<const IN_RUST: bool> Drop for GBSpanInRust<IN_RUST> {
    fn drop(&mut self) {
        if IN_RUST {
...
impl<const IN_RUST: bool> GCDCInRust<IN_RUST> {
    ...
    pub fn new_with_windowdc<W: WindowDCMethods>(window_dc: &W) -> GCDCInRust<IN_RUST> {
        unsafe {
    ...
    pub fn new_with_memorydc<M: MemoryDCMethods>(memory_dc: &M) -> GCDCInRust<IN_RUST> {
        unsafe {
    ...
    pub fn new_with_enhmetafiledc(emf_dc: *const c_void) -> GCDCInRust<IN_RUST> {
...
impl<const IN_RUST: bool> From<GCDCInRust<IN_RUST>> for DCInRust<IN_RUST> {
    fn from(o: GCDCInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> From<GCDCInRust<IN_RUST>> for ObjectInRust<IN_RUST> {
    fn from(o: GCDCInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> DynamicCast for GCDCInRust<IN_RUST> {
    fn class_info() -> ClassInfoInRust<false> {
        unsafe { ClassInfoInRust::from_ptr(ffi::wxGCDC_CLASSINFO()) }
    }
}
impl<const IN_RUST: bool> Drop for GCDCInRust<IN_RUST> {
    fn drop(&mut self) {
        if IN_RUST {
            unsafe { ffi::wxObject_delete(self.0) }
        }
...
impl<const IN_RUST: bool> GDIObjectInRust<IN_RUST> {
...
impl<const IN_RUST: bool> From<GDIObjectInRust<IN_RUST>> for ObjectInRust<IN_RUST> {
    fn from(o: GDIObjectInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> DynamicCast for GDIObjectInRust<IN_RUST> {
    fn class_info() -> ClassInfoInRust<false> {
        unsafe { ClassInfoInRust::from_ptr(ffi::wxGDIObject_CLASSINFO()) }
    }
}
impl<const IN_RUST: bool> Drop for GDIObjectInRust<IN_RUST> {
    fn drop(&mut self) {
        if IN_RUST {
            unsafe { ffi::wxObject_delete(self.0) }
        }
...
impl<const IN_RUST: bool> GIFHandlerInRust<IN_RUST> {
    ...
    pub fn new() -> GIFHandlerInRust<IN_RUST> {
...
impl<const IN_RUST: bool> From<GIFHandlerInRust<IN_RUST>> for ImageHandlerInRust<IN_RUST> {
    fn from(o: GIFHandlerInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> From<GIFHandlerInRust<IN_RUST>> for ObjectInRust<IN_RUST> {
    fn from(o: GIFHandlerInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> DynamicCast for GIFHandlerInRust<IN_RUST> {
    fn class_info() -> ClassInfoInRust<false> {
        unsafe { ClassInfoInRust::from_ptr(ffi::wxGIFHandler_CLASSINFO()) }
    }
}
impl<const IN_RUST: bool> Drop for GIFHandlerInRust<IN_RUST> {
    fn drop(&mut self) {
        if IN_RUST {
            unsafe { ffi::wxObject_delete(self.0) }
        }
...
impl<const IN_RUST: bool> Clone for GaugeInRust<IN_RUST> {
    fn clone(&self) -> Self {
        Self(self.0)
    }
}
impl<const IN_RUST: bool> From<GaugeInRust<IN_RUST>> for ControlInRust<IN_RUST> {
    fn from(o: GaugeInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> From<GaugeInRust<IN_RUST>> for WindowInRust<IN_RUST> {
    fn from(o: GaugeInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> From<GaugeInRust<IN_RUST>> for EvtHandlerInRust<IN_RUST> {
    fn from(o: GaugeInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> From<GaugeInRust<IN_RUST>> for ObjectInRust<IN_RUST> {
    fn from(o: GaugeInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> DynamicCast for GaugeInRust<IN_RUST> {
    fn class_info() -> ClassInfoInRust<false> {
...
impl<const IN_RUST: bool> GenericAboutDialogInRust<IN_RUST> {
    ...
    pub fn new() -> GenericAboutDialogInRust<IN_RUST> {
    ...
    pub fn new_with_aboutdialoginfo<A: AboutDialogInfoMethods, W: WindowMethods>(
        info: &A,
        parent: Option<&W>,
    ) -> GenericAboutDialogInRust<IN_RUST> {
        unsafe {
...
impl<const IN_RUST: bool> Drop for GenericAboutDialogInRust<IN_RUST> {
    fn drop(&mut self) {
        if IN_RUST {
...
impl<const IN_RUST: bool> GenericDirCtrlInRust<IN_RUST> {
    /// Default constructor.
    ///
    ...
    pub fn new_2step() -> GenericDirCtrlInRust<IN_RUST> {
...
impl<const IN_RUST: bool> Clone for GenericDirCtrlInRust<IN_RUST> {
    fn clone(&self) -> Self {
        Self(self.0)
    }
}
impl<const IN_RUST: bool> From<GenericDirCtrlInRust<IN_RUST>> for ControlInRust<IN_RUST> {
    fn from(o: GenericDirCtrlInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> From<GenericDirCtrlInRust<IN_RUST>> for WindowInRust<IN_RUST> {
    fn from(o: GenericDirCtrlInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> From<GenericDirCtrlInRust<IN_RUST>> for EvtHandlerInRust<IN_RUST> {
    fn from(o: GenericDirCtrlInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> From<GenericDirCtrlInRust<IN_RUST>> for ObjectInRust<IN_RUST> {
    fn from(o: GenericDirCtrlInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> DynamicCast for GenericDirCtrlInRust<IN_RUST> {
    fn class_info() -> ClassInfoInRust<false> {
...
impl<const IN_RUST: bool> GenericProgressDialogInRust<IN_RUST> {
    /// Constructor.
    ///
    ...
    pub fn new<W: WindowMethods>(
        ...
        parent: Option<&W>,
        style: c_int,
    ) -> GenericProgressDialogInRust<IN_RUST> {
        unsafe {
...
impl<const IN_RUST: bool> Clone for GenericProgressDialogInRust<IN_RUST> {
    fn clone(&self) -> Self {
        Self(self.0)
    }
}
impl<const IN_RUST: bool> From<GenericProgressDialogInRust<IN_RUST>> for DialogInRust<IN_RUST> {
    fn from(o: GenericProgressDialogInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> From<GenericProgressDialogInRust<IN_RUST>>
...
impl<const IN_RUST: bool> From<GenericProgressDialogInRust<IN_RUST>> for WindowInRust<IN_RUST> {
    fn from(o: GenericProgressDialogInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> From<GenericProgressDialogInRust<IN_RUST>> for EvtHandlerInRust<IN_RUST> {
    fn from(o: GenericProgressDialogInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> From<GenericProgressDialogInRust<IN_RUST>> for ObjectInRust<IN_RUST> {
    fn from(o: GenericProgressDialogInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> DynamicCast for GenericProgressDialogInRust<IN_RUST> {
    fn class_info() -> ClassInfoInRust<false> {
...
impl<const IN_RUST: bool> GenericValidatorInRust<IN_RUST> {
    /// Copy constructor.
    ///
    ...
    pub fn new_with_genericvalidator<G: GenericValidatorMethods>(
        validator: &G,
    ) -> GenericValidatorInRust<IN_RUST> {
        unsafe {
            let validator = validator.as_ptr();
    ...
    pub fn new_with_bool(val_ptr: *mut c_void) -> GenericValidatorInRust<IN_RUST> {
    ...
    pub fn new_with_str(val_ptr: *mut c_void) -> GenericValidatorInRust<IN_RUST> {
    ...
    pub fn new_with_int(val_ptr: *mut c_void) -> GenericValidatorInRust<IN_RUST> {
    ...
    pub fn new_with_float(val_ptr: *mut c_void) -> GenericValidatorInRust<IN_RUST> {
    ...
    pub fn new_with_double(val_ptr: *mut c_void) -> GenericValidatorInRust<IN_RUST> {
...
impl<const IN_RUST: bool> Clone for GenericValidatorInRust<IN_RUST> {
    fn clone(&self) -> Self {
        Self(self.0)
    }
}
impl<const IN_RUST: bool> From<GenericValidatorInRust<IN_RUST>> for ValidatorInRust<IN_RUST> {
    fn from(o: GenericValidatorInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> From<GenericValidatorInRust<IN_RUST>> for EvtHandlerInRust<IN_RUST> {
    fn from(o: GenericValidatorInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> From<GenericValidatorInRust<IN_RUST>> for ObjectInRust<IN_RUST> {
    fn from(o: GenericValidatorInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> DynamicCast for GenericValidatorInRust<IN_RUST> {
    fn class_info() -> ClassInfoInRust<false> {
...
impl<const IN_RUST: bool> GraphicsBrushInRust<IN_RUST> {
    pub fn none() -> Option<&'static Self> {
        None
    }
}
...
impl<const IN_RUST: bool> From<GraphicsBrushInRust<IN_RUST>> for GraphicsObjectInRust<IN_RUST> {
    fn from(o: GraphicsBrushInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> From<GraphicsBrushInRust<IN_RUST>> for ObjectInRust<IN_RUST> {
    fn from(o: GraphicsBrushInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> DynamicCast for GraphicsBrushInRust<IN_RUST> {
    fn class_info() -> ClassInfoInRust<false> {
        unsafe { ClassInfoInRust::from_ptr(ffi::wxGraphicsBrush_CLASSINFO()) }
    }
}
impl<const IN_RUST: bool> Drop for GraphicsBrushInRust<IN_RUST> {
    fn drop(&mut self) {
        if IN_RUST {
            unsafe { ffi::wxObject_delete(self.0) }
        }
...
impl<const IN_RUST: bool> GraphicsContextInRust<IN_RUST> {
    pub fn none() -> Option<&'static Self> {
        None
    }
}
...
impl<const IN_RUST: bool> From<GraphicsContextInRust<IN_RUST>> for GraphicsObjectInRust<IN_RUST> {
    fn from(o: GraphicsContextInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> From<GraphicsContextInRust<IN_RUST>> for ObjectInRust<IN_RUST> {
    fn from(o: GraphicsContextInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> DynamicCast for GraphicsContextInRust<IN_RUST> {
    fn class_info() -> ClassInfoInRust<false> {
        unsafe { ClassInfoInRust::from_ptr(ffi::wxGraphicsContext_CLASSINFO()) }
    }
}
impl<const IN_RUST: bool> Drop for GraphicsContextInRust<IN_RUST> {
    fn drop(&mut self) {
        if IN_RUST {
            unsafe { ffi::wxObject_delete(self.0) }
        }
...
impl<const IN_RUST: bool> GraphicsFontInRust<IN_RUST> {
    pub fn none() -> Option<&'static Self> {
        None
    }
}
...
impl<const IN_RUST: bool> From<GraphicsFontInRust<IN_RUST>> for GraphicsObjectInRust<IN_RUST> {
    fn from(o: GraphicsFontInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> From<GraphicsFontInRust<IN_RUST>> for ObjectInRust<IN_RUST> {
    fn from(o: GraphicsFontInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> DynamicCast for GraphicsFontInRust<IN_RUST> {
    fn class_info() -> ClassInfoInRust<false> {
        unsafe { ClassInfoInRust::from_ptr(ffi::wxGraphicsFont_CLASSINFO()) }
    }
}
impl<const IN_RUST: bool> Drop for GraphicsFontInRust<IN_RUST> {
    fn drop(&mut self) {
        if IN_RUST {
            unsafe { ffi::wxObject_delete(self.0) }
        }
...
impl<const IN_RUST: bool> GraphicsGradientStopInRust<IN_RUST> {
...
impl<const IN_RUST: bool> Drop for GraphicsGradientStopInRust<IN_RUST> {
    fn drop(&mut self) {
        if IN_RUST {
...
impl<const IN_RUST: bool> GraphicsGradientStopsInRust<IN_RUST> {
...
impl<const IN_RUST: bool> Drop for GraphicsGradientStopsInRust<IN_RUST> {
    fn drop(&mut self) {
        if IN_RUST {
...
impl<const IN_RUST: bool> GraphicsMatrixInRust<IN_RUST> {
    pub fn none() -> Option<&'static Self> {
        None
    }
}
...
impl<const IN_RUST: bool> From<GraphicsMatrixInRust<IN_RUST>> for GraphicsObjectInRust<IN_RUST> {
    fn from(o: GraphicsMatrixInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> From<GraphicsMatrixInRust<IN_RUST>> for ObjectInRust<IN_RUST> {
    fn from(o: GraphicsMatrixInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> DynamicCast for GraphicsMatrixInRust<IN_RUST> {
    fn class_info() -> ClassInfoInRust<false> {
        unsafe { ClassInfoInRust::from_ptr(ffi::wxGraphicsMatrix_CLASSINFO()) }
    }
}
impl<const IN_RUST: bool> Drop for GraphicsMatrixInRust<IN_RUST> {
    fn drop(&mut self) {
        if IN_RUST {
            unsafe { ffi::wxObject_delete(self.0) }
        }
...
impl<const IN_RUST: bool> GraphicsObjectInRust<IN_RUST> {
    pub fn none() -> Option<&'static Self> {
        None
    }
}
...
impl<const IN_RUST: bool> From<GraphicsObjectInRust<IN_RUST>> for ObjectInRust<IN_RUST> {
    fn from(o: GraphicsObjectInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> DynamicCast for GraphicsObjectInRust<IN_RUST> {
    fn class_info() -> ClassInfoInRust<false> {
        unsafe { ClassInfoInRust::from_ptr(ffi::wxGraphicsObject_CLASSINFO()) }
    }
}
impl<const IN_RUST: bool> Drop for GraphicsObjectInRust<IN_RUST> {
    fn drop(&mut self) {
        if IN_RUST {
            unsafe { ffi::wxObject_delete(self.0) }
        }
...
impl<const IN_RUST: bool> GraphicsPathInRust<IN_RUST> {
    pub fn none() -> Option<&'static Self> {
        None
    }
}
...
impl<const IN_RUST: bool> From<GraphicsPathInRust<IN_RUST>> for GraphicsObjectInRust<IN_RUST> {
    fn from(o: GraphicsPathInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> From<GraphicsPathInRust<IN_RUST>> for ObjectInRust<IN_RUST> {
    fn from(o: GraphicsPathInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> DynamicCast for GraphicsPathInRust<IN_RUST> {
    fn class_info() -> ClassInfoInRust<false> {
        unsafe { ClassInfoInRust::from_ptr(ffi::wxGraphicsPath_CLASSINFO()) }
    }
}
impl<const IN_RUST: bool> Drop for GraphicsPathInRust<IN_RUST> {
    fn drop(&mut self) {
        if IN_RUST {
            unsafe { ffi::wxObject_delete(self.0) }
        }
...
impl<const IN_RUST: bool> GraphicsPenInRust<IN_RUST> {
    pub fn none() -> Option<&'static Self> {
        None
    }
}
...
impl<const IN_RUST: bool> From<GraphicsPenInRust<IN_RUST>> for GraphicsObjectInRust<IN_RUST> {
    fn from(o: GraphicsPenInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> From<GraphicsPenInRust<IN_RUST>> for ObjectInRust<IN_RUST> {
    fn from(o: GraphicsPenInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> DynamicCast for GraphicsPenInRust<IN_RUST> {
    fn class_info() -> ClassInfoInRust<false> {
        unsafe { ClassInfoInRust::from_ptr(ffi::wxGraphicsPen_CLASSINFO()) }
    }
}
impl<const IN_RUST: bool> Drop for GraphicsPenInRust<IN_RUST> {
    fn drop(&mut self) {
        if IN_RUST {
            unsafe { ffi::wxObject_delete(self.0) }
        }
...
impl<const IN_RUST: bool> GraphicsRendererInRust<IN_RUST> {
    pub fn none() -> Option<&'static Self> {
        None
    }
}
...
impl<const IN_RUST: bool> From<GraphicsRendererInRust<IN_RUST>> for ObjectInRust<IN_RUST> {
    fn from(o: GraphicsRendererInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> DynamicCast for GraphicsRendererInRust<IN_RUST> {
    fn class_info() -> ClassInfoInRust<false> {
        unsafe { ClassInfoInRust::from_ptr(ffi::wxGraphicsRenderer_CLASSINFO()) }
    }
}
impl<const IN_RUST: bool> Drop for GraphicsRendererInRust<IN_RUST> {
    fn drop(&mut self) {
        if IN_RUST {
            unsafe { ffi::wxObject_delete(self.0) }
        }
...
impl<const IN_RUST: bool> GridBagSizerInRust<IN_RUST> {
    ...
    pub fn new(vgap: c_int, hgap: c_int) -> GridBagSizerInRust<IN_RUST> {
...
impl<const IN_RUST: bool> Clone for GridBagSizerInRust<IN_RUST> {
    fn clone(&self) -> Self {
        Self(self.0)
    }
}
impl<const IN_RUST: bool> From<GridBagSizerInRust<IN_RUST>> for FlexGridSizerInRust<IN_RUST> {
    fn from(o: GridBagSizerInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> From<GridBagSizerInRust<IN_RUST>> for GridSizerInRust<IN_RUST> {
    fn from(o: GridBagSizerInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> From<GridBagSizerInRust<IN_RUST>> for SizerInRust<IN_RUST> {
    fn from(o: GridBagSizerInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> From<GridBagSizerInRust<IN_RUST>> for ObjectInRust<IN_RUST> {
    fn from(o: GridBagSizerInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> DynamicCast for GridBagSizerInRust<IN_RUST> {
    fn class_info() -> ClassInfoInRust<false> {
...
impl<const IN_RUST: bool> GridEditorCreatedEventInRust<IN_RUST> {
    /// Default constructor.
    ///
    ...
    pub fn new() -> GridEditorCreatedEventInRust<IN_RUST> {
...
impl<const IN_RUST: bool> From<GridEditorCreatedEventInRust<IN_RUST>>
    for CommandEventInRust<IN_RUST>
{
    fn from(o: GridEditorCreatedEventInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> From<GridEditorCreatedEventInRust<IN_RUST>> for EventInRust<IN_RUST> {
    fn from(o: GridEditorCreatedEventInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> From<GridEditorCreatedEventInRust<IN_RUST>> for ObjectInRust<IN_RUST> {
    fn from(o: GridEditorCreatedEventInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> DynamicCast for GridEditorCreatedEventInRust<IN_RUST> {
    fn class_info() -> ClassInfoInRust<false> {
        unsafe { ClassInfoInRust::from_ptr(ffi::wxGridEditorCreatedEvent_CLASSINFO()) }
    }
}
impl<const IN_RUST: bool> Drop for GridEditorCreatedEventInRust<IN_RUST> {
    fn drop(&mut self) {
        if IN_RUST {
            unsafe { ffi::wxObject_delete(self.0) }
        }
...
impl<const IN_RUST: bool> GridEventInRust<IN_RUST> {
    /// Default constructor.
    ///
    ...
    pub fn new() -> GridEventInRust<IN_RUST> {
...
impl<const IN_RUST: bool> From<GridEventInRust<IN_RUST>> for NotifyEventInRust<IN_RUST> {
    fn from(o: GridEventInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> From<GridEventInRust<IN_RUST>> for CommandEventInRust<IN_RUST> {
    fn from(o: GridEventInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> From<GridEventInRust<IN_RUST>> for EventInRust<IN_RUST> {
    fn from(o: GridEventInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> From<GridEventInRust<IN_RUST>> for ObjectInRust<IN_RUST> {
    fn from(o: GridEventInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> DynamicCast for GridEventInRust<IN_RUST> {
    fn class_info() -> ClassInfoInRust<false> {
        unsafe { ClassInfoInRust::from_ptr(ffi::wxGridEvent_CLASSINFO()) }
    }
}
impl<const IN_RUST: bool> Drop for GridEventInRust<IN_RUST> {
    fn drop(&mut self) {
        if IN_RUST {
            unsafe { ffi::wxObject_delete(self.0) }
        }
...
impl<const IN_RUST: bool> GridRangeSelectEventInRust<IN_RUST> {
    /// Default constructor.
    ///
    ...
    pub fn new() -> GridRangeSelectEventInRust<IN_RUST> {
...
impl<const IN_RUST: bool> From<GridRangeSelectEventInRust<IN_RUST>> for NotifyEventInRust<IN_RUST> {
    fn from(o: GridRangeSelectEventInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> From<GridRangeSelectEventInRust<IN_RUST>>
    for CommandEventInRust<IN_RUST>
{
    fn from(o: GridRangeSelectEventInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
...
impl<const IN_RUST: bool> From<GridRangeSelectEventInRust<IN_RUST>> for EventInRust<IN_RUST> {
    fn from(o: GridRangeSelectEventInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> From<GridRangeSelectEventInRust<IN_RUST>> for ObjectInRust<IN_RUST> {
    fn from(o: GridRangeSelectEventInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> DynamicCast for GridRangeSelectEventInRust<IN_RUST> {
    fn class_info() -> ClassInfoInRust<false> {
        unsafe { ClassInfoInRust::from_ptr(ffi::wxGridRangeSelectEvent_CLASSINFO()) }
    }
}
impl<const IN_RUST: bool> Drop for GridRangeSelectEventInRust<IN_RUST> {
    fn drop(&mut self) {
        if IN_RUST {
            unsafe { ffi::wxObject_delete(self.0) }
        }
...
impl<const IN_RUST: bool> GridSizeEventInRust<IN_RUST> {
    /// Default constructor.
    ///
    ...
    pub fn new() -> GridSizeEventInRust<IN_RUST> {
...
impl<const IN_RUST: bool> From<GridSizeEventInRust<IN_RUST>> for NotifyEventInRust<IN_RUST> {
    fn from(o: GridSizeEventInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> From<GridSizeEventInRust<IN_RUST>> for CommandEventInRust<IN_RUST> {
    fn from(o: GridSizeEventInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> From<GridSizeEventInRust<IN_RUST>> for EventInRust<IN_RUST> {
    fn from(o: GridSizeEventInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> From<GridSizeEventInRust<IN_RUST>> for ObjectInRust<IN_RUST> {
    fn from(o: GridSizeEventInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> DynamicCast for GridSizeEventInRust<IN_RUST> {
    fn class_info() -> ClassInfoInRust<false> {
        unsafe { ClassInfoInRust::from_ptr(ffi::wxGridSizeEvent_CLASSINFO()) }
    }
}
impl<const IN_RUST: bool> Drop for GridSizeEventInRust<IN_RUST> {
    fn drop(&mut self) {
        if IN_RUST {
            unsafe { ffi::wxObject_delete(self.0) }
        }
...
impl<const IN_RUST: bool> GridSizerInRust<IN_RUST> {
    ...
    pub fn new_with_int_int(cols: c_int, vgap: c_int, hgap: c_int) -> GridSizerInRust<IN_RUST> {
    ...
    pub fn new_with_size<S: SizeMethods>(cols: c_int, gap: &S) -> GridSizerInRust<IN_RUST> {
        unsafe {
            let gap = gap.as_ptr();
...
impl<const IN_RUST: bool> Clone for GridSizerInRust<IN_RUST> {
    fn clone(&self) -> Self {
        Self(self.0)
    }
}
impl<const IN_RUST: bool> From<GridSizerInRust<IN_RUST>> for SizerInRust<IN_RUST> {
    fn from(o: GridSizerInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> From<GridSizerInRust<IN_RUST>> for ObjectInRust<IN_RUST> {
    fn from(o: GridSizerInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> DynamicCast for GridSizerInRust<IN_RUST> {
    fn class_info() -> ClassInfoInRust<false> {
...
impl<const IN_RUST: bool> GridTableBaseInRust<IN_RUST> {
...
impl<const IN_RUST: bool> From<GridTableBaseInRust<IN_RUST>> for ObjectInRust<IN_RUST> {
    fn from(o: GridTableBaseInRust<IN_RUST>) -> Self {
        unsafe { Self::from_ptr(o.as_ptr()) }
    }
}
impl<const IN_RUST: bool> DynamicCast for GridTableBaseInRust<IN_RUST> {
    fn class_info() -> ClassInfoInRust<false> {
        unsafe { ClassInfoInRust::from_ptr(ffi::wxGridTableBase_CLASSINFO()) }
    }
}
impl<const IN_RUST: bool> Drop for GridTableBaseInRust<IN_RUST> {
    fn drop(&mut self) {
        if IN_RUST {
            unsafe { ffi::wxObject_delete(self.0) }
        }
...
impl<const IN_RUST: bool> GridUpdateLockerInRust<IN_RUST> {
    ...
    pub fn new(grid: *mut c_void) -> GridUpdateLockerInRust<IN_RUST> {
...
impl<const IN_RUST: bool> Drop for GridUpdateLockerInRust<IN_RUST> {
    fn drop(&mut self) {
        if IN_RUST {
