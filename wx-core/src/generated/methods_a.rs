...
///
/// See [`AboutDialogInfoInRust`] documentation for the class usage.
pub trait AboutDialogInfoMethods: WxRustMethods {
    ...
    fn get_developers(&self) -> ArrayStringInRust<false> {
        unsafe { ArrayStringInRust::from_ptr(ffi::wxAboutDialogInfo_GetDevelopers(self.as_ptr())) }
    }
    ...
    fn get_doc_writers(&self) -> ArrayStringInRust<false> {
        unsafe { ArrayStringInRust::from_ptr(ffi::wxAboutDialogInfo_GetDocWriters(self.as_ptr())) }
    }
    ...
    fn get_artists(&self) -> ArrayStringInRust<false> {
        unsafe { ArrayStringInRust::from_ptr(ffi::wxAboutDialogInfo_GetArtists(self.as_ptr())) }
    }
    ...
    fn get_translators(&self) -> ArrayStringInRust<false> {
        unsafe { ArrayStringInRust::from_ptr(ffi::wxAboutDialogInfo_GetTranslators(self.as_ptr())) }
    }
}
...
///
/// See [`AcceleratorEntryInRust`] documentation for the class usage.
pub trait AcceleratorEntryMethods: WxRustMethods {
    ...
    fn get_menu_item(&self) -> Option<MenuItemInRust<false>> {
...
///
/// See [`AcceleratorTableInRust`] documentation for the class usage.
...
///
/// See [`ActivateEventInRust`] documentation for the class usage.
...
///
/// See [`AffineMatrix2DInRust`] documentation for the class usage.
...
///
/// See [`AffineMatrix2DBaseInRust`] documentation for the class usage.
...
///
/// See [`AnimationCtrlInRust`] documentation for the class usage.
...
///
/// See [`AnyButtonInRust`] documentation for the class usage.
...
///
/// See [`ArtProviderInRust`] documentation for the class usage.
...
///
/// See [`AutoBufferedPaintDCInRust`] documentation for the class usage.
