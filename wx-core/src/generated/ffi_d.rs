...
extern "C" {
    ...
    // BLOCKED: pub fn wxDocManager_GetDocuments(self_: *mut c_void) -> *mut c_void;
    ...
    // BLOCKED: pub fn wxDocManager_GetTemplates(self_: *mut c_void) -> *mut c_void;
    ...
    // BLOCKED: pub fn wxDocTemplate_GetPageSetupDialogData(self_: *mut c_void) -> *mut c_void;
    // BLOCKED: pub fn wxDocTemplate_GetPageSetupDialogData1(self_: *const c_void) -> *const c_void;
    ...
    // BLOCKED: pub fn wxDocument_Activate(self_: *const c_void);
    ...
    // BLOCKED: pub fn wxDocument_GetViews(self_: *mut c_void) -> *mut c_void;
    // BLOCKED: pub fn wxDocument_GetViews1(self_: *const c_void) -> *const c_void;
    pub fn wxDocument_IsChildDocument(self_: *const c_void) -> bool;
    pub fn wxDocument_IsModified(self_: *const c_void) -> bool;
    // BLOCKED: pub fn wxDocument_LoadObject(self_: *mut c_void, stream: *mut c_void) -> *mut c_void;
    // BLOCKED: pub fn wxDocument_LoadObject1(self_: *mut c_void, stream: *mut c_void) -> *mut c_void;
    ...
    // BLOCKED: pub fn wxDocument_SaveObject(self_: *mut c_void, stream: *mut c_void) -> *mut c_void;
    // BLOCKED: pub fn wxDocument_SaveObject1(self_: *mut c_void, stream: *mut c_void) -> *mut c_void;
