...
// wxFileCtrl
/// This trait represents C++ [`wxFileCtrl`](https://docs.wxwidgets.org/3.2/classwx_file_ctrl.html) class's methods and inheritance.
///
...
// wxFileCtrlEvent
/// This trait represents C++ [`wxFileCtrlEvent`](https://docs.wxwidgets.org/3.2/classwx_file_ctrl_event.html) class's methods and inheritance.
///
...
// wxFileDataObject
/// This trait represents C++ [`wxFileDataObject`](https://docs.wxwidgets.org/3.2/classwx_file_data_object.html) class's methods and inheritance.
///
...
// wxFileDialog
/// This trait represents C++ [`wxFileDialog`](https://docs.wxwidgets.org/3.2/classwx_file_dialog.html) class's methods and inheritance.
///
...
/// This trait represents C++ [`wxFileDirPickerEvent`](https://docs.wxwidgets.org/3.2/classwx_file_dir_picker_event.html) class's methods and inheritance.
///
...
// wxFileDropTarget
/// This trait represents C++ [`wxFileDropTarget`](https://docs.wxwidgets.org/3.2/classwx_file_drop_target.html) class's methods and inheritance.
///
...
// wxFileHistory
/// This trait represents C++ [`wxFileHistory`](https://docs.wxwidgets.org/3.2/classwx_file_history.html) class's methods and inheritance.
///
...
// wxFilePickerCtrl
/// This trait represents C++ [`wxFilePickerCtrl`](https://docs.wxwidgets.org/3.2/classwx_file_picker_ctrl.html) class's methods and inheritance.
///
...
// wxFindDialogEvent
/// This trait represents C++ [`wxFindDialogEvent`](https://docs.wxwidgets.org/3.2/classwx_find_dialog_event.html) class's methods and inheritance.
///
...
// wxFindReplaceData
/// This trait represents C++ [`wxFindReplaceData`](https://docs.wxwidgets.org/3.2/classwx_find_replace_data.html) class's methods and inheritance.
///
...
// wxFindReplaceDialog
/// This trait represents C++ [`wxFindReplaceDialog`](https://docs.wxwidgets.org/3.2/classwx_find_replace_dialog.html) class's methods and inheritance.
///
...
// wxFlexGridSizer
/// This trait represents C++ [`wxFlexGridSizer`](https://docs.wxwidgets.org/3.2/classwx_flex_grid_sizer.html) class's methods and inheritance.
///
...
// wxFocusEvent
/// This trait represents C++ [`wxFocusEvent`](https://docs.wxwidgets.org/3.2/classwx_focus_event.html) class's methods and inheritance.
///
...
// wxFont
/// This trait represents C++ [`wxFont`](https://docs.wxwidgets.org/3.2/classwx_font.html) class's methods and inheritance.
///
...
// wxFontData
/// This trait represents C++ [`wxFontData`](https://docs.wxwidgets.org/3.2/classwx_font_data.html) class's methods and inheritance.
///
...
// wxFontDialog
/// This trait represents C++ [`wxFontDialog`](https://docs.wxwidgets.org/3.2/classwx_font_dialog.html) class's methods and inheritance.
///
...
// wxFontEnumerator
/// This trait represents C++ [`wxFontEnumerator`](https://docs.wxwidgets.org/3.2/classwx_font_enumerator.html) class's methods and inheritance.
///
...
// wxFontList
/// This trait represents C++ [`wxFontList`](https://docs.wxwidgets.org/3.2/classwx_font_list.html) class's methods and inheritance.
///
...
// wxFontMapper
/// This trait represents C++ [`wxFontMapper`](https://docs.wxwidgets.org/3.2/classwx_font_mapper.html) class's methods and inheritance.
///
...
// wxFontPickerCtrl
/// This trait represents C++ [`wxFontPickerCtrl`](https://docs.wxwidgets.org/3.2/classwx_font_picker_ctrl.html) class's methods and inheritance.
///
...
// wxFontPickerEvent
/// This trait represents C++ [`wxFontPickerEvent`](https://docs.wxwidgets.org/3.2/classwx_font_picker_event.html) class's methods and inheritance.
///
...
// wxFrame
/// This trait represents C++ [`wxFrame`](https://docs.wxwidgets.org/3.2/classwx_frame.html) class's methods and inheritance.
///
