...
///
/// See [`VListBoxFromCpp`] documentation for the class usage.
pub trait VListBoxMethods: VScrolledWindowMethods {
    // DTOR: fn ~wxVListBox()
    /// Deletes all items from the control.
    ///
    /// See [C++ `wxVListBox::Clear()`'s documentation](https://docs.wxwidgets.org/3.2/classwx_v_list_box.html#aaf92fc38649bd6efc5b1f72c508a5f6f).
    fn clear(&self) {
        unsafe { ffi::wxVListBox_Clear(self.as_ptr()) }
    }
    /// Deselects all the items in the listbox.
    ///
    /// See [C++ `wxVListBox::DeselectAll()`'s documentation](https://docs.wxwidgets.org/3.2/classwx_v_list_box.html#a3d922a858e2af9eb94026a5360e2c443).
    ...
    ///
    /// See [C++ `wxVListBox::GetFirstSelected()`'s documentation](https://docs.wxwidgets.org/3.2/classwx_v_list_box.html#a6fe25d924067f6417d0df219d0d2bf30).
    fn get_first_selected(&self, cookie: *mut c_void) -> c_int {
        unsafe { ffi::wxVListBox_GetFirstSelected(self.as_ptr(), cookie) }
    }
    /// Get the number of items in the control.
    ///
    /// See [C++ `wxVListBox::GetItemCount()`'s documentation](https://docs.wxwidgets.org/3.2/classwx_v_list_box.html#a678e0068cc41361701097f9ebdc63fa5).
    fn get_item_count(&self) -> usize {
        unsafe { ffi::wxVListBox_GetItemCount(self.as_ptr()) }
    }
    /// Returns the margins used by the control.
    ///
    /// See [C++ `wxVListBox::GetMargins()`'s documentation](https://docs.wxwidgets.org/3.2/classwx_v_list_box.html#a021b8a9a3148623508f555f4f3cd0d24).
    ...
    ///
    /// See [C++ `wxVListBox::GetItemRect()`'s documentation](https://docs.wxwidgets.org/3.2/classwx_v_list_box.html#ac42c91e4dc7e877f3062108bcee27693).
    ...
    ///
    /// See [C++ `wxVListBox::GetNextSelected()`'s documentation](https://docs.wxwidgets.org/3.2/classwx_v_list_box.html#af683034a20f3760b4a253510cc320789).
    ...
    ///
    /// See [C++ `wxVListBox::GetSelectedCount()`'s documentation](https://docs.wxwidgets.org/3.2/classwx_v_list_box.html#a0e7a8edc564fa5a309cb09f07258cfe5).
    ...
    ///
    /// See [C++ `wxVListBox::GetSelection()`'s documentation](https://docs.wxwidgets.org/3.2/classwx_v_list_box.html#acc5665a51a4cefd6291cbf3c02e338ba).
    ...
    ///
    /// See [C++ `wxVListBox::HasMultipleSelection()`'s documentation](https://docs.wxwidgets.org/3.2/classwx_v_list_box.html#a8d0144a90340ca18f5be907fd4dfc96a).
    ...
    ///
    /// See [C++ `wxVListBox::IsCurrent()`'s documentation](https://docs.wxwidgets.org/3.2/classwx_v_list_box.html#a84098ec4b9227a619a1dcc4a2427f582).
    ...
    ///
    /// See [C++ `wxVListBox::IsSelected()`'s documentation](https://docs.wxwidgets.org/3.2/classwx_v_list_box.html#a331d39ab137d9319163f29f5659b0dca).
    ...
    ///
    /// See [C++ `wxVListBox::Select()`'s documentation](https://docs.wxwidgets.org/3.2/classwx_v_list_box.html#a0b49818db23a5fbd987438ca5ea0f607).
    fn select(&self, item: usize, select: bool) -> bool {
        unsafe { ffi::wxVListBox_Select(self.as_ptr(), item, select) }
    }
    /// Selects all the items in the listbox.
    ///
    /// See [C++ `wxVListBox::SelectAll()`'s documentation](https://docs.wxwidgets.org/3.2/classwx_v_list_box.html#a46d5153f9c50bff13663d1768818255e).
    fn select_all(&self) -> bool {
        unsafe { ffi::wxVListBox_SelectAll(self.as_ptr()) }
    }
    /// Selects all items in the specified range which may be given in any order.
    ///
    /// See [C++ `wxVListBox::SelectRange()`'s documentation](https://docs.wxwidgets.org/3.2/classwx_v_list_box.html#ab148ec397eacecb1a71e829c2b5aa13a).
    fn select_range(&self, from: usize, to: usize) -> bool {
        unsafe { ffi::wxVListBox_SelectRange(self.as_ptr(), from, to) }
    }
    /// Set the number of items to be shown in the control.
    ///
    /// See [C++ `wxVListBox::SetItemCount()`'s documentation](https://docs.wxwidgets.org/3.2/classwx_v_list_box.html#a205615c79836dc7999d20e083a4a8ffb).
    ...
    ///
    /// See [C++ `wxVListBox::SetMargins()`'s documentation](https://docs.wxwidgets.org/3.2/classwx_v_list_box.html#aeabe37f2b1a1887f995c431eb5522921).
    ...
    ///
    /// See [C++ `wxVListBox::SetMargins()`'s documentation](https://docs.wxwidgets.org/3.2/classwx_v_list_box.html#a20ef3b7013828036d0c3901500d23cf3).
    ...
    ///
    /// See [C++ `wxVListBox::SetSelection()`'s documentation](https://docs.wxwidgets.org/3.2/classwx_v_list_box.html#aee1df263dbb96e49dbc44684fb7d9dad).
    ...
    ///
    /// See [C++ `wxVListBox::SetSelectionBackground()`'s documentation](https://docs.wxwidgets.org/3.2/classwx_v_list_box.html#aad25b40caedb9a864ab347d50e8c5e8b).
    ...
    ///
    /// See [C++ `wxVListBox::Toggle()`'s documentation](https://docs.wxwidgets.org/3.2/classwx_v_list_box.html#ae530f18573bd96ea497d64b1b1b18905).
...
///
/// See [`VScrolledWindowFromCpp`] documentation for the class usage.
...
///
/// See [`ValidatorFromCpp`] documentation for the class usage.
pub trait ValidatorMethods: EvtHandlerMethods {
    ...
    ///
    /// See [C++ `wxValidator::Clone()`'s documentation](https://docs.wxwidgets.org/3.2/classwx_validator.html#a06c78c305b279cd8cad1a31376e6c713).
    fn clone(&self) -> Object {
        unsafe { Object::from_ptr(ffi::wxValidator_Clone(self.as_ptr())) }
    }
    /// Returns the window associated with the validator.
    ///
    /// See [C++ `wxValidator::GetWindow()`'s documentation](https://docs.wxwidgets.org/3.2/classwx_validator.html#a7568622187a3ffa022ba53ef7e976b9c).
    fn get_window(&self) -> WeakRef<Window> {
        unsafe { WeakRef::<Window>::from(ffi::wxValidator_GetWindow(self.as_ptr())) }
    }
    /// Associates a window with the validator.
    ///
    /// See [C++ `wxValidator::SetWindow()`'s documentation](https://docs.wxwidgets.org/3.2/classwx_validator.html#af909586ba6a6c8f665f684a4a83334eb).
    ...
    ///
    /// See [C++ `wxValidator::TransferFromWindow()`'s documentation](https://docs.wxwidgets.org/3.2/classwx_validator.html#acffa9472b2f741ab29dbfad3b80934da).
    ...
    ///
    /// See [C++ `wxValidator::TransferToWindow()`'s documentation](https://docs.wxwidgets.org/3.2/classwx_validator.html#aa09f9ae3bace5de7a8e577206b75aeae).
    ...
    ///
    /// See [C++ `wxValidator::Validate()`'s documentation](https://docs.wxwidgets.org/3.2/classwx_validator.html#abe48368bac7f540f0c20b1436e5c71af).
    ...
    ///
    /// See [C++ `wxValidator::SuppressBellOnError()`'s documentation](https://docs.wxwidgets.org/3.2/classwx_validator.html#a810c6c099c730a13b88f04d46ebe720e).
    ...
    ///
    /// See [C++ `wxValidator::IsSilent()`'s documentation](https://docs.wxwidgets.org/3.2/classwx_validator.html#a50671f3be232b0fd30a0877d3273a366).
    fn is_silent() -> bool {
