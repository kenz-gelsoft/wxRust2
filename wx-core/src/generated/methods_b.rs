...
///
/// See [`BannerWindowInRust`] documentation for the class usage.
...
///
/// See [`BitmapInRust`] documentation for the class usage.
pub trait BitmapMethods: GDIObjectMethods {
    ...
    fn get_mask(&self) -> Option<MaskInRust<false>> {
    ...
    fn get_palette(&self) -> Option<PaletteInRust<false>> {
    ...
    fn find_handler(name: &str) -> Option<BitmapHandlerInRust<false>> {
        unsafe {
            let name = WxString::from(name);
            let name = name.as_ptr();
...
///
/// See [`BitmapBundleInRust`] documentation for the class usage.
...
///
/// See [`BitmapButtonInRust`] documentation for the class usage.
...
///
/// See [`BitmapComboBoxInRust`] documentation for the class usage.
...
///
/// See [`BitmapDataObjectInRust`] documentation for the class usage.
...
///
/// See [`BitmapHandlerInRust`] documentation for the class usage.
...
///
/// See [`BitmapToggleButtonInRust`] documentation for the class usage.
...
///
/// See [`BookCtrlBaseInRust`] documentation for the class usage.
...
///
/// See [`BookCtrlEventInRust`] documentation for the class usage.
...
///
/// See [`BoxSizerInRust`] documentation for the class usage.
...
///
/// See [`BrushInRust`] documentation for the class usage.
...
///
/// See [`BrushListInRust`] documentation for the class usage.
...
///
/// See [`BufferedDCInRust`] documentation for the class usage.
...
///
/// See [`BufferedPaintDCInRust`] documentation for the class usage.
...
///
/// See [`BusyCursorInRust`] documentation for the class usage.
...
///
/// See [`BusyInfoInRust`] documentation for the class usage.
...
///
/// See [`ButtonInRust`] documentation for the class usage.
