...
///
/// See [`MaskInRust`] documentation for the class usage.
...
///
/// See [`MaximizeEventInRust`] documentation for the class usage.
...
///
/// See [`MemoryDCInRust`] documentation for the class usage.
pub trait MemoryDCMethods: DCMethods {
    ...
    fn get_selected_bitmap(&self) -> BitmapInRust<false> {
        unsafe { BitmapInRust::from_ptr(ffi::wxMemoryDC_GetSelectedBitmap(self.as_ptr())) }
    }
...
///
/// See [`MenuInRust`] documentation for the class usage.
pub trait MenuMethods: EvtHandlerMethods {
    ...
    fn append_separator(&self) -> Option<MenuItemInRust<false>> {
    ...
    fn find_child_item(&self, id: c_int, pos: *mut c_void) -> Option<MenuItemInRust<false>> {
    ...
    fn find_item_by_position(&self, position: usize) -> Option<MenuItemInRust<false>> {
    ...
    fn insert_separator(&self, pos: usize) -> Option<MenuItemInRust<false>> {
    ...
    fn prepend_separator(&self) -> Option<MenuItemInRust<false>> {
    ...
    fn remove_int(&self, id: c_int) -> Option<MenuItemInRust<false>> {
...
///
/// See [`MenuBarInRust`] documentation for the class usage.
...
///
/// See [`MenuEventInRust`] documentation for the class usage.
...
///
/// See [`MenuItemInRust`] documentation for the class usage.
pub trait MenuItemMethods: ObjectMethods {
    ...
    fn get_accel(&self) -> Option<AcceleratorEntryInRust<false>> {
...
///
/// See [`MessageDialogInRust`] documentation for the class usage.
...
///
/// See [`MessageOutputMessageBoxInRust`] documentation for the class usage.
...
///
/// See [`MiniFrameInRust`] documentation for the class usage.
...
///
/// See [`MirrorDCInRust`] documentation for the class usage.
...
///
/// See [`MouseCaptureChangedEventInRust`] documentation for the class usage.
...
///
/// See [`MouseCaptureLostEventInRust`] documentation for the class usage.
...
///
/// See [`MouseEventInRust`] documentation for the class usage.
...
///
/// See [`MouseEventsManagerInRust`] documentation for the class usage.
...
///
/// See [`MoveEventInRust`] documentation for the class usage.
