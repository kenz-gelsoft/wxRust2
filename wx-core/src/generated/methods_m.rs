...
pub trait MemoryDCMethods: DCMethods {
    ...
    fn get_selected_bitmap(&self) -> BitmapFromCpp<false> {
...
pub trait MenuMethods: EvtHandlerMethods {
    ...
    fn append_separator(&self) -> Option<MenuItemFromCpp<false>> {
    ...
    fn find_child_item(&self, id: c_int, pos: *mut c_void) -> Option<MenuItemFromCpp<false>> {
    ...
    fn find_item_by_position(&self, position: usize) -> Option<MenuItemFromCpp<false>> {
    ...
    fn insert_separator(&self, pos: usize) -> Option<MenuItemFromCpp<false>> {
    ...
    fn prepend_separator(&self) -> Option<MenuItemFromCpp<false>> {
    ...
    fn remove_int(&self, id: c_int) -> Option<MenuItemFromCpp<false>> {
...
pub trait MenuItemMethods: ObjectMethods {
    ...
    fn get_accel(&self) -> Option<AcceleratorEntryFromCpp<false>> {
