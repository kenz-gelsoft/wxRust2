...
impl<const OWNED: bool> DocChildFrameIsOwned<OWNED> {
    pub fn new<D: DocumentMethods, F: FrameMethods, P: PointMethods, S: SizeMethods>(
        doc: Option<&D>,
        view: *mut c_void,
        parent: Option<&F>,
        id: c_int,
...
impl<const OWNED: bool> DocMDIChildFrameIsOwned<OWNED> {
    pub fn new<D: DocumentMethods, M: MDIParentFrameMethods, P: PointMethods, S: SizeMethods>(
        doc: Option<&D>,
        view: *mut c_void,
        parent: Option<&M>,
        id: c_int,
