...
///
/// [See `wxNativeFontInfo`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_native_font_info.html)
...
///
/// [See `wxNavigationKeyEvent`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_navigation_key_event.html)
...
///
/// [See `wxNonOwnedWindow`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_non_owned_window.html)
...
///
/// [See `wxNotebook`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_notebook.html)
...
///
/// [See `wxNotificationMessage`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_notification_message.html)
...
///
/// [See `wxNotifyEvent`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_notify_event.html)
...
///
/// [See `wxNumberEntryDialog`'s original doc.](https://docs.wxwidgets.org/3.2/classwx_number_entry_dialog.html)
