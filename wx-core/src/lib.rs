...
pub struct BitmapToggleButtonBuilder<'a, P: WindowMethods> {
    parent: Option<&'a P>,
    id: c_int,
    pos: Option<Point>,
    size: Option<Size>,
...
impl<'a, P: WindowMethods> Buildable<'a, P, BitmapToggleButtonBuilder<'a, P>>
    for BitmapToggleButton
{
    fn builder(parent: Option<&'a P>) -> BitmapToggleButtonBuilder<'a, P> {
...
impl<'a, P: WindowMethods> BitmapToggleButtonBuilder<'a, P> {
    pub fn id(&mut self, id: c_int) -> &mut Self {
        self.id = id;
        self
    }
    ...
    pub fn build<B: BitmapBundleMethods>(&mut self, bitmap: &B) -> BitmapToggleButton {
        let pos = self.pos.take().unwrap_or_else(|| Point::default());
        let size = self.size.take().unwrap_or_else(|| Size::default());
        let validator = self
            .validator
...
pub struct SearchCtrlBuilder<'a, P: WindowMethods> {
    parent: Option<&'a P>,
    id: c_int,
    value: String,
    pos: Option<Point>,
...
impl<'a, P: WindowMethods> Buildable<'a, P, SearchCtrlBuilder<'a, P>> for SearchCtrl {
    fn builder(parent: Option<&'a P>) -> SearchCtrlBuilder<'a, P> {
        SearchCtrlBuilder {
            parent: parent,
            id: ID_ANY,
            value: "".to_string(),
...
impl<'a, P: WindowMethods> SearchCtrlBuilder<'a, P> {
    pub fn id(&mut self, id: c_int) -> &mut Self {
        self.id = id;
        self
    }
    ...
    pub fn build(&mut self) -> SearchCtrl {
        let pos = self.pos.take().unwrap_or_else(|| Point::default());
        let size = self.size.take().unwrap_or_else(|| Size::default());
        let validator = self
            .validator
...
pub struct ToggleButtonBuilder<'a, P: WindowMethods> {
    parent: Option<&'a P>,
    id: c_int,
    label: String,
    pos: Option<Point>,
...
impl<'a, P: WindowMethods> Buildable<'a, P, ToggleButtonBuilder<'a, P>> for ToggleButton {
    fn builder(parent: Option<&'a P>) -> ToggleButtonBuilder<'a, P> {
        ToggleButtonBuilder {
            parent: parent,
            id: ID_ANY,
            label: "".to_string(),
...
impl<'a, P: WindowMethods> ToggleButtonBuilder<'a, P> {
    pub fn id(&mut self, id: c_int) -> &mut Self {
        self.id = id;
        self
    }
...
// wxDefaultPosition
impl<const IN_RUST: bool> Default for PointInRust<IN_RUST> {
    fn default() -> Self {
        PointInRust::new_with_int(-1, -1)
    }
}
// wxDefaultSize
impl<const IN_RUST: bool> Default for SizeInRust<IN_RUST> {
    fn default() -> Self {
        SizeInRust::new_with_int(-1, -1)
    }
}
// wxDefaultValidator
impl<const IN_RUST: bool> Default for ValidatorInRust<IN_RUST> {
    fn default() -> Self {
        ValidatorInRust::new()
    }
}
...
wxwidgets! {
    class SizerItemList
        = SizerItemListInRust<true>(wxSizerItemList) impl
        SizerItemListMethods
}
impl<const IN_RUST: bool> SizerItemListInRust<IN_RUST> {
    pub fn new() -> Self {
        unsafe { SizerItemListInRust(ffi::wxSizerItemList_new()) }
    }
}
impl<const IN_RUST: bool> Drop for SizerItemListInRust<IN_RUST> {
    fn drop(&mut self) {
        if IN_RUST {
...
wxwidgets! {
    class WindowList
        = WindowListInRust<true>(wxWindowList) impl
        WindowListMethods
}
impl<const IN_RUST: bool> WindowListInRust<IN_RUST> {
    pub fn new() -> Self {
        unsafe { WindowListInRust(ffi::wxWindowList_new()) }
    }
}
impl<const IN_RUST: bool> Drop for WindowListInRust<IN_RUST> {
    fn drop(&mut self) {
        if IN_RUST {
