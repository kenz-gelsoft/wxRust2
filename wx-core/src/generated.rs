...
mod ffi {
    ...
    extern "C" {
        ...
        pub fn wxButton_GetDefaultSize() -> *mut c_void;
        ...
        // NOT_SUPPORTED: pub fn wxTopLevelWindow_HandleSettingChange(self_: *mut c_void, w_param: WXWPARAM, l_param: WXLPARAM) -> bool;
        ...
        // BLOCKED: pub fn wxTopLevelWindow_SetLeftMenu(self_: *mut c_void, id: c_int, label: *const c_void, sub_menu: *mut c_void);
        // BLOCKED: pub fn wxTopLevelWindow_SetRightMenu(self_: *mut c_void, id: c_int, label: *const c_void, sub_menu: *mut c_void);
        ...
        // BLOCKED: pub fn wxSize_Scale(self_: *mut c_void, xscale: float, yscale: float) -> *mut c_void;
...
pub trait WindowMethods: EvtHandlerMethods {
    ...
    fn is_descendant(&self, win: *mut c_void) -> bool {
        unsafe { ffi::wxWindow_IsDescendant(self.as_ptr(), win) }
    }
...
pub trait ButtonMethods: AnyButtonMethods {
    ...
    fn get_default_size() -> Size {
        unsafe { Size(ffi::wxButton_GetDefaultSize()) }
    }
}
...
pub trait TopLevelWindowMethods: NonOwnedWindowMethods {
    ...
    // NOT_SUPPORTED: fn HandleSettingChange()
    ...
    // BLOCKED: fn SetLeftMenu()
    // BLOCKED: fn SetRightMenu()
